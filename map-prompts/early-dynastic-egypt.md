...
2. The Nile flows from south (bottom) to north (top), fanning into the Delta before reaching the Mediterranean.
3. "Upper Egypt" = the SOUTHERN part (upstream). "Lower Egypt" = the NORTHERN part (the Delta, downstream). This is counterintuitive — Upper is at the BOTTOM of the map.
4. The Fayum is a depression ~50 miles SW of modern Cairo, on the western side of the Nile.
5. The First Cataract at Aswan marks Egypt's southern border. Nubia is south of Aswan.
...
- Show the Sahara as a large pale region WEST of the Nile
- Muted warm palette, all water LIGHT BLUE

**Sites to mark (small dots with labels) — each ONCE:**
- **Nabta Playa** — in the Western Desert, ~60 miles west of the Nile. Label: "Nabta Playa (stone calendar circle, ~4800 BCE — oldest astronomical site in Africa)"
- **Fayum** — depression SW of modern Cairo. Label: "Fayum (first grain-storage pits, ~5200 BCE)"
- **Merimde Beni-Salame** — western Delta edge. Label: "Merimde (earliest dense village, ~4800 BCE)"
- **El-Omari** — eastern Delta. Label: "El-Omari (farming village)"

**Region labels (subtle, gray) — each ONCE:**
- Sahara (large, across the western desert)
- Nile Valley
- Eastern Desert
- Mediterranean Sea
- Red Sea
...
- Muted warm palette, water LIGHT BLUE, floodplain soft green

**Sites (dots + labels) — each ONCE:**
- **El-Badari** — east bank, middle Egypt. Label: "El-Badari (Badarian heartland, ~4400–3800 BCE — black-topped pottery, first copper, first linen)"
- **Maadi** — eastern edge of future Cairo. Label: "Maadi (Lower Egyptian culture, ~3900–3500 BCE — Levantine contacts)"
- **Fayum** — depression SW of Cairo. Label: "Fayum"
- **Sinai** — the peninsula, edge. Label: "Sinai (copper source)"
...
- Muted warm palette, water LIGHT BLUE

**Sites — each ONCE:**
- **Hierakonpolis** — southern Upper Egypt. Label: "Hierakonpolis / Nekhen (city of the falcon — brewery, temple, Painted Tomb, ~3700 BCE)"
- **Naqada** — west bank, ~20 miles N of Luxor. Label: "Naqada (type site for the predynastic sequence)"
- **Buto** — western Delta. Label: "Buto / Tell el-Fara'in (Lower Egyptian cultural center, Wadjet the cobra goddess)"
- **Wadi Hammamat** — Eastern Desert route. Label: "Wadi Hammamat (trade route to Red Sea, greywacke quarries)"
...
**Sites — each ONCE:**
- **Abydos** — middle Upper Egypt. Label: "Abydos (Tomb U-j — Scorpion I, earliest hieroglyphs, ~3250 BCE)"
- **Thinis** — near Abydos. Label: "Thinis / Tjenu (political center of the Thinite kings)"
- **Hierakonpolis** — southern Upper Egypt. Label: "Hierakonpolis (rival power center)"
- **Gebel el-Arak** — middle Egypt. Label: "Gebel el-Arak (knife with Mesopotamian-influenced ivory hilt)"
...
**Sites — each ONCE:**
- **Hierakonpolis** — where the Narmer Palette was found. Label: "Hierakonpolis (Narmer Palette found here, 1898)"
- **Abydos** — Thinite royal cemetery. Label: "Abydos (Thinite royal cemetery — Narmer, Hor-Aha)"
- **Memphis** — apex of the Delta. Label: "Memphis (new capital of unified Egypt, founded ~3100 BCE)"

**Region labels — each ONCE:**
- Upper Egypt (White Crown)
- Lower Egypt (Red Crown)
- Mediterranean Sea
- First Cataract / Aswan (edge)
...
**Sites — each ONCE:**
- **Abydos** — Label: "Abydos (First Dynasty royal tombs — Djer's 338 subsidiary burials)"
- **Saqqara** — Label: "Saqqara (elite mastaba tombs, Memphis necropolis)"
- **Memphis** — Label: "Memphis (capital)"
- **Byblos** — Lebanese coast. Label: "Byblos (cedar trade with Lebanon)"
- **Wadi Maghara** — western Sinai. Label: "Wadi Maghara (Sinai turquoise and copper mines)"
...
**Sites — each ONCE:**
- **Saqqara** — Label: "Saqqara (Hetepsekhemwy moves royal burial here from Abydos)"
- **Memphis** — Label: "Memphis (capital — center of gravity shifts north)"
- **Abydos** — Label: "Abydos (Peribsen returns here — Seth serekh, possible Upper Egyptian power base)"
...
**Sites — each ONCE:**
- **Hierakonpolis** — Label: "Hierakonpolis (Khasekhemwy statue — 47,209 dead northerners on the base)"
- **Abydos** — Label: "Abydos (Khasekhemwy's tomb — 230 ft long, first stone royal chamber, last king buried here)"
- **Saqqara** — Label: "Saqqara (Djoser's Step Pyramid built here one generation later)"
- **Gisr el-Mudir** — at Saqqara. Label: "Gisr el-Mudir (massive stone enclosure — proto-pyramid?)"
