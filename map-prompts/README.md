...
7. **No anachronistic modern geography.** No modern country names or modern national borders on a pre-modern-era map (never PAKISTAN/IRAN/BELIZE/NIGERIA/NEPAL on an ancient or medieval map). Period-appropriate internal outlines (provinces/states/kingdoms of the era depicted) ARE fine and normal — only *anachronistic modern* political geography is the defect.
