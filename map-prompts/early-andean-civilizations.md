...
2. The Andes mountains run roughly NORTH-SOUTH along the western edge of South America, parallel to the Pacific coast.
3. The coast is WEST of the Andes — a narrow strip of desert between the mountains and the ocean.
4. The highlands are the Andes themselves — high valleys, plateaus, and peaks in the center of the map.
5. The eastern jungle slopes drop steeply from the highlands toward the Amazon basin to the RIGHT (east).
...
- OR a standard map view of Peru showing the coast, Andes spine, and eastern slopes
- Muted warm palette, Pacific Ocean LIGHT BLUE
...
- Andes Highlands
- Puna (high grassland)
- Eastern Jungle Slopes
- Lake Titicaca (south)

**Sites — each ONCE:**
- **Huaca Prieta** — north coast, Chicama Valley. Label: "Huaca Prieta (earliest textiles, ~3000 BCE)"
- **Supe Valley** — central coast. Label: "Supe Valley (future site of Caral)"
...
**Sites — each ONCE:**
- **Sechin Bajo** — Casma Valley. Label: "Sechin Bajo (circular plaza, possibly ~3500 BCE)"
- **Huaca Prieta** — Chicama Valley. Label: "Huaca Prieta (earliest decorated textiles)"
- **Aspero** — mouth of Supe Valley. Label: "Aspero (6 platform mounds, marine economy)"
- **Bandurria** — south of Aspero. Label: "Bandurria (early monumental site)"
...
- Muted warm palette, Pacific LIGHT BLUE

**Sites — each ONCE:**
- **Caral** — 14 miles inland. Label: "Caral (6 pyramids, 2 sunken plazas, 150 acres — ~2600 BCE, no pottery, no warfare)"
- **Aspero** — coast. Label: "Aspero (coastal fishing hub)"
...
**Sites — each ONCE:**
- **Sechin Alto** — Casma Valley. Label: "Sechin Alto (1,000 ft long, 130 ft tall — largest structure in the Americas)"
- **Cerro Sechin** — Casma Valley. Label: "Cerro Sechin (300+ carved stone panels showing dismemberment)"
- **El Paraiso** — near Lima. Label: "El Paraiso (13 mounds, U-shape precursor)"
- **Kotosh** — highlands, Huallaga Valley. Label: "Kotosh (Temple of the Crossed Hands — highland parallel)"
...
**Sites — each ONCE:**
- **Garagay** — Rimac Valley (Lima). Label: "Garagay (polychrome clay friezes, partly buried under Lima)"
- **Cardal** — Lurin Valley. Label: "Cardal (fanged-face clay frieze)"
- **Caballo Muerto** — Moche Valley. Label: "Caballo Muerto / Huaca de los Reyes (6-foot adobe heads with fangs)"
...
- Lurin Valley
- Moche Valley
- Jequetepeque Valley (Cupisnique zone)
...
**Sites — each ONCE:**
- **Chavin de Huantar** — highlands, ~10,000 ft. Label: "Chavín de Huántar (Old Temple, underground galleries, Lanzón monolith, ~900 BCE)"
...
**Sites — each ONCE:**
- **Chavin de Huantar** — central highlands. Label: "Chavín de Huántar (origin center)"
- **Kuntur Wasi** — northern highlands. Label: "Kuntur Wasi (earliest gold crowns in Peru)"
- **Quispisisa** — southern highlands (Ayacucho). Label: "Quispisisa (obsidian quarry, traded 350 miles)"

**Region labels — each ONCE:**
- Pacific Ocean
- Andes Highlands
- North Coast (Cupisnique zone)
- Central Coast
- South Coast
...
**Sites — each ONCE:**
- **Paracas Peninsula** — south coast. Label: "Paracas Peninsula (400+ mummy bundles, extraordinary textiles, ~400–200 BCE)"
- **Chavin de Huantar** — highlands (edge). Label: "Chavín de Huántar (declining, galleries empty)"

**Region labels — each ONCE:**
- Pacific Ocean
- Ica Region
- Nazca Desert (south)
- Andes Highlands (edge)
