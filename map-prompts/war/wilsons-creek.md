...
Eight labels: Jefferson City, Boonville, Springfield, Wilson's Creek, Carthage, Lyon, Sigel, McCulloch. No others, and print no color words. Keep them big, bold, and well-separated so none crowd or overlap. EVERY label, including the arrow labels "Lyon", "Sigel", and "McCulloch", MUST sit inside its own solid white rounded pill exactly like the town labels — no bare text floating on the terrain, and keep all label text upright (not italic or rotated).
