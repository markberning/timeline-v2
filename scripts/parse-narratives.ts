...
const NARRATIVE_FILES: Record<string, string> = {
  ...
  'medieval-japan.md': 'medieval-japan',
  'islamic-persia.md': 'islamic-persia',
  'muscovite-russia.md': 'muscovite-russia',
  'age-of-exploration.md': 'age-of-exploration',
  'atlantic-slave-trade.md': 'atlantic-slave-trade',
  'latin-american-independence.md': 'latin-american-independence',
