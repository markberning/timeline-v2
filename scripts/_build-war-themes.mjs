...
const RW = {
  ...
  douglas:f('road-to-war-fig6-douglas-vannerson.jpg', `Stephen A. Douglas, "the Little Giant," photographed in 1859. He saved the Union in 1850 by splitting Clay's omnibus into five manageable bills. He nearly broke it in 1854 by erasing the Missouri Compromise line to build a railroad. Not a villain of this story, but something more interesting: a man whose ambition outran his conscience.`, `Julian Vannerson · 1859 · Library of Congress · public domain`),
  ...
  dred:   f('road-to-war-fig8-dred-scott-1857.jpg', `Dred Scott, photographed around 1857. The Supreme Court ruled he had no right to sue, no right to be free, and no claim to citizenship the law was bound to respect. He was freed eighteen months later anyway, by a private man's signature. He died of tuberculosis on September 17, 1858.`, `Photographer uncredited · c. 1857 · public domain`),
...
const TG = {
  ...
  inaug:  f('two-governments-lincoln-inaugural.jpg', `Lincoln's first inauguration at the U.S. Capitol, March 4, 1861. The unfinished dome was still under construction above him, seven states already gone from the Union.`, `Library of Congress · 1861 · public domain`),
