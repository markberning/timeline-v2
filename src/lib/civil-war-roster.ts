...
// NARRATIVE = the woven chronological spine ("How the War Happened"): per the McPherson
// test (audits/war-build-standard.md §4a) the spine braids military + politics + diplomacy
// + home-front into one thread, so it is NOT tagged MILITARY. ('MILITARY' kept for legacy
// data assignability; nothing renders off these tags.)
export type SpineType = 'CAUSE' | 'BATTLE' | 'POLITICS' | 'SOCIETY' | 'AFTERMATH' | 'MILITARY' | 'NARRATIVE'
...
export const MAJORS: Major[] = [
  ...
  { id: 'e-fortstedman', name: 'Fort Stedman', year: 1865, m: 3, mo: 'Mar', place: 'Petersburg, VA', theatre: 'east', size: 's', href: '/war-civil-war/eastern/fort-stedman', img: '/war-img/fort-stedman-hero.jpg', hook: 'Lee’s last gamble: Gordon’s pre-dawn rush takes the fort in an hour, finds nothing behind it, and the failed attack only hastens the end.' },
  { id: 'e-fiveforks', name: 'Five Forks', year: 1865, m: 4, mo: 'Apr', place: 'Dinwiddie Co., VA', theatre: 'east', size: 'm', href: '/war-civil-war/eastern/five-forks', img: '/war-img/five-forks-hero.jpg', hook: 'Nine months of siege crack open in one afternoon at a backwoods crossroads, while the two Confederate generals responsible are off eating fish a mile and a half away.' },
  { id: 'e-petersburg3', name: 'Third Petersburg', year: 1865, m: 4, mo: 'Apr', place: 'Petersburg, VA', theatre: 'east', size: 'm', href: '/war-civil-war/eastern/third-petersburg', img: '/war-img/third-petersburg-hero.jpg', hook: 'The siege that held for nine months breaks in twenty minutes, and the road to Appomattox opens.' },
  { id: 'e-appomattox', name: 'Appomattox Court House', year: 1865, m: 4, mo: 'Apr', place: 'Appomattox Co., VA', theatre: 'east', size: 'l', href: '/war-civil-war/eastern/appomattox', img: '/war-img/appomattox-hero.jpg', hook: 'Run to ground after Petersburg falls, Lee makes one last dawn attack to reopen the road west, finds Union infantry massed across it, and surrenders the Army of Northern Virginia in a farmhouse parlor.' },
  ...
  { id: 'w-bentonville', name: 'Bentonville', year: 1865, m: 3, mo: 'Mar', place: 'Bentonville, NC', theatre: 'west', size: 'm', href: '/war-civil-war/western/bentonville', img: '/war-img/bentonville-hero.jpg', hook: 'The Confederacy’s last attack: Johnston catches one wing of Sherman’s divided column alone, nearly breaks it, then slips away across Mill Creek by night.' },
  { id: 'w-blakeley', name: 'Fort Blakeley', year: 1865, m: 4, mo: 'Apr', place: 'Baldwin Co., AL', theatre: 'west', size: 's', href: '/war-civil-war/western/fort-blakeley', img: '/war-img/fort-blakeley-hero.jpg', hook: 'The last major battle of the war, carried in about thirty minutes on the very day Lee surrendered, its wall taken in good part by 5,000 United States Colored Troops.' },
  ...
  { id: 't-westport', name: 'Westport', year: 1864, m: 10, mo: 'Oct', place: 'Kansas City, MO', theatre: 'tmis', size: 'm', href: '/war-civil-war/trans-mississippi/westport', img: '/war-img/westport-hero.jpg', hook: 'The largest battle ever fought west of the Mississippi, where two Union forces pin Price’s last invasion against the rivers and break it.' },
  ...
  { id: 'n-fortfisher2', name: 'Second Fort Fisher', year: 1865, m: 1, mo: 'Jan', place: 'Wilmington, NC', theatre: 'naval', size: 'm', href: '/war-civil-war/naval/second-fort-fisher', img: '/war-img/second-fort-fisher-hero.jpg', hook: 'Wilmington was the Confederacy’s last working seaport; once Fort Fisher fell at the river’s mouth, the supply line to Lee’s army closed and Appomattox followed.' },
]
...
export const CHAPTERS: Theme[] = [
  { id: 'mil-1861', name: 'Improvising a War', phase: 'outbreak', type: 'NARRATIVE', size: 'l', date: '1861', year: 1861, m: 1, hook: 'Two amateur nations raise armies from nothing, and the dream of a short war dies at Bull Run.', href: '/war-civil-war/how-the-war-was-fought/improvising-a-war', short: 'Improvising a War', img: '/war-img/improvising-a-war-hero.jpg', stack: true },
  { id: 'mil-1862', name: 'The Limited War Ends', phase: 'hard', type: 'NARRATIVE', size: 'l', date: '1862', year: 1862, m: 1, hook: 'The year’s huge battles kill the short-war dream, and Antietam turns a war for the Union into a war on slavery.', href: '/war-civil-war/how-the-war-was-fought/the-limited-war-ends', short: 'The Limited War Ends', img: '/war-img/the-limited-war-ends-hero.jpg', stack: true },
  { id: 'mil-1863', name: 'The Turning', phase: 'turning', type: 'NARRATIVE', size: 'l', date: '1863', year: 1863, m: 1, hook: 'Vicksburg and Gettysburg, and why the war was really won in the West, with Black soldiers now in the fight.', href: '/war-civil-war/how-the-war-was-fought/the-turning', short: 'The Turning', img: '/war-img/the-turning-hero.jpg', stack: true },
  { id: 'mil-1864', name: 'Coordinated Attrition', phase: 'total', type: 'NARRATIVE', size: 'l', date: '1864', year: 1864, m: 1, hook: 'Grant takes overall command and advances on every front at once, and the battlefield decides an election.', href: '/war-civil-war/how-the-war-was-fought/coordinated-attrition', short: 'Coordinated Attrition', img: '/war-img/coordinated-attrition-hero.jpg', stack: true },
  { id: 'mil-1865', name: 'The Collapse', phase: 'total', type: 'NARRATIVE', size: 'l', date: '1865', year: 1865, m: 1, hook: 'The Confederacy runs out of men, food, and rail, and the surrender secures emancipation for good.', href: '/war-civil-war/how-the-war-was-fought/the-collapse', short: 'The Collapse', img: '/war-img/the-collapse-hero.jpg', stack: true },
]
