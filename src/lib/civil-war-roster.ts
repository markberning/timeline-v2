...
export interface Theme {
  ...
  date: string; year: number; m: number; hook: string; href?: string; short?: string
}
...
export const THEMES: Theme[] = [
  ...
  { id: 'th-emancipation', name: 'The Emancipation Proclamation', phase: 'turning', type: 'POLITICS', size: 'l', date: 'Jan 1863', year: 1863, m: 1, hook: 'Lincoln changes what the entire war is for.', href: '/war-civil-war/off-the-battlefield/emancipation', short: 'Emancipation' },
