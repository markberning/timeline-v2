...
export const THEMES: Theme[] = [
  ...
  { id: 'th-prisons', name: 'Andersonville & the Prisons', phase: 'total', type: 'AFTERMATH', size: 'm', date: '1864–1865', year: 1864, m: 2, hook: 'Andersonville, and the prison camps where thousands starved.' },
  { id: 'th-atrocity', name: 'Fort Pillow & the Guerrilla War', phase: 'total', type: 'AFTERMATH', size: 'm', date: '1862–1865', year: 1864, m: 5, hook: 'No-quarter killings and the savage guerrilla war.' },
  { id: 'th-northwithin', name: 'The War Within the North', phase: 'total', type: 'POLITICS', size: 'l', date: '1861–1864', year: 1864, m: 11, hook: 'Copperheads, jailed editors, and the election Lincoln feared he’d lose.' },
  ...
  { id: 'th-reckoning', name: 'The Reckoning', phase: 'after', type: 'AFTERMATH', size: 'l', date: '1865 →', year: 1865, m: 12, hook: 'Three-quarters of a million dead, four million freed.' },
]
