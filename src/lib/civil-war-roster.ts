...
export const THEMES: Theme[] = [
  ...
  { id: 'th-diplomacy', name: 'Britain, France & Cotton', phase: 'hard', type: 'POLITICS', size: 'm', date: '1861–1863', year: 1862, m: 2, hook: 'Cotton diplomacy, the Trent Affair, and the foreign recognition the South never got.', href: '/war-civil-war/off-the-battlefield/cotton-diplomacy', short: 'Britain & Cotton', img: '/war-img/cotton-diplomacy-hero-trent-seizure.jpg', stack: true },
  { id: 'th-ironclads', name: 'Ironclads & the Blockade', phase: 'hard', type: 'SOCIETY', size: 'm', date: '1862', year: 1862, m: 3, hook: 'The Anaconda tightens; the Monitor and the Virginia change naval war overnight.', href: '/war-civil-war/off-the-battlefield/ironclads', short: 'Ironclads', img: '/war-img/ironclads-hero-monitor-merrimac-combat.jpg', stack: true },
  { id: 'th-tech', name: 'The New Way of War', phase: 'hard', type: 'SOCIETY', size: 'm', date: '1861–1865', year: 1862, m: 6, hook: 'Rifled muskets, the railroad, and the telegraph remade how battles were fought and supplied.', href: '/war-civil-war/off-the-battlefield/new-way-of-war', short: 'New Way of War', img: '/war-img/new-way-of-war-hero-railroad-bridge.jpg', stack: true },
  { id: 'th-homefront', name: 'The Home Front', phase: 'hard', type: 'SOCIETY', size: 'm', date: '1861–1865', year: 1862, m: 7, hook: 'Draft riots, war economies, and women running the farms and the hospitals.', href: '/war-civil-war/off-the-battlefield/home-front', short: 'The Home Front', img: '/war-img/home-front-hero-asylum-burning.jpg', stack: true },
  { id: 'th-medicine', name: 'Medicine & Disease', phase: 'hard', type: 'SOCIETY', size: 'm', date: '1861–1865', year: 1862, m: 8, hook: 'Two soldiers died of disease for every one killed in battle.', href: '/war-civil-war/off-the-battlefield/medicine', short: 'Medicine', img: '/war-img/medicine-hero-field-hospital.jpg', stack: true },
  ...
  { id: 'th-usct', name: 'Freedom Seekers & the USCT', phase: 'turning', type: 'SOCIETY', size: 'l', date: '1861–1865', year: 1863, m: 5, hook: 'The enslaved freed themselves — fleeing to Union lines by the hundreds of thousands, filling the contraband camps, and finally putting on Union blue: nearly 180,000 Black soldiers who changed the war’s meaning.', href: '/war-civil-war/off-the-battlefield/usct', short: 'Freedom & the USCT', img: '/war-img/usct-hero-soldier-family.jpg' },
