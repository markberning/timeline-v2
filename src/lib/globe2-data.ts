...
export const GLOBE2_CIVS: GlobeCiv2[] = [
  ...
  { id: "sumer", name: "Sumer", start: -4500, end: -1900, capital: [45.7, 31.3], region: "Southern Mesopotamia", summary: "The earliest urban civilization, Sumer invented cuneiform writing, the wheel for transport, monumental ziggurats, and the first city-states. Its temple-based economies and legal codes shaped every later Mesopotamian culture.", cities: ["Uruk", "Ur", "Eridu", "Lagash", "Nippur"], extent: [[44.5,29.8],[47.5,30.3],[47.2,32.5],[44.0,32.8],[43.5,31.2]] },
  { id: "akkad", name: "Akkadian Empire", start: -2334, end: -2154, capital: [44.4, 33.1], region: "Mesopotamia", summary: "Founded by Sargon of Akkad, the first true empire unified Sumerian city-states under a single ruler and spread Akkadian, a Semitic language, across the Near East.", cities: ["Akkad", "Kish", "Nineveh"], extent: [[40.0,30.0],[48.0,30.5],[48.5,36.5],[39.5,36.0]] },
  { id: "babylon", name: "Babylonia", start: -1894, end: -539, capital: [44.42, 32.54], region: "Mesopotamia", summary: "Babylon rose under Hammurabi, whose famous law code standardized justice. Later Neo-Babylonia under Nebuchadnezzar II rebuilt the city with the legendary Hanging Gardens and Ishtar Gate.", cities: ["Babylon", "Sippar", "Borsippa"], extent: [[43.0,30.5],[47.0,30.8],[47.0,34.5],[42.5,34.2]] },
  ...
  { id: "goguryeo", name: "Goguryeo", start: -37, end: 668, capital: [125.75, 39.03], region: "Korea & Manchuria", summary: "A militarized kingdom straddling Korea and Manchuria that repulsed massive Sui and Tang invasions before finally falling. Its tomb murals are UNESCO treasures.", cities: ["Pyongyang", "Gungnae"], extent: [[118.0,37.0],[132.0,37.0],[132.0,46.0],[118.0,46.0]] },
  { id: "silla", name: "Silla / Unified Silla", start: -57, end: 935, capital: [129.22, 35.86], region: "Korean Peninsula", summary: "Unifier of the Three Kingdoms of Korea in 668, Silla built Buddhist masterpieces like Seokguram Grotto and ruled a peninsula-wide realm for nearly three centuries.", cities: ["Gyeongju"], extent: [[125.0,33.0],[130.0,33.0],[130.0,39.0],[125.0,39.0]] },
  { id: "goryeo", name: "Goryeo", start: 918, end: 1392, capital: [126.56, 37.97], region: "Korean Peninsula", summary: "Namesake of modern 'Korea', Goryeo produced the world's first movable metal type and celadon ceramics, and carved the Tripitaka Koreana onto 81,000 woodblocks.", cities: ["Kaesong"], extent: [[124.5,33.0],[131.0,33.0],[131.0,43.0],[124.5,43.0]] },
  { id: "yamato", name: "Yamato / Nara Japan", start: 250, end: 794, capital: [135.8, 34.69], region: "Japan", summary: "The formative Japanese state, adopting Chinese writing, Buddhism, and imperial ritual. The Kojiki and Nihon Shoki were compiled in this era.", cities: ["Nara", "Asuka"], extent: [[130.0,31.0],[141.0,31.0],[141.0,41.0],[130.0,41.0]] },
  { id: "heian", name: "Heian Japan", start: 794, end: 1185, capital: [135.77, 35.01], region: "Japan", summary: "A courtly golden age that produced The Tale of Genji, elegant kana script, and a refined aristocratic aesthetic that still defines 'classical' Japan.", cities: ["Heian-kyō (Kyoto)"], extent: [[130.0,31.0],[142.0,31.0],[142.0,42.0],[130.0,42.0]] },
  ...
  { id: "chavin", name: "Chavín Culture", start: -900, end: -200, capital: [-77.18, -9.59], region: "Andean highlands", summary: "A pan-Andean religious tradition that spread from the temple complex of Chavín de Huántar, unifying early Peruvian art and iconography.", cities: ["Chavín de Huántar"], extent: [[-79.0,-12.0],[-75.0,-12.0],[-75.0,-6.0],[-79.0,-6.0]] },
  { id: "nazca", name: "Nazca Culture", start: -100, end: 800, capital: [-74.94, -14.83], region: "Southern Peru coast", summary: "Creators of the enormous Nazca Lines — geoglyphs only fully visible from the air — and a vivid polychrome ceramic tradition.", cities: ["Cahuachi"], extent: [[-76.5,-16.0],[-73.5,-16.0],[-73.5,-13.0],[-76.5,-13.0]] },
  { id: "moche", name: "Moche Culture", start: 100, end: 700, capital: [-78.82, -8.12], region: "Northern Peru coast", summary: "Skilled metallurgists and ceramicists whose astonishingly realistic portrait vessels offer a direct window into Andean faces and daily life.", cities: ["Cerro Blanco", "Sipán"], extent: [[-81.0,-10.0],[-77.5,-10.0],[-77.5,-5.5],[-81.0,-5.5]] },
  { id: "tiwanaku", name: "Tiwanaku", start: 300, end: 1000, capital: [-68.67, -16.55], region: "Lake Titicaca basin", summary: "A high-altitude empire at 3,850 m whose monumental gateways and raised-field agriculture sustained a polity across the Andes for seven centuries.", cities: ["Tiwanaku"], extent: [[-71.0,-18.0],[-66.0,-18.0],[-66.0,-14.0],[-71.0,-14.0]] },
  { id: "wari", name: "Wari Empire", start: 500, end: 1000, capital: [-74.22, -13.06], region: "Peruvian Andes", summary: "Often called the first Andean empire, Wari pioneered road networks and administrative centers that the Inca later inherited and expanded.", cities: ["Huari"], extent: [[-79.0,-16.0],[-72.0,-16.0],[-72.0,-8.0],[-79.0,-8.0]] },
