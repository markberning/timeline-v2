...
const GLOBE_TO_READER: Record<string, string> = {
  ...
  abbasid: 'islamic-golden-age',
  'al-andalus': 'al-andalus',
  celts: 'celtic-cultures',
  vikings: 'viking-age',
  'kievan-rus': 'kievan-rus',
  scythians: 'scythians',
  xiongnu: 'xiongnu-huns',
  huns: 'xiongnu-huns',
  gokturk: 'gokturk-khaganate',
  ...
  polynesia: 'polynesian-voyagers',
  aksum: 'kingdom-of-aksum',
  mali: 'mali-empire',
  songhai: 'songhai-empire',
  'greece-classical': 'ancient-greece',
  ...
  franks: 'early-medieval-europe',
  hre: 'high-medieval-europe',
  ottoman: 'ottoman-empire',
  safavid: 'safavid-persia',
  gupta: 'gupta-empire',
  chola: 'medieval-india',
  delhi: 'delhi-sultanate',
  vijayanagara: 'medieval-india',
  mughal: 'mughal-empire',
  han: 'han-dynasty',
  tang: 'tang-song-china',
  song: 'tang-song-china',
  yuan: 'yuan-dynasty',
  ming: 'ming-dynasty',
  goryeo: 'joseon-korea',
  ...
  aztec: 'aztec-empire',
  inca: 'inca-empire',
  nazca: 'andean-kingdoms',
  moche: 'andean-kingdoms',
  tiwanaku: 'middle-horizon-empires',
  wari: 'middle-horizon-empires',
}
