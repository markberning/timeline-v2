  ...
  home: {
    ...
    battleRegions: [
      { id: 'new-england', label: 'New England & Canada', range: '1775', color: { light: '#2c7d99', dark: '#5fb0cc', dot: '#2c7d99' },
        ...
        states: [
          { name: 'Massachusetts', label: 'MASS.', labelLon: -72.0, labelLat: 42.2, labelSize: 19 },
          { name: 'Quebec', label: 'QUÉBEC', labelLon: -72.6, labelLat: 46.8, labelSize: 20 },
          { name: 'Maine', label: 'MAINE', labelLon: -69.2, labelLat: 45.2, labelSize: 19 },
          { name: 'New Hampshire', label: 'N.H.', labelLon: -71.6, labelLat: 43.9, labelSize: 18 },
          { name: 'Vermont', label: 'VT.', labelLon: -72.8, labelLat: 44.2, labelSize: 18 },
          { name: 'New York' }, { name: 'Connecticut' }, { name: 'Rhode Island' },
        ],
        labels: [{ text: 'ATLANTIC OCEAN', lon: -68.3, lat: 42.6, kind: 'water', size: 20 }] },
      { id: 'middle', label: 'New York & New Jersey', range: '1776–79', color: { light: '#8a5b86', dark: '#c79cd0', dot: '#8a5b86' },
        ...
        states: [
          { name: 'New York', label: 'NEW YORK', labelLon: -74.25, labelLat: 41.45, labelSize: 20 },
          { name: 'New Jersey', label: 'N.J.', labelLon: -74.6, labelLat: 40.3, labelSize: 19 },
          { name: 'Pennsylvania', label: 'PENN.', labelLon: -75.4, labelLat: 40.95, labelSize: 18 },
          { name: 'Connecticut', label: 'CONN.', labelLon: -73.0, labelLat: 41.5, labelSize: 18 },
        ],
        labels: [{ text: 'ATLANTIC', lon: -73.1, lat: 39.95, kind: 'water', size: 19 }] },
      { id: 'saratoga', label: 'The Hudson & Saratoga', range: '1777', color: { light: '#b3852f', dark: '#d8b25a', dot: '#b3852f' },
        ...
        states: [
          { name: 'New York', label: 'NEW YORK', labelLon: -74.7, labelLat: 43.35, labelSize: 20 },
          { name: 'Vermont', label: 'VT.', labelLon: -72.75, labelLat: 43.95, labelSize: 19 },
          { name: 'Massachusetts', label: 'MASS.', labelLon: -72.4, labelLat: 42.7, labelSize: 18 },
          { name: 'New Hampshire', label: 'N.H.', labelLon: -71.55, labelLat: 43.7, labelSize: 18 },
        ],
        lakes: [
          { name: 'Lake Champlain', label: 'LAKE CHAMPLAIN', labelLon: -73.05, labelLat: 44.45, labelSize: 19, labelAnchor: 'start' },
          { name: 'Lake George', label: 'L. GEORGE', labelLon: -73.95, labelLat: 43.62, labelSize: 17.5, labelAnchor: 'end' },
        ],
        labels: [{ text: 'HUDSON R.', lon: -73.95, lat: 42.85, kind: 'water', size: 18 }] },
      { id: 'pennsylvania', label: 'Pennsylvania', range: '1777', color: { light: '#4e8a52', dark: '#84c089', dot: '#4e8a52' },
        ...
        states: [
          { name: 'Pennsylvania', label: 'PENNSYLVANIA', labelLon: -75.95, labelLat: 40.45, labelSize: 19 },
          { name: 'New Jersey', label: 'N.J.', labelLon: -74.6, labelLat: 40.05, labelSize: 18 },
          { name: 'Delaware', label: 'DEL.', labelLon: -75.5, labelLat: 39.5, labelSize: 17 },
          { name: 'Maryland' },
        ],
        labels: [{ text: 'DELAWARE R.', lon: -75.3, lat: 39.95, kind: 'water', size: 17 }] },
      { id: 'south', label: 'The South', range: '1779–81', color: { light: '#b3502f', dark: '#d98a5a', dot: '#b3502f' },
        ...
        states: [
          { name: 'Virginia', label: 'VIRGINIA', labelLon: -78.8, labelLat: 37.4, labelSize: 19 },
          { name: 'North Carolina', label: 'N. CAROLINA', labelLon: -79.6, labelLat: 35.4, labelSize: 19 },
          { name: 'South Carolina', label: 'S. CAROLINA', labelLon: -81.1, labelLat: 34.0, labelSize: 19 },
          { name: 'Georgia', label: 'GEORGIA', labelLon: -83.0, labelLat: 32.6, labelSize: 19 },
        ],
        labels: [{ text: 'ATLANTIC OCEAN', lon: -76.7, lat: 32.5, kind: 'water', size: 20 }] },
    ...
    battleViews: {
      ...
      'rev-vincennes': {
        ...
        states: [
          { name: 'Indiana', label: 'INDIANA', labelLon: -86.3, labelLat: 40.0, labelSize: 19 },
          { name: 'Illinois', label: 'ILLINOIS', labelLon: -89.4, labelLat: 39.6, labelSize: 19 },
          { name: 'Ohio', label: 'OHIO', labelLon: -82.7, labelLat: 40.2, labelSize: 19 },
          { name: 'Kentucky', label: 'KENTUCKY', labelLon: -85.0, labelLat: 37.4, labelSize: 19 },
          { name: 'Virginia' }, { name: 'West Virginia' },
        ],
        labels: [{ text: 'THE ILLINOIS COUNTRY', lon: -88.4, lat: 41.4, kind: 'faint', size: 18 }, { text: 'OHIO R.', lon: -85.0, lat: 38.4, kind: 'water', size: 17 }],
      },
