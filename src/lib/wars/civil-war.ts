...
export const CIVIL_WAR: WarConfig = {
  ...
  lanes: [
    ...
    { id: 'howfought', kind: 'story', label: 'How the War Happened', short: 'How it Happened', href: '/war-civil-war/how-the-war-was-fought', ready: true, color: WAR_STORY_COLOR, skinVar: '--warstory' },
