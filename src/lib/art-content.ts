...
export const PICASSO: ArtArtistContent = {
  ...
  keyWorks: [
    ...
    { year: 1957, name: 'Las Meninas (series)', period: 'late', hook: 'Fifty-eight variations on Velázquez, one summer.' },
  ],
  life: [
    ...
    { year: 1917, label: 'Designs for Ballets Russes (Parade)' },
    { year: 1918, label: 'Marries Olga Khokhlova' },
