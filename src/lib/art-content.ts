...
// is a born-verified Wikipedia article title (the work's own page where one
// exists; the artist's page as a confirmed broad fallback otherwise).
export interface CanonWork { year: number; name: string; artist: string; wiki: string }
...
export const CUBISM: ArtMovementContent = {
  ...
  canon: [
    { year: 1907, name: 'Les Demoiselles d’Avignon', artist: 'Picasso', wiki: "Les Demoiselles d'Avignon" },
    { year: 1908, name: 'Houses at L’Estaque', artist: 'Braque', wiki: "Houses at l'Estaque" },
    { year: 1908, name: 'Three Women', artist: 'Picasso', wiki: 'Pablo Picasso' },
    { year: 1909, name: 'Houses on the Hill, Horta de Ebro', artist: 'Picasso', wiki: 'Pablo Picasso' },
    { year: 1910, name: 'Girl with a Mandolin (Fanny Tellier)', artist: 'Picasso', wiki: 'Girl with a Mandolin' },
    { year: 1910, name: 'Portrait of Daniel-Henry Kahnweiler', artist: 'Picasso', wiki: 'Daniel-Henry Kahnweiler (Picasso)' },
    { year: 1910, name: 'Violin and Candlestick', artist: 'Braque', wiki: 'Georges Braque' },
    { year: 1910, name: 'Violin and Jug', artist: 'Braque', wiki: 'Pitcher and Violin' },
    { year: 1911, name: 'The Portuguese', artist: 'Braque', wiki: 'Georges Braque' },
    { year: 1911, name: 'Ma Jolie', artist: 'Picasso', wiki: 'Pablo Picasso' },
    { year: 1911, name: 'Le Goûter (Tea Time)', artist: 'Metzinger', wiki: 'Tea Time (Metzinger)' },
    { year: 1911, name: 'The Eiffel Tower', artist: 'Delaunay', wiki: 'Eiffel Tower (Delaunay series)' },
    { year: 1911, name: 'Abundance', artist: 'Le Fauconnier', wiki: 'Henri Le Fauconnier' },
    { year: 1911, name: 'Portrait of Jacques Nayral', artist: 'Gleizes', wiki: 'Portrait of Jacques Nayral' },
    { year: 1912, name: 'Still Life with Chair Caning', artist: 'Picasso', wiki: 'Still Life with Chair Caning' },
    { year: 1912, name: 'Fruit Dish and Glass', artist: 'Braque', wiki: 'Fruit Dish and Glass' },
    { year: 1912, name: 'The City of Paris', artist: 'Delaunay', wiki: 'Robert Delaunay' },
    { year: 1912, name: 'Simultaneous Windows', artist: 'Delaunay', wiki: 'Windows (Delaunay series)' },
    { year: 1912, name: 'Nude Descending a Staircase No. 2', artist: 'Duchamp', wiki: 'Nude Descending a Staircase, No. 2' },
    { year: 1912, name: 'Man on a Balcony', artist: 'Gleizes', wiki: 'Man on a Balcony' },
    { year: 1912, name: 'Woman in Blue', artist: 'Léger', wiki: 'Fernand Léger' },
    { year: 1912, name: 'Homage to Pablo Picasso', artist: 'Gris', wiki: 'Juan Gris' },
    { year: 1913, name: 'The Cardiff Team', artist: 'Delaunay', wiki: 'Robert Delaunay' },
    { year: 1913, name: 'Contrast of Forms', artist: 'Léger', wiki: 'Fernand Léger' },
    { year: 1913, name: 'Udnie', artist: 'Picabia', wiki: 'Udnie' },
    { year: 1914, name: 'The Sunblind', artist: 'Gris', wiki: 'Juan Gris' },
    { year: 1914, name: 'Breakfast (Le Petit Déjeuner)', artist: 'Gris', wiki: 'Juan Gris' },
    { year: 1915, name: 'Man with a Guitar', artist: 'Lipchitz', wiki: 'Jacques Lipchitz' },
    { year: 1919, name: 'The City (La Ville)', artist: 'Léger', wiki: 'The City (Léger)' },
    { year: 1921, name: 'Three Musicians', artist: 'Picasso', wiki: 'Three Musicians (Picasso)' },
  ],
  sections: [
...
export const REALISM: ArtMovementContent = {
  ...
  canon: [
    { year: 1826, name: 'The Bridge at Narni', artist: 'Corot', wiki: 'The Bridge at Narni' },
    { year: 1831, name: 'Gargantua', artist: 'Daumier', wiki: 'Honoré Daumier' },
    { year: 1834, name: 'Rue Transnonain', artist: 'Daumier', wiki: 'Honoré Daumier' },
    { year: 1834, name: 'The Legislative Belly', artist: 'Daumier', wiki: 'Honoré Daumier' },
    { year: 1844, name: 'Under the Birches, Evening', artist: 'Rousseau', wiki: 'Théodore Rousseau' },
    { year: 1848, name: 'The Winnower', artist: 'Millet', wiki: 'The Winnower (Millet)' },
    { year: 1848, name: 'The Uprising', artist: 'Daumier', wiki: 'Honoré Daumier' },
    { year: 1849, name: 'After Dinner at Ornans', artist: 'Courbet', wiki: 'After Dinner at Ornans' },
    { year: 1849, name: 'The Stone Breakers', artist: 'Courbet', wiki: 'The Stone Breakers' },
    { year: 1849, name: 'Ploughing in the Nivernais', artist: 'Bonheur', wiki: 'Ploughing in the Nivernais' },
    { year: 1850, name: 'A Burial at Ornans', artist: 'Courbet', wiki: 'A Burial at Ornans' },
    { year: 1850, name: 'The Sower', artist: 'Millet', wiki: 'The Sower (Millet)' },
    { year: 1853, name: 'Harvesters Resting (Ruth and Boaz)', artist: 'Millet', wiki: 'Jean-François Millet' },
    { year: 1853, name: 'The Bathers', artist: 'Courbet', wiki: 'The Bathers (Courbet)' },
    { year: 1854, name: 'The Wheat Sifters', artist: 'Courbet', wiki: 'The Wheat Sifters' },
    { year: 1854, name: 'The Meeting (Bonjour, Monsieur Courbet)', artist: 'Courbet', wiki: 'The Meeting (Courbet)' },
    { year: 1855, name: 'The Painter’s Studio', artist: 'Courbet', wiki: "The Painter's Studio" },
    { year: 1855, name: 'The Horse Fair', artist: 'Bonheur', wiki: 'The Horse Fair' },
    { year: 1857, name: 'The Gleaners', artist: 'Millet', wiki: 'The Gleaners' },
    { year: 1857, name: 'Young Ladies on the Banks of the Seine', artist: 'Courbet', wiki: 'Gustave Courbet' },
    { year: 1859, name: 'The Angelus', artist: 'Millet', wiki: 'The Angelus (painting)' },
    { year: 1859, name: 'The Banks of the Oise', artist: 'Daubigny', wiki: 'Charles-François Daubigny' },
    { year: 1862, name: 'Man with a Hoe', artist: 'Millet', wiki: 'Man with a Hoe' },
    { year: 1862, name: 'The Third-Class Carriage', artist: 'Daumier', wiki: 'The Third-Class Carriage' },
    { year: 1863, name: 'The Laundress', artist: 'Daumier', wiki: 'The Laundress (Daumier)' },
    { year: 1863, name: 'Shepherdess with her Flock', artist: 'Millet', wiki: 'Shepherdess with her Flock' },
    { year: 1864, name: 'Souvenir de Mortefontaine', artist: 'Corot', wiki: 'Souvenir de Mortefontaine' },
    { year: 1866, name: 'The Origin of the World', artist: 'Courbet', wiki: "L'Origine du monde" },
    { year: 1869, name: 'Woman with a Pearl', artist: 'Corot', wiki: 'Jean-Baptiste-Camille Corot' },
    { year: 1872, name: 'The Trout', artist: 'Courbet', wiki: 'Gustave Courbet' },
  ],
  sections: [
