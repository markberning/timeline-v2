...
export const POST_IMP: ArtMovementContent = {
  ...
  works: [
    ...
    { id: 'starry-night', year: 1889, name: 'The Starry Night', artist: 'Van Gogh', place: 'Saint-Rémy', size: 'l', blurb: 'A cypress, a sleeping village and a swirling sky painted from memory in his asylum room at Saint-Paul-de-Mausole. The most reproduced picture in Western art after the Mona Lisa, made in spite of the suffering — not because of it.', palette: ['#2a3a6a', '#c8b84a', '#0e1428'], imageUrl: ART_IMG.starryNight, credit: 'Van Gogh, The Starry Night, 1889 · Museum of Modern Art, New York' },
  ...
  canon: [
    ...
    { year: 1889, name: 'The Starry Night', artist: 'Van Gogh', wiki: 'The Starry Night', img: ART_IMG.starryNight, note: 'A cypress, a sleeping village and a swirling sky, painted from memory in June 1889 in his room at the Saint-Paul-de-Mausole asylum. The most reproduced picture in Western art after the Mona Lisa, and Van Gogh painted it locked up.' },
