...
export const NAVIGATOR_TLS: NavigatorTl[] = [
  ...
  { id: 'uyghur-steppe', label: 'Uyghur & Qara-Khitai Steppe', subtitle: "the steppe's forgotten half-millennium", region: 'asia', startYear: 744, endYear: 1206, hasContent: false },
