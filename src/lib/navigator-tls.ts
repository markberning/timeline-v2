...
export const NAVIGATOR_TLS: NavigatorTl[] = [
  ...
  { id: 'islamic-persia', label: 'Islamic Persia', subtitle: 'Persia conquers its conquerors', region: 'near-east', startYear: 651, endYear: 1501, hasContent: false },
  ...
  { id: 'medieval-japan', label: 'Medieval Japan', subtitle: 'the samurai centuries — shogun, warlord, and the sword', region: 'asia', startYear: 1185, endYear: 1603, hasContent: false },
  ...
  { id: 'muscovite-russia', label: 'Muscovite Russia', subtitle: 'from the Mongol yoke to the first tsars', region: 'europe', startYear: 1240, endYear: 1721, hasContent: false },
