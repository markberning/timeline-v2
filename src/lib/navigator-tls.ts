...
export const NAVIGATOR_TLS: NavigatorTl[] = [
  ...
  { id: 'islamic-persia', label: 'Islamic Persia', subtitle: 'Persia conquers its conquerors', region: 'near-east', startYear: 651, endYear: 1501, hasContent: true },
  ...
  { id: 'swahili-coast', label: 'The Swahili Coast', subtitle: 'the African civilization that chose the ocean', region: 'africa', startYear: 600, endYear: 1700, hasContent: true },
  ...
  { id: 'medieval-japan', label: 'Medieval Japan', subtitle: 'the samurai centuries — shogun, warlord, and the sword', region: 'asia', startYear: 1185, endYear: 1603, hasContent: true },
  ...
  { id: 'germanic-tribes', label: 'Germanic Tribes', subtitle: "Rome's barbarian frontier", region: 'europe', startYear: -113, endYear: 375, hasContent: true },
  { id: 'the-goths', label: 'The Goths', subtitle: 'Scandza to the sack of Rome', region: 'europe', startYear: 150, endYear: 554, hasContent: true },
  { id: 'migration-period', label: 'The Migration Period', subtitle: "the Völkerwanderung's peoples on the move", region: 'europe', startYear: 375, endYear: 568, hasContent: true },
  { id: 'anglo-saxon-england', label: 'Anglo-Saxon England', subtitle: 'adventus Saxonum to Lindisfarne', region: 'europe', startYear: 410, endYear: 793, hasContent: true },
  { id: 'vendel-scandinavia', label: 'The Vendel Age', subtitle: 'the world that built the longship', region: 'europe', startYear: 550, endYear: 793, hasContent: true },
  ...
  { id: 'muscovite-russia', label: 'Muscovite Russia', subtitle: 'from the Mongol yoke to the first tsars', region: 'europe', startYear: 1240, endYear: 1721, hasContent: true },
  { id: 'age-of-exploration', label: 'The Age of Exploration', subtitle: 'wooden ships stitch the whole world together — for good and ill', region: 'europe', startYear: 1415, endYear: 1700, hasContent: false },
  { id: 'atlantic-slave-trade', label: 'The Atlantic Slave Trade', subtitle: 'the largest forced migration in history — and the people who outlived it', region: 'africa', startYear: 1500, endYear: 1888, hasContent: false },
  { id: 'latin-american-independence', label: 'Latin American Independence', subtitle: 'a hemisphere tears itself free from Spain and Portugal', region: 'americas', startYear: 1808, endYear: 1903, hasContent: false },
  ...
  { id: 'mississippian-culture', label: 'Mississippian', subtitle: "Cahokia's mound-building chiefdoms", region: 'americas', startYear: 800, endYear: 1600, hasContent: true },
