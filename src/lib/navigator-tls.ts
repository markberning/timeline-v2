...
export const NAVIGATOR_TLS: NavigatorTl[] = [
  ...
  { id: 'age-of-exploration', label: 'The Age of Exploration', subtitle: 'wooden ships stitch the whole world together — for good and ill', region: 'europe', startYear: 1415, endYear: 1700, hasContent: true },
  { id: 'atlantic-slave-trade', label: 'The Atlantic Slave Trade', subtitle: 'the largest forced migration in history — and the people who outlived it', region: 'africa', startYear: 1500, endYear: 1888, hasContent: true },
  { id: 'latin-american-independence', label: 'Latin American Independence', subtitle: 'a hemisphere tears itself free from Spain and Portugal', region: 'americas', startYear: 1808, endYear: 1903, hasContent: true },
