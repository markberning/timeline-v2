      ...
      >
        ...
        >
          <span
            ...
            style={{ color: 'var(--accent)', fontSize: 'var(--ch-subtitle)' }}
          >
            {String(chapter.number).padStart(2, '0')}
          </span>
          <div className="min-w-0 flex-1">
            <h2 className="font-[family-name:var(--font-lora)] leading-snug" style={{ fontSize: 'var(--ch-title)' }}>
              {(() => {
            ...
            {chapter.subtitle && (
              <p className="text-foreground/55 mt-0.5 italic font-[family-name:var(--font-lora)] leading-snug" style={{ fontSize: 'var(--ch-subtitle)' }}>{chapter.subtitle}</p>
            )}
            {chapter.dateRange && (
              <p className="text-foreground/35 mt-0.5 tabular-nums" style={{ fontSize: 'var(--ch-meta)' }}>{chapter.dateRange}</p>
            )}
          </div>
        </div>
