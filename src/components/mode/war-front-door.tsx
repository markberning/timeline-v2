...
export const WAR_EVENTS: War[] = [
  { id: 'fi', band: 'col', size: 's', name: 'French & Indian War', range: '1754–1763', vs: 'Britain & colonies vs. France & allies', hook: 'A continent-sized turf war — also the first half of a world war.', palette: ['#5f6b3a', '#1c1a10', '#a08a4a'], imgLabel: 'West, The Death of General Wolfe (Quebec, 1759)', img: '/war-img/fi-war-hero.jpg', href: '/war-french-indian' },
  { id: 'rev', band: 'forge', size: 'm', name: 'American Revolution', range: '1775–1783', vs: 'United States vs. Great Britain', hook: 'We hold these truths to be — well, you know the rest.', palette: ['#7a3b1c', '#c08a3a', '#0a0a0a'], imgLabel: 'Washington Crossing the Delaware', img: '/war-img/rev-war-hero.jpg', href: '/war-revolution' },
