...
const WAR_EVENTS: War[] = [
  ...
  { id: 'cw', band: 'ind', size: 'l', name: 'American Civil War', range: '1861–1865', vs: 'Union vs. Confederacy', hook: 'The argument the country had been refusing to finish since 1789.', palette: ['#3a2a1c', '#7a1422', '#100506'], imgLabel: 'Battle of Gettysburg', href: '/war-pilot-preview' },
