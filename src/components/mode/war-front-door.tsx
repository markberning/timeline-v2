...
export const WAR_EVENTS: War[] = [
  { id: 'fi', band: 'col', size: 's', name: 'French & Indian War', range: '1754–1763', vs: 'Britain & colonies vs. France & allies', hook: 'A continent-sized turf war — also the first half of a world war.', palette: ['#5f6b3a', '#1c1a10', '#a08a4a'], imgLabel: 'Lake George skirmish', href: '/war-french-indian' },
