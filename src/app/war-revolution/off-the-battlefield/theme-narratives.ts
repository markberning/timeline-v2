...
export const THEME_NARR: Record<string, Narr> = {
  ...
  "slavery-and-the-revolution": {
    ...
    "blocks": [
      ...
      {
        "p": "Johnson was a hostile witness. He opposed American independence and slavery both, and the line landed because it was true. It did not take an enemy of the Revolution to see it. Almost a year before the fighting started, Abigail Adams wrote to her husband John from Braintree, Massachusetts, in plainer, more anguished form: \"I wish most sincerely there was not a slave in the province. It always appeared a most iniquitous scheme to me — fight ourselves for what we are daily robbing and plundering from those who have as good a right to freedom as we have.\" She wrote that amid rumors that enslaved people in Boston were planning to offer to fight for the royal governor in exchange for their freedom, which shows the enslaved had already done the same arithmetic everyone else was doing, only sooner."
      },
      {
