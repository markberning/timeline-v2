...
const DATA: BattleData = {
  ...
  note: 'A worn-out converted merchantman grappled a brand-new British warship off the English coast, two of Jones\'s big guns burst at first fire, his own consort raked him from behind, and the ship was sinking under him when the Englishman struck first.',
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'Jones\'s squadron', str: 'Bonhomme Richard (~40 guns, ~320 crew) with the Alliance (36), Pallas (32), and Vengeance (12)', cmd: 'Capt. John Paul Jones', note: 'A French-financed squadron under American colors: the flagship was an old converted East Indiaman, her crew from half the ports of Europe, each captain nearly independent under a shared agreement, which is why the Alliance fired into her own flagship.' },
    { side: 'c', tag: 'British', force: 'The Baltic convoy escort', str: 'HMS Serapis (rated 44 guns, brand new) and the hired Countess of Scarborough (20), guarding a 40-plus-ship convoy', cmd: 'Capt. Richard Pearson', note: 'A powerful new frigate launched only that March, escorting the timber, hemp, and tar of British sea power home from the Baltic; Pearson put his ships between Jones and the convoy, waved the merchantmen to safety, and fought a ship that would not sink until it had taken his.' },
  ],
  casualties: {
    union: 155, csa: 140,
    unionLabel: 'American ~140–170 of ~320',
    csaLabel: 'British 117+ (likely ~130–150)',
    footnote: 'The honest headline for both ships is the same: roughly half the men on each were killed or wounded. American: about 140 to 170 of ~320 crew, no muster-verified figure. British: at least 117 by Pearson\'s own incomplete return, probably nearer 130 to 150; no definitive total survives for either ship.',
  },
  commanders: [
