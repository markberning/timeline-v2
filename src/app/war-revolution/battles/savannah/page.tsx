...
const DATA: BattleData = {
  ...
  note: 'A French battle fleet racing the hurricane season brought the most diverse army of the war to take back Savannah; while the British commander asked for a day to consider surrender, a relief column waded the creeks and made the garrison defensible, and the betrayed dawn assault cost the attackers about five men for every defender.',
  ...
  sides: [
    { side: 'u', tag: 'Allied', force: 'The Franco-American army', str: 'about 7,500 (roughly 4,000 French including ~545 Chasseurs-Volontaires de Saint-Domingue; about 2,000-plus Americans; Pulaski\'s legion of ~200 horse), with more than 20 French ships of the line offshore', cmd: 'Vice Adm. the comte d\'Estaing (French) and Maj. Gen. Benjamin Lincoln (American)', note: 'The most diverse army of the war: French line regiments, an Irish regiment in French service, over 500 free men of color from Saint-Domingue, Continentals and militia, and a Polish general\'s legion; the fleet, most of the troops, and the hurricane deadline were all French.' },
    { side: 'c', tag: 'British', force: 'The Savannah garrison', str: 'roughly 3,200 effectives swelling toward 4,800 with armed sailors, militia, and Black auxiliaries, behind about 13 redoubts and more than 100 guns', cmd: 'Maj. Gen. Augustine Prevost', note: 'A thin garrison transformed in three weeks by a Royal Engineer\'s earthwork sprint dug by hundreds of enslaved laborers, and by Lt. Col. Maitland\'s ~800-man relief column that waded the coastal creeks from Beaufort during the 24-hour truce.' },
  ],
  casualties: {
    union: 948, csa: 155,
    unionLabel: 'Allied ~800 killed & wounded + 100+ prisoners',
    csaLabel: 'British ~155 (about 40 killed)',
    footnote: 'Allied: about 244 killed, 584 to 600 wounded, and about 120 captured, total near 950 (the American Battlefield Trust rounds to 948); the French bore the bulk, roughly 650 of about 800 killed and wounded. Almost all fell in under an hour at Spring Hill. British: about 40 killed, 63 wounded, 52 missing, roughly 155; Prevost\'s 1,000 to 1,200 is the winner\'s inflation.',
  },
  commanders: [
