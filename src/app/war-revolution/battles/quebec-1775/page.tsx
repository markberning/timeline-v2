...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The invasion army before the walls', str: '~900–1,200 effectives (men actually fit for duty)', cmd: 'Maj. Gen. Richard Montgomery', note: 'Two feints at the western walls covered two real columns converging on the Lower Town in a blizzard, Montgomery\'s from the south and Arnold\'s from the north. The attack was forced by the calendar: most of the men\'s enlistments (their agreed terms of service) expired at midnight on December 31, after which they could lawfully walk home.' },
  ...
  casualties: {
    ...
    footnote: 'American reports vary, roughly 30–51 killed and 30–36 wounded (Arnold\'s own report said about 60 killed and wounded), plus ~400–430 captured (Carleton counted 431 prisoners); several of the dead were not recovered until the spring thaw. Carleton\'s official return counted about 5 killed and 13 to 14 wounded; a few witness accounts run as high as ~50, with the official return the firmest figure. All figures are ranges; sickness, expiring enlistments, and detachments make any precise American count false, and witness tallies of the defenders\' losses disagree with the official return.',
  },
  commanders: [
