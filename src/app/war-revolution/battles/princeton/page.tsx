...
const DATA: BattleData = {
  ...
  sides: [
    ...
    { side: 'c', tag: 'British', force: 'The Princeton garrison', str: '~1,200: the 17th, 40th, and 55th Regiments of Foot (infantry regiments), with dragoons (mounted soldiers) and guns; about 700–800 engaged at the Clarke farm', cmd: 'Lt. Col. Charles Mawhood', note: 'Caught marching the wrong way at sunrise, Mawhood\'s regiments turned and went straight at the Americans. The 17th Foot\'s charge with the bayonet (the blade on a musket\'s muzzle) broke the first American brigade it met, and when the field turned, Mawhood cut his way out and saved most of his regiment. Washington himself wrote that they "made a gallant resistance."' },
  ],
  casualties: {
    union: 85, csa: 360,
    unionLabel: 'American ~70–100',
    csaLabel: 'British ~270–450',
    footnote: 'American: ~70–100 total; Washington reported "about twenty five or thirty privates" killed plus several officers, with around 40 wounded. The officer toll was heavy for so short a fight: Brig. Gen. Hugh Mercer (died of his wounds January 12), Col. John Haslet, Capt. Daniel Neil, Capt. John Fleming. British: ~270–450 total, and the figures genuinely conflict. The official return (casualty report) of Gen. William Howe (the British commander in chief in America) admitted 18 killed, 58 wounded, and about 200 missing; Washington claimed around 100 killed and a total loss near 500; the historian Stryker (1898) put it near 450. The firmest number is the prisoners: about 230–300 captured, including 194 who surrendered in Nassau Hall. The British totals depend on whose count you believe; the disagreement between Howe\'s return and the American counts is itself part of the record. The common grave on the battlefield holds 15 Americans and 21 British.',
  },
  commanders: [
