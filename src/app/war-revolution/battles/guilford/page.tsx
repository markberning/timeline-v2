...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The Southern army', str: 'About 4,400 to 4,500, set in three lines (North Carolina militia, then Virginia militia, then Continentals)', cmd: 'Maj. Gen. Nathanael Greene', note: 'The Cowpens blueprint: ~1,000 North Carolina militia behind a rail fence on the first line, ~1,200 Virginia militia in thick woods on the second, and ~1,400 Continentals in a clearing on the third, with Lee\'s Legion and Washington\'s cavalry on the flanks.' },
    { side: 'c', tag: 'British', force: 'Cornwallis\'s army', str: 'Roughly 1,900 to 2,100 effectives, outnumbered better than two to one', cmd: 'Lt. Gen. Charles, Earl Cornwallis', note: 'The 23rd and 33rd Foot, 71st Highlanders, Regiment von Bose, the elite Brigade of Guards under O\'Hara, jägers and light infantry, Tarleton\'s cavalry in reserve; every man had marched 240 miles with the baggage burned behind him to force this fight.' },
  ],
  casualties: {
    union: 532, csa: 264,
    ...
    footnote: 'British: about 93 killed, 413 wounded, 26 missing, roughly 532 of the ~2,100 engaged (about a quarter), with the Foot Guards battalions losing near 56%. American: about 79 killed and 185 wounded, plus roughly 1,000 "missing" North Carolina militia who fired their volleys and went home; Greene\'s effective loss was only about 6%. The disproportion is the whole point: the winner bled four times as hard as the loser.',
  },
  commanders: [
