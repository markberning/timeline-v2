...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The main Continental Army', str: 'more than 14,000 (Lee\'s vanguard ~4,500; main body ~7,800; Morgan\'s ~600–800 riflemen; plus militia)', cmd: 'Gen. George Washington', note: 'The army Steuben drilled at Valley Forge; roughly half the Continentals were recruits enlisted since January, so what held the line in the open field was training, not veteran seasoning, and Monmouth was its first major test.' },
    { side: 'c', tag: 'British', force: 'Clinton\'s column on the march', str: 'about 10,000 of Clinton\'s best troops turned to fight; the whole column with its 1,500-wagon train ran 17,700 to 19,700', cmd: 'Gen. Sir Henry Clinton', note: 'An army on a forced evacuation marching some 20,000 people and a 12-mile baggage train across New Jersey toward Sandy Hook; when Lee\'s vanguard struck the rear, Clinton turned his elite first division around and threw it at them.' },
  ],
  casualties: {
    union: 475, csa: 550,
    unionLabel: 'American ~450–500 including the heat dead',
    csaLabel: 'British ~360 admitted · likely well over 500',
    footnote: 'American: Washington\'s return gave 69 killed, 161 wounded, 132 to 140 missing; real losses including the heat dead are usually put at 450 to 500. British: Clinton\'s return totaled about 358 (65 killed, 59 dead of heatstroke, 170 wounded, 64 missing), but American burial parties counted about 250 to 300 British dead on the field, far above Clinton\'s admitted figure; no single number reconciles the two, and on both sides the heat killed men who never saw an enemy.',
  },
  commanders: [
