...
const DATA: BattleData = {
  ...
  note: 'The decisive blow fell at sea on September 5, when de Grasse\'s fleet beat the British off the Virginia Capes and sealed the bay; what had been a safe anchorage became a trap, and on October 19 more than 7,000 men marched out and laid down their arms.',
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The allied army', str: '~19,000–19,800 on land (roughly 8,800 Americans + 7,800–10,800 French), plus de Grasse\'s fleet of 24 ships of the line in the bay', cmd: 'Gen. George Washington · Gen. comte de Rochambeau', note: 'A combined Franco-American force; the siege artillery, the engineers, and the fleet that sealed the bay were all French, while Lafayette had pinned Cornwallis in Virginia for months so the army would still be there when the trap shut.' },
    { side: 'c', tag: 'British', force: 'Cornwallis\'s southern army', str: '~8,000–9,000, about half German auxiliaries; roughly half sick by the surrender, plus ~700 at Gloucester Point across the river', cmd: 'Lt. Gen. Earl Cornwallis', note: 'The British southern army, worn down by the Carolinas campaign and Virginia summer malaria, dug in on the one condition that the Royal Navy held the water; when de Grasse sealed the bay, the anchorage became a trap, and Clinton\'s promised relief sailed from New York the day Cornwallis surrendered.' },
  ],
  casualties: {
    union: 389, csa: 500,
    ...
    footnote: 'Allied: about 88 killed and 301 wounded in the land siege, roughly 389 total; French losses at Redoubt 9 (~15 killed, 77 wounded) heavier than the Americans\' at Redoubt 10 (~9 killed, 25 wounded). British: several hundred killed and wounded (artillery makes the count unreliable); the catastrophe was the surrender: more than 7,000 soldiers (sources run 7,400 to 7,700 depending on categories), plus 800+ sailors and 240-odd guns, marched into captivity on October 19, roughly a third of all British forces in North America.',
  },
  commanders: [
