...
const DATA: BattleData = {
  ...
  note: 'A 26-year-old colonel marched ~180 miles across flooded prairie in midwinter, wading icy floodwater to the chest the last week, bluffed a fort into surrender without losing a man in the fighting, and had four captured Native warriors tomahawked in front of the gate so the garrison and the watching nations would know what British protection was worth.',
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'Clark\'s Illinois regiment', str: '~170 on the overland march (Virginia and Kentucky riflemen plus French volunteers, nearly half); the row-galley Willing with ~40 more arrived Feb 27, two days too late', cmd: 'Lt. Col. George Rogers Clark', note: 'Clark had taken the Illinois Country in 1778, then watched the British retake Vincennes in December; facing a spring offensive he could not stop, he marched the one direction the enemy thought impassable across the drowned winter prairie.' },
    { side: 'c', tag: 'British', force: 'Hamilton\'s garrison, Fort Sackville', str: 'about 90 in the fort (33 regulars of the 8th Regiment plus Detroit militia; 79 surrendered)', cmd: 'Lt. Gov. Henry Hamilton', note: 'A reduced winter garrison; Hamilton had dismissed most of his militia and nearly all his Native allies until spring, and counted only about 35 or 36 of the men inside as reliably loyal.' },
  ],
  casualties: {
    union: 1, csa: 85,
    unionLabel: 'American 0 killed · 1 wounded',
    csaLabel: 'British ~5–7 wounded · 79 captured',
    footnote: 'American: 0 killed, 1 wounded in the siege; during the victory salute on February 25 a captured cannon touched off loose powder and burned six men, including Maj. Bowman, who died of the burns in August. British: 0 to 1 killed at the walls, about 5 to 7 wounded, 79 captured. Separate from the siege: an ambushed war party of about 15 to 16 lost 2 killed and 6 taken; 4 (some accounts say 5) of the captives were executed before the fort gate.',
  },
  commanders: [
