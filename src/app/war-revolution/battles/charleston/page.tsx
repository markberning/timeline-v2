...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The Southern army', str: '~5,500–6,000 inside the lines (about 2,500–2,800 Continentals + militia, armed citizens, and sailors)', cmd: 'Maj. Gen. Benjamin Lincoln', note: 'The entire Continental establishment in the South, dug in behind a fortified line across the neck of the peninsula, fronted by a flooded ditch with a tabby strongpoint (the Hornwork) at the gate. Continentals were the full-time paid regulars of the Continental Army; the rest were militia (part-time citizen soldiers) and armed townsmen. Woodford\'s ~750 Virginians arrived April 7 after a forced march of some 800 miles from Morristown, just in time to be captured. Lincoln could have saved the army by marching it out while the back door was open; the city\'s own government would not let him.' },
  ...
  casualties: {
    ...
    footnote: 'American: about 89 killed and 138 wounded in six weeks of siege, almost nothing. The catastrophe was the capture: more than 5,000 men surrendered on May 12, the entire southern army, about half of them Continental regulars, along with seven generals, more than 300 guns, some 5,000 muskets, fifteen stands of colors, and three Continental Navy frigates. British: around 100 killed and a few hundred wounded (land and naval returns vary), a trifling cost for the greatest British victory of the war. The captured total needs a word of caution: Clinton\'s official return counted 5,466 prisoners, but it swept in militia, armed citizens, and sailors along with the regulars; the genuinely effective Continentals numbered closer to 2,650. The honest statement is "more than five thousand men, the whole southern army, about half of them regulars." And the deadliest single event came three days after the surrender: a captured-arms magazine blew up on May 15, killing perhaps two hundred people, more than had died on both sides in the entire siege.',
  },
  commanders: [
