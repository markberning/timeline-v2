...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The redoubt (their overnight-dug dirt fort) and the rail-fence line', str: '~2,400–3,000 engaged across the day, men rotating in and out', cmd: 'Col. William Prescott (in the redoubt)', note: 'A militia army with no clean command structure: Prescott held the redoubt all day, Stark ran his own flank at the rail fence and the beach, and Putnam, the senior officer present, rode the field without clear authority over anyone. The men had dug their fort overnight and fought it nearly out of powder.' },
    { side: 'c', tag: 'British', force: 'The Boston garrison', str: '~2,200–3,000 engaged across the day, with reinforcements', cmd: 'Maj. Gen. William Howe', note: 'Regulars (Britain’s professional, full-time soldiers) who re-formed twice and walked up the hill three times into the heaviest infantry fire of the era, Howe leading every assault in person, on foot. They took the position with the bayonet when the defenders’ powder ran out.' },
  ],
  casualties: { union: 435, csa: 1054, unionLabel: 'American ~420–450', csaLabel: 'British 1,054', footnote: 'The British figure is firm, from Gage’s official casualty report: 226 killed and 828 wounded, roughly 40 to 50 percent of those who fought, about a hundred of them officers. American losses are ranges, never reported cleanly: ~115 killed (range 115–140), ~270–305 wounded, ~30 captured (most of the captured wounded; 20 of the roughly 30 prisoners died); among the dead, Maj. Gen. Joseph Warren. Most American casualties came in the retreat across the Neck (the one land exit from the peninsula), not in the redoubt (the dirt fort).' },
  commanders: [
