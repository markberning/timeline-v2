...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The main Continental Army', str: '~11,000 (≈8,000 Continentals + ≈3,000 militia)', cmd: 'Gen. George Washington', note: 'Four columns on four roads ordered to hit Howe\'s camp simultaneously at dawn with bayonets after a 14–16-mile night march, white paper in their hats to tell each other apart, with no way to signal between columns: the Trenton plan scaled up nearly five times.' },
    { side: 'c', tag: 'British', force: 'Howe\'s main camp at Germantown', str: 'about 9,000 engaged (some accounts put roughly 8,000 in camp; detachments had thinned it)', cmd: 'Gen. Sir William Howe', note: 'The conquerors of Philadelphia, camped unentrenched in a line straddling the village; Howe was so sure the beaten Americans would not attack that at dawn on October 4 he rode toward the firing believing it was a raiding party.' },
  ],
  casualties: {
    union: 1080, csa: 527,
    unionLabel: 'American ~1,050–1,110',
    csaLabel: 'British ~520–535',
    footnote: 'American: ~152 killed (including Brig. Gen. Francis Nash; over 50 at the Chew House alone), ~521 wounded, ~400–440 captured (including the entire 9th Virginia), total ~1,050–1,110. British: ~70 killed (including Brig. Gen. James Agnew), ~448 wounded, ~14 missing, total ~520–535.',
  },
  commanders: [
