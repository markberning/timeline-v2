...
const DATA: BattleData = {
  ...
  casualties: {
    ...
    footnote: 'American: about 300 at Freeman\'s Farm (commonly ~65–90 killed and ~210–240 wounded or missing; the per-battle splits vary by return) and about 130–150 at Bemis Heights; roughly 450–500 for the whole campaign\'s fighting. British/German: about 600 at Freeman\'s Farm, where the 62nd Foot was reduced to roughly company strength; 600 and more on Oct 7, including some 200 captured, six of ten guns lost, and Breymann dead. The number that mattered came ten days later: nearly 6,000 men (period returns 5,791–5,895) marched into captivity on Oct 17, with more than two dozen guns and ~5,000 stand of small arms. Tactically, Freeman\'s Farm was a British field-holding draw bought at roughly two casualties for every American one. The campaign\'s real arithmetic was the two armies\' curves: Gates\'s force nearly doubled between the battles while Burgoyne\'s effectives fell toward 5,000 on shrinking rations.',
  },
  commanders: [
