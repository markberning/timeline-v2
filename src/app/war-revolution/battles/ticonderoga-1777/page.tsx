...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The Ticonderoga garrison', str: '~2,500 effectives; ~3,000–3,500 total with militia and artificers', cmd: 'Maj. Gen. Arthur St. Clair', note: 'About 2,500 effectives holding sprawling works that needed roughly 10,000 to defend properly; their commander had been in post three weeks and evacuated by night when British guns appeared on the undefended hill above them.' },
    { side: 'c', tag: 'British & German', force: 'Burgoyne\'s invasion army', str: '~7,800–8,000 fighting men (≈3,981 British + ≈3,116 Brunswick and Hesse-Hanau regulars, plus gunners, Canadians, and Loyalists), and several hundred Native allies', cmd: 'Lt. Gen. John Burgoyne', note: 'Advancing south along Lake Champlain in two wings: Fraser\'s Advanced Corps and the British division on the west shore, Riedesel\'s Germans on the east; its engineers won the fort with a road and two cannon on a hilltop.' },
  ],
  casualties: {
    union: 405, csa: 250,
    unionLabel: 'American ≈40 killed · ≈100 wounded · ≈230–300 captured',
    csaLabel: 'British/German ~235–270',
    footnote: 'No battle at the fort itself; the week\'s bill was paid at Hubbardton on July 7. American at Hubbardton: ~41 killed, ~96 wounded, ~230 to 270 captured, roughly 40% of the rearguard; Fort Anne losses uncertain (50 to 200 including captured). Materiel was the real loss: dozens of cannon, the Lake Champlain flotilla, and mountains of provisions. British/German at Hubbardton: ~50 to 60 killed and ~140 to 170 wounded, over 20% of Fraser\'s force.',
  },
  commanders: [
