...
const DATA: BattleData = {
  ...
  note: 'The only British soldier on the field was the man who died commanding it: an army no government ordered ran Ferguson 330 miles down the foothills, surrounded his thousand Loyalists on a wooded ridge, shot him from his horse, and then kept firing after the white flags went up.',
  ...
  sides: [
    { side: 'u', tag: 'Patriot', force: 'The Over-mountain men and backcountry militia', str: 'About 900 picked, mounted riflemen made the attack (chosen from a gathered force of perhaps 1,400 or more)', cmd: 'Col. William Campbell (officer of the day)', note: 'A self-summoned army with no Continental commission, the colonels governing by council; most were farmers from the Watauga, Nolichucky, and Holston settlements carrying long rifles with no bayonets, on land leased from the Cherokee.' },
    { side: 'c', tag: 'Loyalist', force: 'Ferguson\'s corps of American Loyalists', str: 'About 1,100: roughly 100 Provincial regulars (northern Loyalists in red coats) plus about 1,000 Carolina Loyalist militia', cmd: 'Maj. Patrick Ferguson', note: 'Ferguson was the only British soldier on the field (his adjutant Chesney was Irish-born); the rest were American colonists, Provincials from New York, New Jersey, and Connecticut plus Carolina militia, fighting in close order with muskets and bayonets.' },
  ],
  casualties: {
    union: 90, csa: 1100,
    unionLabel: 'Patriot about 28 killed + about 62 wounded',
    csaLabel: 'Loyalist about 320 killed & wounded + roughly 700 captured',
    footnote: 'Patriot: about 28 killed (including Col. James Williams, mortally hit at the end, and Maj. William Chronicle) and about 62 wounded, Campbell\'s Virginians worst hit. Loyalist: the commonly given set is about 157 killed, 163 too badly wounded to move, and roughly 698 captured (other counts run 668 to 716 prisoners); the honest statement is that of roughly 1,100 men, the whole force was killed, wounded, or taken in about an hour.',
  },
  commanders: [
