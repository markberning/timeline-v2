...
const DATA: BattleData = {
  ...
  note: "Morgan, cornered against a flooded river with no retreat, scripted his militia's flight as bait, hid his cavalry behind a rise, and when Tarleton's exhausted men surged after the 'fleeing' militia in a disordered mob, folded them into a double envelopment that destroyed the command in about an hour.",
  ...
  sides: [
    { side: 'u', tag: 'American', force: "Morgan's flying army", str: "800 by Morgan's own count to ~1,900 by modern reconstruction (militia kept arriving overnight)", cmd: 'Brig. Gen. Daniel Morgan', note: "Three lines: ~150 picked riflemen as skirmishers, the militia under Pickens ordered to fire two volleys and fall back, then ~300 Maryland and Delaware Continentals plus Virginia state troops under Howard on the crest, with Washington's 80 to 125 cavalry hidden behind a rise." },
    { side: 'c', tag: 'British', force: "Tarleton's corps", str: '~1,050 to 1,150, roughly half American Loyalist provincials', cmd: 'Lt. Col. Banastre Tarleton', note: "The fast quarter of Cornwallis's army: the British Legion, the 7th Royal Fusiliers, the 1st/71st Highlanders, a detachment of the 17th Light Dragoons, and two light 3-pounder guns; they reached the field after less than four hours' sleep in 48 hours and Tarleton attacked straight off the march." },
  ],
  casualties: {
    union: 150, csa: 870,
    ...
    footnote: "British: about 100 to 110 killed, roughly 200 to 230 wounded (most also captured), and 500 to 630 captured unwounded, roughly 80 to 90 percent of the force; both grasshopper guns and the 7th Fusiliers' colors also taken. American: Morgan's report gives about 12 killed and 60 wounded; the modern reconstruction runs nearer 25 killed and 124 wounded, about 150 total, because he undercounted the militia.",
  },
  commanders: [
