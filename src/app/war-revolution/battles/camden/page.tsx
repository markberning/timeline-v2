...
const DATA: BattleData = {
  ...
  note: 'Three months after Charleston swallowed the first southern army, Congress sent the hero of Saratoga to build a new one; twenty-two days later Gates had lost that army too, marching it hungry into Cornwallis in the dark, his rawest militia opposite the best regulars in America, and the whole fight was over in about an hour.',
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The "Grand Army" of the Southern Department', str: 'About 3,052 fit for duty (Aug 15 return), roughly two-thirds militia', cmd: 'Maj. Gen. Horatio Gates', note: 'Fewer than a thousand Maryland and Delaware Continental regulars (the cream of Washington\'s infantry) flanked by about 1,800 raw North Carolina militia in the center and 700 Virginians on the left who had arrived two days before; all had marched for weeks through stripped country on green corn and lean cattle.' },
    { side: 'c', tag: 'British', force: 'Cornwallis\'s southern field force', str: 'About 2,200 fit for duty (2,239 by Cornwallis\'s return)', cmd: 'Lt. Gen. Charles, Earl Cornwallis', note: 'Webster\'s veteran regulars on the right, Rawdon\'s Volunteers of Ireland and Loyalist provincials on the left, the 71st Highlanders and Tarleton\'s cavalry in reserve; Cornwallis raced up from Charleston to attack rather than retreat.' },
  ],
  casualties: {
    union: 1900, csa: 324,
    unionLabel: 'American ~600–900 killed & wounded + about 1,000 captured',
    csaLabel: 'British ~324 (68–69 killed, ~245 wounded)',
    footnote: 'American killed and wounded commonly put at 600 to 900, plus about 1,000 captured; all seven or eight guns and some 200 wagons lost; what reassembled at Hillsborough was roughly 700 to 800 Continentals. British: about 324 (68–69 killed, ~245 wounded), roughly 15% of the force. The starkest figure: the Virginia militia\'s total reported loss was three wounded, because they broke before they fought.',
  },
  commanders: [
