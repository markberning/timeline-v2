...
const DATA: BattleData = {
  ...
  sides: [
    ...
    { side: 'c', tag: 'British', force: 'The Stony Point garrison', str: 'about 600–700', cmd: 'Lt. Col. Henry Johnson', note: 'The 17th Regiment of Foot at its core, with a grenadier company (the British army\'s elite heavy-infantry soldiers, the biggest and most experienced men in the regiment) of a Highland regiment, a company of Loyalists, and Royal Artillery detachments, holding a field fortification of gun batteries, earthworks, and two belts of abatis (felled trees turned sharp-end out, the period\'s barbed wire) on a rock surrounded by water on three sides. British engineers thought it close to impregnable; the literature calls it "little Gibraltar." A Royal Navy sloop and a gunboat covered the river, until the weather pushed them off station.' },
  ],
  casualties: {
    union: 98, csa: 566,
    unionLabel: 'American ~98 (about 15 killed, 83 wounded)',
    csaLabel: 'British ~20 killed · 74 wounded · ~470–540 captured',
    footnote: 'American: about 15 killed and 83 wounded, roughly 98 in all, of the 1,200 or so who made the assault. A large share of them fell in the forlorn hopes, the twenty-man volunteer parties whose axemen had to hack lanes through the abatis under fire ahead of each column. British: about 20 killed by the official return, with 74 wounded and some 472 unwounded men taken prisoner, a total of roughly 470 to 540 captured depending on whether the wounded are counted. American accounts at the time claimed as many as 63 British killed; the low official figure is the one modern historians accept, and the low number is exactly what makes the restraint real. The prisoner total is honest only as a range, about 470 to 540, and the British dead are best given as the official "about 20." Inflating the British dead, or staging the storming as a slaughter, inverts the documented meaning of the night: quarter was asked and given, and contemporaries on both sides said so.',
  },
  commanders: [
