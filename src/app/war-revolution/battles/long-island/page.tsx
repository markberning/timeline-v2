...
const DATA: BattleData = {
  ...
  casualties: {
    ...
    footnote: 'British/Hessian losses: ~370–400 total (~63–69 killed, ~290–293 wounded, ~30 missing) of ~20,000 landed. American losses: ~1,000–2,000 total: roughly 200–300 killed, ~650–800 wounded (the counts overlap with the captured), and ~870–1,100 or more taken prisoner, including Generals Sullivan and Stirling (and Brig. Gen. Nathaniel Woodhull of the New York militia, captured separately on Aug 28). American figures are ranges, never counted cleanly: returns were chaotic because so many of the "missing" later straggled in, and Howe\'s official claim of ~3,300 American losses is inflated. The prisoner figure is the one to hold loosely; it is always a range.',
  },
  commanders: [
