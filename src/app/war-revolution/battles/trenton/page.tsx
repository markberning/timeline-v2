...
const DATA: BattleData = {
  ...
  sides: [
    { side: 'u', tag: 'American', force: 'The army that crossed the Delaware', str: '~2,400 crossed, with 18 guns', cmd: 'Gen. George Washington', note: 'An army eight days from dissolving crossed an ice-choked river in a nor\'easter, marched nine miles in sleet, and hit both ends of Trenton within minutes; two supporting crossings of ~2,200 to 2,600 more men never got over.' },
    { side: 'c', tag: 'Hessian', force: 'The Trenton garrison', str: '~1,500, with 6 light guns', cmd: 'Col. Johann Rall', note: 'Three veteran German regiments (Rall\'s grenadiers and the von Lossberg and von Knyphausen fusiliers), the most exposed post in Britain\'s New Jersey chain; exhausted by militia alarms, not drunk, their commander having refused to fortify despite repeated warnings.' },
  ],
  casualties: {
    union: 5, csa: 1000,
    unionLabel: 'American 4–6 wounded',
    csaLabel: 'Hessian ~1,000 (most captured)',
    footnote: 'Hessian: about 22 killed (including Rall, mortally wounded), roughly 90 wounded, and about 900 captured; ~250 to 500 escaped over the Assunpink bridge; all six guns, ~1,000 muskets, and the regimental colors taken. American: 4 to 6 wounded (including Lt. James Monroe and Capt. William Washington), no one killed by enemy fire in the assault.',
  },
  commanders: [
