...
const MONONGAHELA_NARR: Record<string, Narr> = {
  ...
  'the-crossing': {
    ...
    blocks: [
      ...
      { fig: '/war-img/fi-monongahela-battle-map.jpg', cap: 'The fight on the river. To skirt a narrows, Braddock’s column forded the Monongahela twice, then ran head-on into the French and Native force about ten miles short of Fort Duquesne. The warriors poured into the ravines on both flanks of the road and fired into the packed column from cover.', credit: 'Stuff Happened map' },
    ],
