...
const DATA: BattleData = {
  ...
  hero: {
    img: '/war-img/fi-lake-george-hero.jpg',
    pal: ['#23282b', '#33454a', '#0c1012'],
    credit: 'A Prospective Plan of the Battle near Lake George, Sept. 8, 1755 · Samuel Blodget, engraved by Thomas Johnston · 1755 · Smithsonian American Art Museum · public domain',
  },
