...
const DATA: BattleData = {
  ...
  sections: [
    { id: 'the-lynchpin-on-the-lake', eyebrow: 'The depot on the water', title: 'The lynchpin on the lake', blurb: 'Frontenac was the hinge the whole French west hung on, sitting on a lake the French were sure was theirs. After they destroyed Oswego in 1756, no one believed the British would ever put boats on Lake Ontario again.' },
    { id: 'bradstreets-raid', eyebrow: 'The bold strike', title: 'Bradstreet’s raid', blurb: 'A provincial army rowed up the inland route and out across the open lake, the part the French thought no one would dare. The surprise was total, the fort indefensible, and an aging commander surrendered it in two days.' },
    { id: 'the-blow-to-the-west', eyebrow: 'The supply line cut', title: 'The blow to the west', blurb: 'The fort was the smallest part of the prize. Bradstreet took the lake fleet, the cannon, and the stores of the western war, then burned it all, and three hundred miles south a fort British armies could not storm starved instead.' },
  ],
