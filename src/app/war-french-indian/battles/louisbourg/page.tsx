...
const DATA: BattleData = {
  ...
  sections: [
    ...
    { id: 'the-siege', eyebrow: 'Closing the ring', title: 'The siege', blurb: 'With the army ashore, the British strangled the fortress by the book. Batteries crept toward the walls, the fleet sealed the sea, and the French harbor squadron died by fire and a night boarding party.' },
    { id: 'the-fall-and-the-road-to-quebec', eyebrow: 'The reckoning', title: 'The fall and the road to Quebec', blurb: 'Drucour surrendered on hard, unconditional terms. What followed fell on people who had not fought the siege: the deportation of the Acadians and a campaign against the settlements and the Mi’kmaq of the Gulf. And then the road to Quebec lay open.' },
  ],
