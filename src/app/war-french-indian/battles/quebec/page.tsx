...
const DATA: BattleData = {
  ...
  commanders: [
    ...
    { name: 'Charles Saunders', role: 'Naval cmdr., British', side: 'u', img: '', bio: 'Vice Admiral Charles Saunders commanded the fleet that did the thing everyone had thought impossible: he took a battle force up the narrow, treacherous St. Lawrence, held the supply line open all summer, ran the loud feint off Beauport that fixed Montcalm’s attention the wrong way, and rowed the landing in through the dark on the ebbing tide. The climb up the cliff is the famous part of Quebec. The river was the thing that made it possible, and the river was his.' },
