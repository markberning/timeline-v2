...
const DATA: BattleData = {
  ...
  sections: [
    { id: 'the-prize-on-the-lake', eyebrow: 'The only door on the lake', title: 'The prize on the lake', blurb: 'Lake Ontario was the hinge between the colonies and the interior, and Oswego was Britain’s one base on it. A strong idea built on weak ground, and across the water the French were gathering to take it.' },
    { id: 'the-siege', eyebrow: 'Four days', title: 'The siege', blurb: 'Montcalm ran a textbook siege. The garrison handed him the commanding height without a fight, and he fired down into the low forts until they broke. Then he denied them the honours of war.' },
