...
const DATA: BattleData = {
  ...
  sections: [
    { id: 'the-fort-that-could-not-be-held', img: '/war-img/fi-lake-champlain-corridor-map.jpg', eyebrow: 'The corridor', title: 'The fort that could not be held', blurb: 'A timber fort at the south end of Lake George could only survive if relieved. The general who held the relief sat sixteen miles away, and down the lake came the largest army New France would ever field, with the largest Native force of the war at its head.' },
    { id: 'the-siege', img: '/war-img/fi-fwh-siege-plan.jpg', eyebrow: 'Six days under the guns', title: 'The siege', blurb: 'Montcalm ran a textbook European siege, batteries in crossfire, the garrison’s own cannon bursting. Then he handed Monro the proof he was abandoned, gave him the honours of war, and set the terms without asking the allies who would never accept them.' },
    { id: 'the-massacre', img: '/war-img/fi-fwh-massacre.jpg', eyebrow: 'The terms unravel', title: 'The massacre', blurb: 'What the warriors had come for and what the terms gave them were opposite things. The killing began that afternoon, the column was swarmed at dawn, and the number everyone has heard turns out to be ten times too large.' },
    { id: 'the-reckoning', img: '/war-img/fi-fwh-attacks-map.jpg', eyebrow: 'What it cost everyone', title: 'The reckoning', blurb: 'Montcalm won the fort and threw the winnings away. The massacre became a weapon and a poison, the British answered in kind, and the alliance that had won the battle never came together for France again.' },
  ],
