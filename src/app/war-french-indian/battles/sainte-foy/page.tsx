...
const DATA: BattleData = {
  ...
  sections: [
    { id: 'the-winter-garrison', eyebrow: 'A city held by sick men', title: 'The winter garrison', blurb: 'Quebec fell in 1759, but holding it through a Canadian winter nearly destroyed the British army that took it. Two hundred miles upriver, the French rebuilt and prepared to march down and take the capital back.' },
