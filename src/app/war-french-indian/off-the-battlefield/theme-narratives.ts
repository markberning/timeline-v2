...
export const THEME_NARR: Record<string, Narr> = {
  ...
  "acadian-expulsion": {
    ...
    "blocks": [
      ...
      {
        "p": "Aboard the Duke William was an elder named Noël Doiron (French), with his wife Marie, five of their grown children and their spouses, and more than thirty grandchildren. About 120 people of one family. None of them survived."
      },
      {
