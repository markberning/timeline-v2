...
export const THEME_NARR: Record<string, Narr> = {
  "ohio-company": {
    ...
    "blocks": [
      ...
      {
        "p": "Then there was George Croghan, the Irish-born Pennsylvania trader the frontier called the king of the traders, the British Empire's chief man among the Ohio Indians. In August 1749 Croghan bought 200,000 acres from the Iroquois, with one telling exception written into the deed: two square miles at the Forks of the Ohio, reserved for a British fort. That little reservation tells you what everyone already understood. The Forks were the key to the whole country."
      },
      {
