...
export const PHASE_NARR: Record<string, Narr> = {
  ...
  "disaster": {
    ...
    "blocks": [
      ...
      {
        "p": "Before he ever reached the French, Braddock made a decision that cost him an army. A group of Ohio Lenape (also called Delaware) chiefs came to him, led by Shingas, and asked the question that mattered most to them: if the British drove the French out, would Native peoples be allowed to keep living and hunting on their own land. Shingas asked whether Native friends of the English might be \"Permitted to Live and Trade Among the English and have Hunting Ground sufficient to Support themselves and Familys.\" Braddock answered that \"No Savage Should Inherit the Land.\" The chiefs told him they would not fight alongside him. He replied that he \"did not need their Help.\""
      },
      {
      ...
      {
        "fig": "/war-img/fi-oswego-map.jpg",
        "cap": "Oswego, Britain's only base on Lake Ontario, sat at the end of a long supply line up the Mohawk River and down the Oswego River. In August 1756 Montcalm crossed the lake from Fort Frontenac, took the three forts, and burned them — slamming the lake shut to the British.",
        "credit": "Stuff Happened"
      },
      {
  ...
  "peace-fuse": {
    ...
    "blocks": [
      ...
      {
        "p": "Britain had won the most complete victory of its history and immediately found itself trapped by the size of it."
      },
      {
