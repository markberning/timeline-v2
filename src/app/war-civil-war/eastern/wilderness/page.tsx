...
const FIGURES = [
  ...
  { name: 'G. K. Warren', role: 'V Corps, Union', side: 'U', img: '/war-img/cmdr/warren.jpg' },
  ...
  { name: 'J. Longstreet', role: 'First Corps, CSA', side: 'C', img: '/war-img/cmdr/longstreet.jpg' },
  { name: 'R. S. Ewell', role: 'Second Corps, CSA', side: 'C', img: '/war-img/cmdr/ewell.jpg' },
  { name: 'A. P. Hill', role: 'Third Corps, CSA', side: 'C', img: '/war-img/cmdr/ap-hill.jpg' },
]
const SECTIONS = [
  { id: 'the-thicket', eyebrow: 'May 4', title: 'The woods Lee picked on purpose', blurb: 'Grant (North) pushes a vast army into the thicket to march through it; Lee (South) strikes inside the woods, where cannon cannot aim and numbers do not count.' },
    ...
    <div style={{ padding: '14px 16px' }}>
      <div style={{ border: `1px solid ${alpha(ACCENT, 0.4)}`, background: alpha(ACCENT, 0.08), borderRadius: 10, padding: '13px 15px' }}>
        ...
        <p style={{ fontFamily: SERIF, fontSize: 13.5, lineHeight: 1.55, color: 'color-mix(in srgb, var(--foreground) 80%, transparent)', margin: '8px 0 0' }}>
          Lee (South) stopped a far larger army on ground he had chosen and lost only about half as many men — a defeat by every rule of the previous three years. But Grant (North) did not retreat. He marched the army south, around Lee’s flank, toward Spotsylvania — and the soldiers, realizing they were advancing and not falling back, cheered in the dark. It was the first time the Army of the Potomac stayed on the offensive after an opening battle with Lee, and it opened the Overland Campaign that would never let Lee’s army recover.
        </p>
      </div>
    </div>
  )
