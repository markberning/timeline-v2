...
const ARMIES = [
  { side: 'Union', label: 'Army of the Potomac', size: '~100,000 troops', commander: 'Grant & Meade', note: 'Wouldn’t go home — attacked, was bled, slid southeast, and tried again.', color: ACCENTS.blue },
...
const FIGURES = [
  { name: 'U. S. Grant', role: 'Gen.-in-Chief, Union', side: 'U', img: '/war-img/cmdr/grant.jpg' },
  ...
  { name: 'E. Upton', role: 'Col., Union', side: 'U', img: '/war-img/cmdr/upton.jpg' },
...
const SECTIONS = [
  { id: 'the-race', eyebrow: 'May 7–8 · A foot-race for a crossroads', title: 'Why Grant Didn’t Go Home', blurb: 'Grant (North) marches southeast instead of retreating; Anderson’s (South) corps wins the race to the Laurel Hill crossroads by minutes.' },
  ...
  { id: 'the-mule-shoe', eyebrow: 'May 10–11 · The fatal geometry', title: 'Upton’s Column and the Mule Shoe', blurb: 'A salient bulges north into a death-trap; Upton (North) cracks it with a fast dense column, and Lee (South) pulls his guns the night before the big assault.' },
