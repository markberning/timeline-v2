...
const TL_META: Record<string, { size: CardSize; date: string; palette: [string, string, string] }> = {
  'the-crossroads': { size: 'l', date: 'May 31', palette: ['#3a4a2a', '#283420', '#0a0e08'] },
  'the-trench': { size: 'l', date: 'Jun 2', palette: ['#3a2e21', '#2a221c', '#0a0806'] },
  'the-assault': { size: 'xl', date: 'Jun 3', palette: ['#7a1422', '#3a1208', '#0a0606'] },
  'between-the-lines': { size: 'm', date: 'Jun 4–12', palette: ['#1d3a5a', '#16283a', '#080c12'] },
  'the-pivot': { size: 'm', date: 'After', palette: ['#2e2640', '#221c30', '#0a0810'] },
}
        ...
        {view === 'dossier' ? (
          ...
          <div style={{ padding: '8px 0 20px' }}>
            <p style={{ fontFamily: SERIF, fontSize: 16, lineHeight: 1.6, margin: '8px 16px 4px', color: 'color-mix(in srgb, var(--foreground) 78%, transparent)' }}>
              The bloody culmination of the Overland Campaign — and the failure that forced the move that won the war.
            </p>
            <CordTimeline>
              {SECTIONS.map(s => {
