...
// BATTLE dossier (Antietam). Same shape as Gettysburg: hero · collapsible
...
const HERO_IMG = '/war-img/antietam-hero.jpg' // Kurz & Allison chromolithograph (PD)
...
const sectionHref = (id: string) => `/war-civil-war/eastern/antietam/s/${id}`
  ...
  return (
    <div style={{ position: 'relative', height: 260, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 16, right: 16, bottom: 14 }}>
        ...
        <h1 style={{ margin: '6px 0 0', fontFamily: SERIF, fontWeight: 500, fontSize: 30, lineHeight: 1.05, letterSpacing: -0.5, color: '#fff' }}>Battle of Antietam</h1>
        <div style={{ fontFamily: SERIF, fontSize: 14, color: 'rgba(255,255,255,0.82)', marginTop: 4 }}>September 17, 1862 · Sharpsburg, Maryland</div>
      </div>
    </div>
  )
}
      ...
      {open && (
        <div style={{ marginTop: 14 }}>
          <div style={{ display: 'flex', marginBottom: 18 }}>
            {[['Duration', '1 day'], ['Casualties', '~23k'], ['Winner', 'Union']].map(([k, v], i) => (
