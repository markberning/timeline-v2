...
function GenericHero() {
  ...
  return (
    ...
    <div style={{ padding: '7px 16px 0', fontFamily: MONO, fontSize: 10, letterSpacing: 0.2, color: FAINT }}>{ET.heroCredit}</div>
    </>
  )
}
...
// Round commander headshot with a side-colored ring; falls back to a gradient
// disc if the portrait is missing or fails to load.
