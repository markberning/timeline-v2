...
// BATTLE dossier (Battle of Gaines’ Mill). Same shape as Antietam: hero · collapsible At-a-glance
...
const CRUMBS = civilWarCrumbs({ theatre: 'east', battleId: 'e-gainesmill' })
...
const SECTION_IMG: Record<string, string> = {
  ...
  'hoods-breakthrough': '/war-img/cmdr/hood.jpg',
}
const sectionHref = (id: string) => `/war-civil-war/eastern/gaines-mill/s/${id}`
  ...
  return (
    <div style={{ position: 'relative', height: 260, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 16, right: 16, bottom: 14 }}>
        ...
        <h1 style={{ margin: '6px 0 0', fontFamily: SERIF, fontWeight: 500, fontSize: 30, lineHeight: 1.05, letterSpacing: -0.5, color: '#fff' }}>Battle of Gaines’ Mill</h1>
        <div style={{ fontFamily: SERIF, fontSize: 14, color: 'rgba(255,255,255,0.82)', marginTop: 4 }}>June 27, 1862 · Hanover County, Virginia</div>
      </div>
    </div>
  )
}
      ...
      {open && (
        <div style={{ marginTop: 14 }}>
          <div style={{ display: 'flex', marginBottom: 18 }}>
            {([['Duration', '1 day'], ['Casualties', '~15,000'], ['Winner', 'Confederacy']] as const).map(([k, v], i) => (
