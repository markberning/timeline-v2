...
const CRUMBS = civilWarCrumbs({ theatre: 'naval', battleId: 'n-jacksonstphilip' })
...
const SECTION_IMG: Record<string, string> = {
  ...
  'the-fall-of-new-orleans': '/war-img/forts-jackson-city.png',
}
const sectionHref = (id: string) => `/war-civil-war/naval/forts-jackson/s/${id}`
  ...
  return (
    <div style={{ position: 'relative', height: 260, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 16, right: 16, bottom: 14 }}>
        ...
        <h1 style={{ margin: '6px 0 0', fontFamily: SERIF, fontWeight: 500, fontSize: 30, lineHeight: 1.05, letterSpacing: -0.5, color: '#fff' }}>Forts Jackson &amp; St. Philip</h1>
        <div style={{ fontFamily: SERIF, fontSize: 14, color: 'rgba(255,255,255,0.82)', marginTop: 4 }}>April 18–28, 1862 · Lower Mississippi, Louisiana</div>
      </div>
    </div>
  )
}
      ...
      {open && (
        <div style={{ marginTop: 14 }}>
          <div style={{ display: 'flex', marginBottom: 18 }}>
            {([['Duration', '11 days'], ['Casualties', '~1,000'], ['Winner', 'Union']] as const).map(([k, v], i) => (
