...
const TL_META: Record<string, { size: CardSize; date: string; palette: [string, string, string] }> = {
  'the-surprise': { size: 'l', date: 'Apr 6', palette: ['#3a4a2a', '#283420', '#0a0e08'] },
  'the-hornets-nest': { size: 'xl', date: 'Midday', palette: ['#7a1422', '#3a1208', '#0a0606'] },
  'the-second-day': { size: 'l', date: 'Apr 7', palette: ['#1d3a5a', '#16283a', '#080c12'] },
        ...
        {view === 'dossier' ? (
          ...
          <div style={{ padding: '8px 0 20px' }}>
            <p style={{ fontFamily: SERIF, fontSize: 16, lineHeight: 1.6, margin: '8px 16px 4px', color: 'color-mix(in srgb, var(--foreground) 78%, transparent)' }}>
              The bloodiest battle in America to that point — and the day the war became total.
            </p>
            <CordTimeline>
              {SECTIONS.map(s => {
