...
const FIGURES = [
  { name: 'D. C. Buell', role: 'Cmdr., Union', side: 'U', img: '/war-img/cmdr/buell.jpg' },
  { name: 'P. H. Sheridan', role: 'Div., Union', side: 'U', img: '/war-img/cmdr/sheridan.jpg' },
  { name: 'A. M. McCook', role: 'I Corps, Union', side: 'U', img: '/war-img/cmdr/mccook.jpg' },
  { name: 'B. Bragg', role: 'Cmdr., CSA', side: 'C', img: '/war-img/cmdr/bragg.jpg' },
  { name: 'W. J. Hardee', role: 'Left Wing, CSA', side: 'C', img: '/war-img/cmdr/hardee.jpg' },
  { name: 'L. Polk', role: 'Right Wing, CSA', side: 'C', img: '/war-img/cmdr/polk.jpg' },
  { name: 'B. F. Cheatham', role: 'Div., CSA', side: 'C', img: '/war-img/cmdr/cheatham.jpg' },
]
const SECTIONS = [
...
const TL_META: Record<string, { size: CardSize; date: string; palette: [string, string, string] }> = {
  'the-invasion': { size: 'l', date: 'Sept', palette: ['#3a4a2a', '#283420', '#0a0e08'] },
  'the-fight-for-water': { size: 'l', date: 'Oct 6', palette: ['#1d3a5a', '#16283a', '#080c12'] },
  'the-acoustic-shadow': { size: 'xl', date: 'Oct 8', palette: ['#7a1422', '#3a1208', '#0a0606'] },
  'the-victory-and-the-retreat': { size: 'l', date: 'Dusk', palette: ['#3a2e21', '#2a221c', '#0a0806'] },
        ...
        {view === 'dossier' ? (
          ...
          <div style={{ padding: '8px 0 20px' }}>
            <p style={{ fontFamily: SERIF, fontSize: 16, lineHeight: 1.6, margin: '8px 16px 4px', color: 'color-mix(in srgb, var(--foreground) 78%, transparent)' }}>
              The bloodiest afternoon for the smallest fight — a battle one army won and the other slept through.
            </p>
            <CordTimeline>
              {SECTIONS.map(s => {
