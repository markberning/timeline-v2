...
// BATTLE dossier (Battle of Chickamauga). Same shape as Stones River: hero · collapsible At-a-glance
...
const CRUMBS = civilWarCrumbs({ theatre: 'west', battleId: 'w-chickamauga' })
...
const SECTION_IMG: Record<string, string> = {
  ...
  'the-gap': '/war-img/chickamauga.png',
  'the-rock': '/war-img/chickamauga-snodgrass.png',
  'the-reckoning': '/war-img/cmdr/thomas.jpg',
}
const sectionHref = (id: string) => `/war-civil-war/western/chickamauga/s/${id}`
  ...
  return (
    <div style={{ position: 'relative', height: 260, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 16, right: 16, bottom: 14 }}>
        ...
        <h1 style={{ margin: '6px 0 0', fontFamily: SERIF, fontWeight: 500, fontSize: 30, lineHeight: 1.05, letterSpacing: -0.5, color: '#fff' }}>Battle of Chickamauga</h1>
        <div style={{ fontFamily: SERIF, fontSize: 14, color: 'rgba(255,255,255,0.82)', marginTop: 4 }}>September 18–20, 1863 · Catoosa &amp; Walker Counties, Georgia</div>
      </div>
    </div>
  )
}
      ...
      {open && (
        <div style={{ marginTop: 14 }}>
          <div style={{ display: 'flex', marginBottom: 18 }}>
            {([['Duration', '3 days'], ['Casualties', '~34,000'], ['Winner', 'Confederacy']] as const).map(([k, v], i) => (
