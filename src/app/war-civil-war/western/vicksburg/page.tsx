...
const SECTIONS = [
  ...
  { id: 'the-gamble', eyebrow: 'The spring run', title: 'Past the Guns and Loose in Mississippi', blurb: 'Porter (North) runs the batteries; Grant crosses at Bruinsburg, cuts his supply line, and wins five battles in eighteen days, capped at Champion Hill.' },
