...
const NARRATIVES: Record<string, Record<string, NarrativeFn>> = {
  'bathers-asnieres': {
    ...
    making: BaMaking,
    salon: BaSalon,
    reception: BaReception,
    afterlife: BaAfterlife,
  },
  'card-players': {
    estate: CpEstate,
    making: CpMaking,
    reception: CpReception,
    versions: CpVersions,
    afterlife: CpAfterlife,
  },
  'mont-sainte-victoire-lauves': {
    lauves: MvLauves,
    making: MvMaking,
    reception: MvReception,
    death: MvDeath,
    afterlife: MvAfterlife,
  },
  'starry-night': {
    asylum: SnAsylum,
    making: SnMaking,
