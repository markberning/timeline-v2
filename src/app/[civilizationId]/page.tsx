...
export default async function CivilizationPage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-prose mx-auto px-5">
      <div className="sticky top-0 z-20 bg-background/95 backdrop-blur-sm -mx-5 px-5 pt-3 pb-2">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-1 text-sm text-foreground/50 hover:text-foreground/80 transition-colors">
