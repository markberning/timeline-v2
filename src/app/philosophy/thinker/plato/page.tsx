// "Plato" — a thinker deep read in a provisional self-contained reader modeled on
// the Greeks/faith-reason reader pattern: its own light identity (a quiet
...
import { PLATO, type PhiFig } from './narrative'
...
// Same parser as the threads reader; the Plato prose uses *italics* and **bold**.
const INLINE_RE = /(\[([^\]]+)\]\((\/[^)]+)\))|(\*\*([^*]+)\*\*)|(\*([^*]+)\*)/
  ...
  return (
    <div className="phi-root">
      ...
      <header className="phi-topbar">
        <Link href="/philosophy/greeks" className="phi-back">&larr; Philosophy &middot; The Greeks</Link>
        <span className="phi-kicker">A Thinker</span>
      </header>
      ...
      <main>
        ...
        <div className="phi-mast">
          <p className="phi-eyebrow">Philosophy &middot; The Greeks</p>
      ...
      <footer className="phi-foot">
        ...
        <p>Part of <strong>Philosophy</strong>, the history of Western thought era by era. More thinkers and eras on the way.</p>
      </footer>
