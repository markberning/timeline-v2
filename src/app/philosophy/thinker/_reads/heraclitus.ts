// Heraclitus of Ephesus thinker read. Structurally modeled on socrates.ts (a thinker
// reconstructed from fragments + hostile/late reports). Authored ONLY from
// audits/philosophy-pipeline/heraclitus-thinker-fact-ledger.md. Quotations are verbatim John
// Burnet (Early Greek Philosophy, 3rd ed. 1920, PD), with DK fragment numbers in the prose.
// Inline *italics* and [text](/internal-href) rendered by the page; NO bold. Foreign
// transliterations carry an inline pronunciation guide. Verified quotes are never altered.
...
export const HERACLITUS: PhiNarr = {
  ...
  "brk": {
    ...
    "paragraphs": [
      "The thinkers before Heraclitus, the first Greek philosophers, were hunting for the *arche* (AR-kay: the single underlying source or stuff that everything is really made of, beneath the shifting appearances). Thales of Miletus said it was water. Anaximenes said air. The whole project assumed that under the flux of the world there sits something solid and permanent, one ground-stuff that persists while its surface forms come and go. Change was the problem to be explained away; permanence was the bedrock the reasoning came to rest on. This was a real revolution, the first attempt in the West to explain nature by nature rather than by the gods (the Pre-Socratics chapter). But it pointed at a thing that holds still.",
      ...
      "The second half of the break is the half that keeps Heraclitus from being a prophet of chaos. All that change is not random. It runs by a measure, a ratio, a law he calls the *logos* (LOH-gos, DK B1), a word that means something like \"the account,\" \"the reckoning,\" \"the way things add up.\" The fire kindles and goes out *in measures*, not at whim. The opposites that seem to be at war (hot and cold, up and down, life and death) are actually locked together, each one needing the other, like the two ends of a strung bow pulling against each other to make the thing work. Strife and tension are not the enemies of order. They *are* the order. People miss it because they look for stability and the logos is not stable; it is the pattern that governs the instability. He said it was common to everyone and that the many lived as if they had a private wisdom of their own, awake but acting like sleepers. That accusation, that the truth is in plain sight and humans walk right through it, runs through everything he wrote."
    ]
  },
  "chapters": [
    {
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "There is an obvious objection to all this: calling everyone else \"asleep\" is just an arrogant man flattering himself. But the experience he is pointing at is real and common. A person can stare at a system for years (a market, a marriage, a body, a city) and react to each event as a separate shock, never seeing the rule generating all of them, until one day the rule clicks and every separate event turns out to have been the same pattern all along. That click, the shift from a thousand disconnected happenings to one law producing them, is what Heraclitus means by waking. The truth about the world is not buried somewhere exotic; it is the pattern inside everything that happens, and the work is to stop sleepwalking through the events and see the pattern. What the pattern is, the rest of his thought tries to say."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "p": "The famous part comes wrapped in a slogan Heraclitus never wrote. Everyone knows the line: *panta rhei*, \"everything flows,\" no one steps into the same river twice. It is the single most repeated thing about him. And the fixed phrase \"panta rhei\" is not in the fragments at all. It is a summary, and the summarizer was Plato, writing more than a century after Heraclitus died. In his dialogue the *Cratylus*, Plato pins on Heraclitus the view that all things move and nothing stays still, and the later doxographers compressed Plato's gloss into the tidy slogan that has ridden on Heraclitus' name ever since. The slogan is real philosophy and it is roughly in the neighborhood of his view. It is just not his sentence."
        },
        {
          "p": "What he actually wrote about the river is more careful. The fragment scholars trust as genuine, DK B12, says, in literal translation, that *upon those who step into the same rivers, different and again different waters flow*. It does not say no one can step into the same river twice. It says nearly the opposite: a person steps into the *same river*, the river keeps its name and its identity, *and* the waters touching them are always new. The river stays one thing precisely by never being the same water. Its sameness and its constant change are not in conflict; the sameness is *made of* the changing. A river is a stable identity that exists only as an ongoing flow. Stop the flow and there is no river, just a pond. That is the idea, and it is subtler than the slogan it became."
        },
        {
          "p": "The harder, more famous wordings are later reworkings. \"You cannot step twice into the same river\" (close to DK B91) is regarded by scholars as a paraphrase, probably Plutarch's, quoting from memory and sharpening the line into an impossibility. \"We step and do not step into the same rivers; we are and are not\" (DK B49a) is sharper still, and it is written in the wrong Greek dialect for Heraclitus, which marks it as someone else's reformulation, possibly already shaped by Plato's reading. So the progression runs from the genuine, subtle B12 (same river, ever-new waters) to the punchier later versions that turn it into the paradox the slogan needs. The deepest version of Heraclitus is the quietest one: identity through change, not the loss of identity to change."
        },
        {
        ...
        {
          "p": "The fire fragment turns on two words: *with measures*. The fire kindles \"with measures\" and goes out \"with measures.\" The change is total, but it is not random. It runs by a ratio, a law, a reckoning, which is the logos from the last chapter wearing its physical face. Reality is flux, but *measured* flux, governed flux. Heraclitus is not saying nothing is solid and giving up. He says nothing is solid *and* there is an exact account of how the un-solid behaves. The world is not a pile of stable things; it is more like a fire or a river, something that holds its shape only by constantly changing its matter, and the shape it holds is set by a fixed law most people never notice. The river keeps its name. The fire keeps its measure. Permanence turns out to be a pattern riding on top of change, not a thing sitting underneath it."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "p": "If the world is a process held together by a law, the next question is what the law actually says, and Heraclitus' answer is counterintuitive: the law is conflict. Opposites are not enemies to be resolved. They are partners that need each other, and the tension between them is what holds the world up. The blunt version is the epigraph, DK B53: \"War is the father of all and the king of all; and some he has made gods and some men, some bond and some free.\" The Greek word is *polemos* (POL-e-mos), war or strife, and Heraclitus means it as praise. Strife is not the breakdown of order. Strife is the *generator* of order, the thing that brings everything into being and sorts it into what it is."
        },
        {
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "No documented debate between them exists, no evidence they ever met or read each other, and the neat story of Heraclitus and Parmenides as dueling rivals is partly a frame later writers (Plato among them) imposed to organize the period. What is true is that they mark the two logical extremes of the same question, the one that obsessed early Greek thought: what is the relationship between the changing world the senses show and whatever is really, permanently there? Heraclitus answered that the change *is* what is really there, and permanence is the illusion. Parmenides answered that permanent Being is what is really there, and change is the illusion. They cannot both be right, and much of later philosophy is an attempt to find some third way between them."
        },
        {
          "p": "That third way is, in a real sense, what Plato and Aristotle were built to provide. Plato's answer was to give each man his own territory: the changing world of the senses really does flux, exactly as Heraclitus said, which is why it cannot be known, only opinioned about; but above it sits a realm of changeless, perfect Forms, eternal and unmoving in Parmenides' way, and *those* are the true objects of knowledge (the Plato chapter). Aristotle's answer was to distinguish the ways a thing can be: a thing can stay the same in its underlying substance while genuinely changing in its qualities, so that change and permanence both turn out to be real, in different respects (the Aristotle chapter). Both solutions are, underneath, negotiations between the river and the frozen sphere, between the man of flux and the man of Being. The fork the two pre-Socratics opened never really closed; it just got more sophisticated."
        },
        {
          "p": "Heraclitus' own side of the fork is more than a slogan. His flux is not a counsel of despair, a shrug that nothing can be known because nothing stays still. It is the reverse. Precisely *because* the surface keeps shifting, there is something worth knowing underneath it: the measure, the logos, the hidden attunement that governs all the shifting. \"The hidden attunement is better than the open\" (DK B54). The obvious harmony, the calm still surface, is the cheap one, and it is mostly an illusion anyway. The real attunement is the structural agreement buried inside the apparent conflict, the law that makes the fire kindle in measures and the river keep its name. The flux is the appearance. The hidden law inside the flux is the prize."
        },
        {
          "p": "So \"nature loves to hide\" (DK B123) fits him exactly. His reality is double-layered. On top is the world of appearances, the visible flux that the sleepers mistake for either solid objects or meaningless chaos. Underneath is the logos, the measured order, the unity of opposites, which is real and knowable but concealed, and concealed *by* the very surface it governs. Knowing the world is not a matter of cataloguing the changing surface (\"the learning of many things teacheth not understanding,\" DK B40, from the first chapter). It is a matter of waking up enough to see through the surface to the law. The obscurity Heraclitus was mocked for was not a stylistic vice. It was a faithful match between his prose and his world."
        }
      ]
    },
    {
