...
// John Burnet, Early Greek Philosophy (1920, PD); Plato is Jowett (PD). Fragments are labeled
// "Fragment N" for the reader (Diels-Kranz 28 B N). The B3 "to think and to be are the same"
// slogan is NOT quoted (contested translation) — B6 (Fragment 6) carries that idea verbatim.
...
export const PARMENIDES: PhiNarr = {
  ...
  "hook": [
    ...
    "So the puzzle is not why his conclusion sounds mad. It is why, for the next two and a half thousand years, the smartest people alive could not simply wave it away. His pupil Zeno built a set of paradoxes to defend it. The atomists redesigned the universe to get around it. Plato wrote one dialogue to honor him and another to commit what he called \"parricide\" against him. It all grows from one small word, *is*, and from the steps that carry a man from there to denying the entire visible world."
  ],
  "brk": {
  ...
  "chapters": [
    {
      ...
      "epigraph": {
        ...
        "attribution": "— the goddess greets Parmenides, Fragment 1, trans. John Burnet"
      },
      "blocks": [
        {
        ...
        },
        {
          ...
          "cap": "Raphael's Parmenides, a detail from *The School of Athens*, 1509–1511, a Renaissance invention rather than a real likeness.",
    ...
    },
    {
      ...
      "epigraph": {
        ...
        "attribution": "— the goddess, Fragment 2, trans. John Burnet"
      },
      "blocks": [
        {
        ...
        {
          "p": "The second road is supposed to be impassable because of what \"the way of *It is not*\" actually asks. It asks a person to think about, talk about, inquire into *what is not*: nothing, non-being, what isn't there. And Parmenides' claim, stated flatly in Fragment 6, is that this simply cannot be done: \"It needs must be that what can be spoken and thought is; for it is possible for it to be, and it is not possible for what is nothing to be.\" The idea is that thought and speech always have to be *about* something, have to have an object, and \"nothing\" is by definition not an object. The moment the mind tries to think about non-being, the \"nothing\" it is reaching for turns into a *something*, and the attempt to think about real nothing has failed. So \"what is not\" cannot be thought, cannot be spoken, cannot be the subject of any genuine inquiry. The road of *It is not* leads nowhere because there is nothing down it to find. As the goddess puts it in Fragment 7: \"For this shall never be proved, that the things that are not are; and do thou restrain thy thought from this way of inquiry.\""
        },
        {
          "p": "The charge of word-play is fair enough to take seriously, so the strongest version of the argument runs like this. A person who genuinely attempts to think about sheer nothingness, not empty space (that is still something, a region) and not darkness (that is the absence of light, still defined by something), but pure non-being, the total absence of anything whatever, finds that the mind slides off it. Every attempt to grab it ends up grabbing some faint *thing*. Parmenides' point is that this is not a failure of effort but a structural fact: meaning requires an object, non-being offers none, and so non-being is literally unthinkable and unsayable. And if it cannot even be thought, the goddess says, then it certainly cannot be used as an ingredient in any account of reality. The second road is closed not because it is forbidden but because it is empty. That single move, *there is no such thing as what-is-not, and it cannot be reasoned with*, is the hinge for everything that follows."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "epigraph": {
        ...
        "attribution": "— the goddess names the second half of her lesson, Fragment 1, trans. John Burnet"
      },
      "blocks": [
        {
          "p": "If the visible world is an illusion, why would a serious man spend his time describing it? And yet that is what Parmenides does. After the Way of Truth, the goddess turns to the second part of her promised lesson, the Way of Opinion (the Greek is *doxa*, meaning seeming, belief, the way things appear to mortals), and she lays out a full account of the everyday world: a cosmology built from two opposed principles, fire or light against night, and an account of the heavenly bodies and how things come to be. She gives this in real detail, as much care as a thinker who took the visible world seriously would. And she has already branded the whole thing false, \"the opinions of mortals in which is no true belief at all.\""
        },
        {
          "p": "Why include it? This is one of the genuinely unsettled questions in the study of Parmenides. Scholars have read the Way of Opinion several incompatible ways. Some take it as the best possible account of a world that is, at bottom, still false, a kind of \"if the seeming world must be explained at all, here is the least bad way to do it.\" Some read it as a deliberate exercise, Parmenides showing he could play the ordinary cosmology game as well as anyone before refusing it. Some think he is laying out the rival views of other thinkers in order to mark them as the errors mortals fall into. Some argue it has more positive value than the goddess's harsh verdict admits. The text does not settle it, and the poem is too fragmentary to force an answer. What is clear is the *ranking*: the Way of Truth is the truth, and the Way of Opinion is how things merely seem."
        },
        {
