// "Kant and the Germans" — the fourth Philosophy era, in a provisional self-contained reader modeled on
// the faith-reason reader (src/app/philosophy/faith-reason/page.tsx): its own light identity (a quiet
...
// audits/philosophy-pipeline/kant-germans-draft-r2.md — never edit content here or there; edit the
// gated .md through the pipeline and re-transport. This page ships unlinked (URL-only pilot).

import type { Metadata } from 'next'
import Link from 'next/link'
import type { ReactNode } from 'react'
import { KANT_GERMANS, type PhiFig } from './narrative'
...
// Same parser as the threads reader; the Kant and the Germans prose uses *italics* and **bold**.
const INLINE_RE = /(\[([^\]]+)\]\((\/[^)]+)\))|(\*\*([^*]+)\*\*)|(\*([^*]+)\*)/
    ...
    <div className="phi-root">
      ...
      <main>
        ...
        <div className="phi-mast">
          <p className="phi-eyebrow">Philosophy &middot; The fourth era</p>
