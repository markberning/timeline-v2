// "The nineteenth century" — the fifth Philosophy era, in a provisional self-contained reader modeled
// on the faith-reason reader (src/app/philosophy/faith-reason/page.tsx): its own light identity (a
// quiet bronze-olive, NOT the war stone skin, NOT the threads slate), dark-mode aware, mobile-first.
// The prose lives in ./narrative.ts, a faithful transport of the gated draft in
// audits/philosophy-pipeline/nineteenth-century-draft-r2.md — never edit content here or there; edit
// the gated .md through the pipeline and re-transport. This page ships unlinked (URL-only pilot).

import type { Metadata } from 'next'
import Link from 'next/link'
import type { ReactNode } from 'react'
import { NINETEENTH_CENTURY, type PhiFig } from './narrative'
...
// Same parser as the threads reader; the nineteenth century prose uses *italics* and **bold**.
const INLINE_RE = /(\[([^\]]+)\]\((\/[^)]+)\))|(\*\*([^*]+)\*\*)|(\*([^*]+)\*)/
    ...
    <div className="phi-root">
      ...
      <main>
        ...
        <div className="phi-mast">
          <p className="phi-eyebrow">Philosophy &middot; The fifth era</p>
