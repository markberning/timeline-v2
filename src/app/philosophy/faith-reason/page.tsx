// "Faith meets reason" — the second Philosophy era, in a provisional self-contained reader modeled on
...
// audits/philosophy-pipeline/faith-reason-draft-r2.md — never edit content here or there; edit the
// gated .md through the pipeline and re-transport. This page ships unlinked (URL-only pilot).

import type { Metadata } from 'next'
import Link from 'next/link'
import type { ReactNode } from 'react'
import { FAITH_REASON, type PhiFig } from './narrative'
...
// Same parser as the threads reader; the Faith meets reason prose uses *italics* and **bold**.
const INLINE_RE = /(\[([^\]]+)\]\((\/[^)]+)\))|(\*\*([^*]+)\*\*)|(\*([^*]+)\*)/
    ...
    <div className="phi-root">
      ...
      <main>
        ...
        <div className="phi-mast">
          <p className="phi-eyebrow">Philosophy &middot; The second era</p>
