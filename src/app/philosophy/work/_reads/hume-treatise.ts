  ...
  "chapters": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "Then, near the end of the first part of Book III, comes the observation that quietly demolished a way of doing ethics that had run for centuries. Hume reports it in the tone of a man noticing a recurring trick. Reading every system of morality he had met, he kept catching the same slide. The author reasons along in the ordinary way for a while, making claims about what *is* the case, about God, about human nature, about how society works, and then, of a sudden, the sentences change: instead of *is* and *is not*, every proposition is now joined by an *ought* or an *ought not*. The passage is exact, and the exactness is the whole point:"
        },
        {
