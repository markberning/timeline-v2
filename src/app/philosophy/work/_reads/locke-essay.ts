...
export const LOCKE_ESSAY: PhiNarr = {
  ...
  "chapters": [
    ...
    {
      "num": 4,
      "title": "Book II: the prince and the cobbler, or what makes you you",
      "epigraph": {
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "Locke catalogues the resulting **abuses of words** with the irritation of a man who has sat through too many empty arguments. Using words with no clear idea behind them at all, so the sound is just noise. Shifting a word's meaning mid-argument. Taking words for things, and assuming that because there is a single word there must be a single real essence answering to it. Inventing learned jargon that impresses without informing. His remedy is plain to the point of severity: use no word without a settled idea attached, keep that idea steady, and where a term is contested, say what you mean by it before proceeding. It reads like advice for clearer writing, and it is, but Locke meant it as something larger, a discipline for keeping thought honest, since a mind that lets its words drift has already lost hold of its ideas."
        }
      ]
    },
    {
