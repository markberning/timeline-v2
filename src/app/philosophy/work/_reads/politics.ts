  ...
  "chapters": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "His objection is that a city is, by its very nature, a *plurality* (many different kinds of people doing many different jobs), and that the drive toward total unity does not perfect it but destroys it. \"The nature of a state is to be a plurality, and in tending to greater unity, from being a state, it becomes a family, and from being a family, an individual.\" Push a city toward becoming one big undifferentiated unit and the result is not a better city but a family, and then a single person, and then no city at all. A city is *made of* its differences: farmer and soldier and ruler, each contributing something the others need. Erase the differences in the name of unity and the thing itself is erased."
        },
        {
