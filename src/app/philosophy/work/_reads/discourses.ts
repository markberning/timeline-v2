  ...
  "chapters": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "The second field is the discipline of action: dealing rightly with other people and with one's duties, acting justly and doing what one's roles require, while holding the results loosely. This field is what keeps the philosophy from collapsing into private serenity. The Stoic still has a father to honor, a city to serve, a job to do, and the discipline of action is the steady performance of all of it, with full effort poured into the doing and no peace staked on the outcome. The text is firm that withdrawal is not the goal. The goal is right action with a will that the outcome cannot touch."
        },
        {
