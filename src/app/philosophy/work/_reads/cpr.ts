  ...
  "chapters": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "Part of the difficulty was that the book's verdict cut against what people wanted from philosophy, and Kant said so plainly. He had taken apart the proofs of God, the soul, and immortality, but he insisted he had not done it to destroy faith. In Meiklejohn's translation: he had to abolish knowledge in order to make room for belief. The point was that as long as metaphysics claimed to *prove* God and the soul, it left them hostage to refutation; by showing that such matters lie outside the reach of theoretical knowledge altogether, Kant meant to put them beyond the reach of disproof as well, and to relocate them where he thought they belonged, in the domain of moral faith he would develop in his later ethical works."
        },
        {
