...
[FIGURE: A portrait of King George III early in his reign, around 1761 to 1762. | George III, who came to the throne in 1760 and on whose watch the bill for the war finally came due. | George III in his coronation robes · Allan Ramsay · public domain | /war-img/rev-george-iii.jpg]
...
[FIGURE: A portrait of George Grenville, first lord of the Treasury and effectively prime minister from 1763. | George Grenville, a meticulous lawyer and finance man who inherited the war debt and concluded the colonies should help pay it down. The print names him Treasurer of the Navy, the post he held twice. | 18th-century mezzotint · public domain | /war-img/rev-george-grenville.jpg]
...
[FIGURE: A period map showing the Proclamation Line of 1763 running along the Appalachian crest, with the reserved Indian territory to the west. | The Proclamation Line of 1763. Everything west of the Appalachian crest was, on paper, closed to colonial settlement and reserved for Native nations. | Stuff Happened map · public domain | ]
...
> quote: it is just and necessary that a revenue should be raised … for defraying the expenses of defending, protecting, and securing the colonies. — preamble to the Sugar Act, 1764
...
[FIGURE: A page from the printed text of the Sugar Act of 1764, showing the preamble. | The Sugar Act of 1764. Its preamble stated openly that its purpose was to raise a revenue from the colonies, which made it the first of its kind. | Printed act, 1764 · public domain | ]
...
[FIGURE: A portrait of James Otis Jr. of Massachusetts. | James Otis Jr., whose 1764 pamphlet helped turn a tax dispute into a constitutional argument. | Portrait of James Otis Jr. · public domain | /war-img/rev-james-otis.jpg]
...
What changed in this revision, and any remaining `[VERIFY]` carries.

### MUST-FIX (factual) — applied
- Debt ceiling: changed "£130 to £137 million" → "roughly £75 million ... to roughly £130 million." £137M dropped (unsupported per addendum; well-sourced range is ~£72M 1755 → ~£129.6M 1764, £133M ceiling). "Roughly doubled" kept.
- Cider tax: "had helped bring down the previous ministry" → "had badly damaged the standing of the previous ministry." No longer claims it toppled the ministry (Wilkes affair was the trigger).
- Proclamation timing: "The immediate reason was a war already burning" → "The Proclamation had been in the works before the frontier caught fire. What forced it into law was a war already burning." Reflects that it was already being drafted and Pontiac's War hastened it.

### MUST (storytelling) — applied
- Grenville: humanized before the constitutional-fault-line beat using addendum facts (trained lawyer, finance specialist, twice Treasurer of the Navy, meticulous to the point of parliamentary tedium, came to power April 1763 with the war debt as his defining problem, studied the customs system and consulted colonial agents, thought he was reasonable).
- Currency Act section: cut the meta-narration opener and the survey-citation register. Kept the fair judgment in one plain sentence (historians don't rank colonial debt among leading causes). Reframed as the two-sided vise: Sugar Act demands scarce hard coin while the Currency Act strangles the paper colonists used.
- Closing line: replaced the wispy tease with an arrival, naming the Stamp Act by name as the internal-side tax landing next year, and kept the "Britons demanding the rights of Britons" beat earlier in the section.

### MUST-ADD (comprehensiveness) — applied
- Virtual representation: added a two-sided beat after the no-taxation passage (every MP represents the whole nation; colonists "represented" like un-enfranchised Manchester/Birmingham; colonial demand for actual representation).
- Vice-admiralty courts: added reversed burden of proof (accused must prove legal import) and officers'/informers' share of forfeited cargo ("a rigged collection machine").

### MUST-FIX (clarity) — applied
- Pontiac identified in one clause ("the Odawa war leader who organized and led the uprising").
- Common-law right to a jury of one's peers established in a sentence before the vice-admiralty beat.
- Sentence added on why the Sugar Act sat uneasily on the line (external in form, internal in purpose).
- Colonial assemblies anchored "one per colony, like a local parliament" on first mention.

### MUST-FIX (framing) — applied
- "a free people" dropped → "that people could be taxed only by a legislature they had voted for."
- London "meanwhile" card swapped to the addendum's revised body (acknowledges the real war debt and the beneficiary logic, not just "that was going to stop").

### SHOULD — applied
- Trimmed the first-sentence Treaty-of-Paris parenthetical pile-up (split the two parentheticals into cleaner clauses).
- Moved the "fury at being told they could not take Native land" line to be the closing beat of the Proclamation section.
- Cut "a phrase that would outlast everyone who first spoke it."
- Added the optional sentence on colonial assemblies formally petitioning Parliament in 1764 (Sugar Act section).
- Kept 5 FIGURE anchors at natural beats (map, George III, Grenville, Proclamation map, Sugar Act page, Otis portrait — 6 total, all carried from the draft, repositioned as prose moved).

### Remaining [VERIFY] carries
- Washington line: still PARAPHRASED, not quoted ("privately dismissed the Proclamation as a temporary measure to quiet the Native nations" + "went on quietly acquiring western claims"). Confirm exact wording before any quotation marks return, or leave paraphrased. Addendum quote on record: "a temporary expedient to quiet the minds of the Indians."
- Grenville's pre-Sugar-Act consultation of colonial agents: addendum marks the agent-consultation specifics [VERIFY]; no specific agent named, written generally ("consulted the colonies' agents in London").
- Standing army "~10,000 regulars" and "a few hundred thousand pounds a year": both hedged, no precise figure printed (addendum range £200,000–£350,000).
- Vice-admiralty "Halifax / no-jury" location: hedged "most notoriously the one at Halifax."
- Otis title + 1764 date kept; "no taxation without representation" still presented as a crystallizing idea, not Otis's coinage.

### Cross-ref pills
- `/war-french-indian/off-the-battlefield/treaty-of-paris` — opening.
- `/war-french-indian/off-the-battlefield/war-finance` — after the standing-army beat.
- `/war-french-indian/off-the-battlefield/pontiacs-war` — in the Proclamation section.
- `/war-revolution/off-the-battlefield/stamp-act` — closing forward pill (unbuilt; 404s by design until built).
