...
[FIGURE: portrait photograph of Major General George B. McClellan, the general who built the Army of the Potomac and would not fight with it]
...
[FIGURE: Francis Carpenter’s engraving of the first reading of the Emancipation Proclamation before Lincoln’s cabinet, September 1862, the moment the war’s purpose became official]
...
**The plan, and the man who wouldn’t move**
- Anaconda Plan: Scott proposed blockade + seize the Mississippi to cut the South in two; press mocked it; became the real shape of victory: factpack §1 [Wikipedia: Anaconda Plan].
...
- Caution: overestimated enemy ~2×, underestimated own strength ~2×; Pinkerton fed inflated numbers but the habit was his own: factpack §1.
...
- Fort Henry Feb. 6, 1862: Grant + Foote’s ironclad gunboats; gunboats did most of the work: factpack §2 [Wikipedia: Fort Henry]. (“Flag Officer” glossed inline at first use as a senior naval rank ≈ admiral/fleet commander.)
...
- A. S. Johnston killed Apr. 6, bled out from severed artery, highest-ranking combat death of the war; Beauregard succeeded: factpack §3.
- “Exceeded the COMBINED casualties of the Revolution, War of 1812, and Mexican War”: phrased with the combined qualifier AND hedged (“as people then reckoned it”) per flag #2 / FACT FIX #6 (the claim is contested): factpack §3 [Battlefields.org; Wikipedia].
...
- Seven Pines May 31, 1862: J. E. Johnston wounded; June 1, 1862 Lee takes command, renames Army of Northern Virginia: factpack §4.
...
- Seven Days casualties: CSA ~20,200 vs Union ~15,900: printed as “around twenty thousand” per FACT FIX #3 (was “well over twenty thousand,” which overstated ~20,200); Lee won at higher cost, smaller army (manpower-system thread): factpack §4.
- Result: drove McClellan to the James; Richmond safe; Lee holds the initiative: factpack §4.
- Second Bull Run (Aug 28–30): Lee splits army, Jackson hits supply line + holds, Longstreet ~25,000 in the largest simultaneous assault of the war, routs Pope; road north opened: factpack §4 (LINK DOWN second-bull-run).
...
**What the war was now for**
- Seward advised holding the Proclamation until a victory or it would look like “our last shriek, on the retreat” (paraphrased, not block-quoted): factpack §6 [Wikipedia: Emancipation Proclamation].
...
**The river war and a brutal close**
- Hampton Roads Mar. 8–9, 1862: CSS Virginia destroyed 2 wooden warships Mar. 8; USS Monitor fought it to a draw Mar. 9, first ironclad-vs-ironclad battle: factpack §7 (LINK DOWN ironclads). Ironclad glossed once (Monitor/Virginia gloss); CSS/USS glossed inline at first use (Confederate States Ship / United States Ship) per FACT FIX #10; the earlier redundant ironclad re-gloss simplified per NICE #13.
- New Orleans late Apr. 1862: Farragut ran past Forts Jackson & St. Philip in the dark, took the city; Butler occupied: factpack §7 (LINK DOWN forts-jackson). Date span per flag #10.
- Island Number Ten (Feb 28–Apr 8): Pope + Foote, bypass canal + gunboats past in a thunderstorm; several thousand captured (approx. per flag #9); upper Mississippi opened: factpack §7 (LINK DOWN island-number-ten). (Second-occurrence allegiance tags on Pope and Foote REMOVED per CRAFT FIX #9: both introduced earlier in the chapter; rule is once per person per chapter.)
...
- Corinth (early October): Union held the northern Mississippi rail junction against a Confederate assault: factpack §7 (LINK DOWN corinth). Merged with Perryville into one “fall counter-offensives” paragraph per CRAFT FIX #11a so the two pills are separated by prose.
- Perryville (Oct 8): Bragg invaded Kentucky; turned back for lack of Kentucky recruits/supply, NOT beaten on the field, per FACT FIX #5: factpack §7 (LINK DOWN perryville).
- Stones River (Dec 31 / assault again Jan 2): among the deadliest by share of men engaged (kept, accurate); recast per FACT FIX #4 to “bloody and inconclusive on the field, but Bragg withdrew and the Union kept middle Tennessee” (strategically a Union win): factpack §7 (LINK DOWN stones-river).
- Fredericksburg (Dec 11–15; assault Dec 13): Burnside frontal assaults uphill vs stone wall / sunken road; FACT FIX #1: recast from “not a single Union soldier reached the wall” (wrong; men got within 25–40 yards) to “Wave after wave was cut down in the open before it could reach the wall; no Union attack broke the line”; ~2:1 losses; worst Union morale: factpack §7 (LINK DOWN fredericksburg).
- Lee quote (verified, block-quoted): “It is well that war is so terrible, or we should grow too fond of it.”: factpack §7 [Wikipedia: Fredericksburg] (flag #7: this one is solid; Curtin/Lincoln quotes NOT used). CRAFT FIX #8: the “the line that has outlived the battle” herald CUT; now plain “Watching the carnage from the heights, Lee said:”.
...
- Medicine/logistics overwhelmed: ~17,000 wounded at Shiloh, ~17,000 at Antietam; disease > bullets: factpack §7 (LINK DOWN medicine). CRAFT FIX #11b: one-sentence bridge added between the Medicine and New-Way-of-War paragraphs so the two pills are separated by prose.
...
- DOWN: Stones River `/war-civil-war/western/stones-river`: The river war and a brutal close (bloody, inconclusive on the field; Union kept Tennessee).
...
4. **Shiloh “exceeded combined casualties of prior wars”**: carried with the “combined casualties” qualifier AND hedged (“as people then reckoned it”); the claim is contested, so it is no longer asserted flat [flag #2 / FACT FIX #6].
...
13. **Fredericksburg “reached the wall”**: corrected per FACT FIX #1: attackers got within ~25–40 yards but none broke the stone-wall line; prose no longer claims “not a single Union soldier reached the wall.”
14. **Pea Ridge date**: corrected per FACT FIX #2 to March 7–8, 1862, explicitly placed three weeks after the February river forts (no longer grouped in “the same weeks”).
15. **Perryville**: corrected per FACT FIX #5: Bragg withdrew for lack of Kentucky recruits/supply, not because beaten on the field.
...
- **Pea Ridge**: printed “March 7–8,” Arkansas, three weeks after the February forts, “secured Missouri for the Union.” Outcome from brief; date per FACT FIX #2. [VERIFY]
...
- **Perryville**: printed “October 8,” Bragg invaded Kentucky and turned back for lack of recruits/supply, not beaten on the field (FACT FIX #5). Date + “few rose” mechanism standard but not in the pack. [VERIFY]
- **Stones River**: printed “December 31 / January 2,” near Murfreesboro, Tennessee; bloody and inconclusive on the field, after which Bragg withdrew and the Union kept middle Tennessee (FACT FIX #4). Dates standard; “deadliest by share of men engaged” is a commonly cited claim, confirm against the dossier. [VERIFY]
