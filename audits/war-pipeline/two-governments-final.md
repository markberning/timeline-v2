...
[FIGURE: The Alabama State Capitol in Montgomery, 1861, where the Confederate provisional government was organized — a wide-columned antebellum statehouse, the first Confederate capital.]
...
The talking is finished and the choosing is done; what remains is the fighting. Both governments now scramble to raise armies almost from nothing: green volunteers, untrained officers, two amateur nations stumbling toward the first real battle. Within weeks they will collide near a Virginia creek called Bull Run, where a North that expected a quick, glorious afternoon will learn, in a single bloody day, exactly how long and how terrible this war is going to be.

## FACT LEDGER

Every concrete claim below is tied to a fact-pack item or to a source verified at revision time. Corrected/added items from the five critic gates are marked **[GATE-FIX]**. Locked framing quotes are confirmed verbatim in the final sub-list.

**Opening / scope**
- Two governments, two presidents, two constitutions, two capitals in 1861 → fact pack framing; Beats 1–3; date table.
- **[GATE-FIX, STORY-1]** Opening rebuilt as an immersive scene (two men, two cities, ~6 weeks apart, half-built Capitol dome) before the "slow-motion divorce" line. The Capitol-dome-under-construction detail is historically accurate (the new cast-iron dome was under construction 1861, completed 1863) → comprehensiveness SHOULD-CONSIDER C; widely documented (Architect of the Capitol).
- Seven Deep South states gone by Feb 1 (SC, MS, FL, AL, GA, LA, TX) → Scope/Dedup note; Beat 1.
- **[GATE-FIX, CLARITY-M1/S1]** "secession" defined plainly on first use ("the legal term these states used for formally quitting the United States"); "secession winter" glossed inline (the months between Lincoln's election and inauguration). Picks up Feb 4, 1861 (DEDUP: not re-covering 1860 election or initial secession votes).

**Montgomery / Confederate founding (Beat 1)**
- Feb 4 (six states convene; TX delegates after) · Feb 8 (provisional constitution) · Feb 9 (Davis unanimously elected, Stephens VP) · Feb 11 (Stephens oath, 49th birthday) · Feb 18, 1:00 p.m. (Davis inaugurated, Alabama State Capitol) → Beat 1; date table; all ✅ in fact-check.
- **[GATE-FIX, CLARITY-M2/S2]** Davis inaugural "resume the authority delegated" now followed by a plain-English gloss (states "lent" sovereignty to the federal government and were taking it back); "abuse of language… denominated a revolution" glossed inline ("the wrong word"). "Secretary of War" glossed as the civilian cabinet minister who runs the army.
- **[GATE-FIX, STORY flag]** Dropped the unnecessary hedge "by contemporary accounts" before "wrote the whole address the night before" (fact-check confirms it as established via Rice University Papers of Jefferson Davis).
- **[GATE-FIX, CLARITY-S3]** Stephens's "went with it" now carries the "loyalty to his state above his own judgment" gloss, priming the Lee payoff.
- Capital moves to Richmond (voted May 8; executive moved late May); reason = Virginia's industrial output ~equaled all other Confederate states combined + bind upper South → Beat 1 / Beat 5.

**Davis / Lincoln contrast (Beat 2)**
- Davis bio: MS planter, b. KY 1808, West Point 1828, Black Hawk War 1832, Mexican-American War / Buena Vista, Congressman, Senator, Sec. of War 1853–57 (modernized army, railroad surveys, camels); ~113 enslaved at Brierfield → Beat 2; all ✅ in fact-check.
- **[GATE-FIX, FRAMING SHOULD-FIX]** "genuine combat hero" → "a combat veteran who distinguished himself at the Battle of Buena Vista" (removes the warmer, endorsing phrasing).
- **[GATE-FIX, both VERIFY + STORY/FRAMING]** Lincoln "mosquitoes" gloss now sourced and quoted to Lincoln's own 1848 speech in Congress on the Mexican War ("I had a good many bloody struggles with the musquetoes…"). Confirmed by fact-check ([VERIFY] #1 RESOLVED). No longer a bare anecdote.
- Lincoln: one-term congressman, railroad lawyer, only military = brief Black Hawk militia stint, own party preferred others, underestimated → Beat 2; ✅.
- Framing kept as "one of the great wrong guesses" / "everyone's guess that spring" per fact-pack [NOTE] on not validating Davis's expected competence.

**Cornerstone Speech (Framing A)** — see verbatim confirmation below.
- Stephens delivered it Mar 21, 1861, Athenaeum, Savannah; extemporaneous → ✅.
- **[GATE-FIX, FRAMING MUST-FIX 1]** Provenance corrected: canonical Savannah text comes from the **Savannah Republican** (reprinted in Moore's *Rebellion Record* and Cleveland's authorized 1866 collection), NOT the *Southern Confederacy* of Atlanta. The *Southern Confederacy* reported a **separate, earlier** version Stephens gave in Atlanta on **March 12** — explicitly distinguished in-text so a bad-faith reader cannot use the old error to dismiss the sourcing. Verified at revision time via Wikipedia "Cornerstone Speech" + Encyclopedia Virginia + Teaching American History. The misleading "ran in print on March 25" line (which applies to the Atlanta speech, not the Savannah text) was removed.
- Stephens later claimed reporters garbled it; historians reject the walk-back → ✅.

**Secession declarations (Framing C)** — see verbatim confirmation below.
- Mississippi Jan 9, 1861; SC Dec 24, 1860; Georgia Jan 19, 1861 → all ✅; quotes verbatim.
- **[GATE-FIX, FACT SHOULD-FIX A]** Georgia closing quote restored to the full sentence — "…the destruction of ourselves, our wives and our children, and the desolation of our homes, our altars, and our firesides" (previously cut mid-sentence at "our children" without ellipsis). Verbatim against Avalon Project.
- **[GATE-FIX, COMPREHENSIVENESS MUST-ADD 2]** Texas declaration ADDED (filed Feb 2, 1861) with its distinct "inferior and dependent race" / racial-hierarchy-as-settled-truth language, so "four states, four official documents" now matches four quoted declarations (SC, MS, GA, TX). Verbatim against the fact pack / Avalon Project. *(Date note: the Texas convention adopted the secession ordinance Feb 1; the Declaration of Causes is dated Feb 2, 1861 — the ledger uses Feb 2 for the declaration specifically.)*

**Confederate Constitution (Framing B)** — see verbatim confirmation below.
- Permanent constitution adopted Mar 11, 1861 → ✅. Added one beat tying its adoption (ten days before) to Stephens celebrating it in Savannah → comprehensiveness SHOULD-CONSIDER B.
- U.S. euphemisms ("persons held to service or labor"/"other persons", never "slavery") vs. Confederate plain "slaves"/"negro slaves" → ✅.
- **[GATE-FIX, CLARITY-M3]** Three-fifths clause now glossed before the quote (it was the formula for counting each enslaved person as 3/5 of a person toward a state's *representation* — its number of seats in Congress — without letting them vote).
- "law denying or impairing the right of property in negro slaves" (Art. I §9(4)) · "slaves and other property" transit (Art. IV §2(1)) · territories clause (Art. IV §3(3)) → all ✅.
- **[GATE-FIX, COMPREHENSIVENESS MUST-ADD 1]** Added the internal "states'-rights" contradiction paragraph built only from clauses already quoted: the property clause forbade any Confederate *state* from weakening/abolishing slavery, and the territories clause overrode any future territory's wish to bar it — so the document protected one right (the enslaver's) and used it to crush all competing state/territorial rights. No new facts; analysis from quoted text.

**Lincoln First Inaugural (Beat 3)** — see verbatim confirmation below.
- Mar 4, 1861, U.S. Capitol; 7 states gone, Confederate gov't 13 days old → ✅.
- **[GATE-FIX, FACT MUST-FIX 2]** "hold, occupy, and possess" quote completed to the full sentence — "…belonging to the Government, **and to collect the duties and imposts**; but beyond what may be necessary for these objects, there will be no invasion, no using of force against or among the people anywhere." Verbatim against Avalon Project (previously truncated at "Government" with a period, presented as complete).
- **[GATE-FIX, CLARITY-S8/S9/S10]** Upper-South four now framed with WHY ("whether to follow the Deep South out of the Union"); explicit Fort Sumter "translation" added after the hold/occupy quote; Seward's role (senior cabinet minister, foreign affairs) glossed.
- "better angels" closing revised from Seward's "guardian angel of the nation"; aimed at keeping the upper South → ✅. Removed the "most beautiful sentence in the English language" editorial verdict per story flag.

**Fort Sumter (Beat 4)** — see verbatim (75,000 proclamation) confirmation below.
- Charleston harbor, man-made island, SC → ✅. **[GATE-FIX, CLARITY-S11/Leap F]** "garrison" glossed; Moultrie-vs-Sumter defensibility (shore vs. island) now explained.
- **[GATE-FIX, ANDERSON VERIFY → RESOLVED]** Anderson "Kentucky-born former enslaver" KEPT and the [VERIFY] flag DROPPED. Both facts confirmed by the fact-checker and framing critic: Anderson b. near Louisville, KY, June 14, 1805; acquired enslaved people through his 1845 marriage to a Georgia woman (Britannica; Battlefields.org; Wikipedia "Robert Anderson"). The Southern-enslaver-holding-the-fort-for-the-Union irony is true and load-bearing for the "line ran through families" theme.
- Food crisis; Apr 4 food-only resupply; Apr 9 Davis cabinet decision; Beauregard to Charleston (Mar 1); Apr 10 surrender demand → all ✅.
- **[GATE-FIX, CLARITY Leap E]** Added Davis's reason for striking despite the trap (could not accept a permanent Union post in the Confederacy's most symbolic harbor).
- **[GATE-FIX, FRAMING SHOULD-FIX]** Beauregard "former West Point superintendent" qualified: appointed superintendent only weeks earlier, the post lasting **five days** before Louisiana seceded and the government revoked his orders (verified by fact-check: Jan 23–28, 1861). "Louisiana Creole" replaced with the plainer "old French-speaking Louisiana family" per clarity-S12. Teacher-student irony (Anderson was Beauregard's West Point artillery instructor) retained, ✅.
- Apr 12, 3:30 a.m. notice; 4:30 a.m. first shot (mortar round, now glossed) → ✅; first shot NOT attributed to a named individual (disputed), honored.
- ~34 hrs; >3,000 shells; 43 guns/mortars; Apr 13 surrender; Apr 14 evacuate → ✅.
- ZERO combat deaths in bombardment; TWO accidental salute deaths — Pvt. Daniel Hough (killed instantly) + Pvt. Edward Galloway (mortally wounded, died days later); Hough = first military fatality → ✅. "Gun salute" glossed (ceremonial blank volley).
- Apr 15: Lincoln calls for 75,000 militia → ✅.

**Upper South secession + Lee (Beats 5 & 6)**
- Militia call as tipping point; VA Apr 17; AR May 6; NC May 20; TN Jun 8 (referendum, East TN Unionist); 11 CSA states; Richmond capital → all ✅.
- **[GATE-FIX, CLARITY-M4]** 75,000 militia now explains the no-standing-army / states-supply-their-own-militia mechanism AND glosses "ninety-day men" (90-day enlistments because a short war was expected — the dramatic irony made explicit).
- **[GATE-FIX, STORY pacing]** Virginia / capital-move / proximity split into two beats so the Richmond-100-miles-from-Washington geography lands.
- Lee: colonel, ~32-yr veteran, former West Point superintendent, one of the finest officers, Scott thought him near-indispensable; opposed secession ("nothing but revolution"), enslaver via wife's family → ✅.
- **[GATE-FIX, FRAMING SHOULD-FIX]** "perhaps the best general it had" → "one of its most capable senior officers… a deficit it would spend three years and a great deal of blood learning to compensate for" (drops the Lost Cause "best general" hagiography).
- **[GATE-FIX, CLARITY-S14/S15]** Lee side-tag changed to "(U.S. Army, soon Confederate)"; Blair given a one-line ID ("a veteran political operator acting as Lincoln's trusted emissary").
- Apr 18 Blair offer / Lee declines (paraphrase, not quoted); Apr 20 Lee resigns; 3-day sequence honored → ✅.

**Border states (Beat 7)**
- Four (DE, MD, KY, MO); rivers; nearly surround D.C.; Browning letter Sept 22, 1861 (verbatim); "God on my side" flagged apocryphal, not asserted → all ✅.
- **[GATE-FIX, STORY pacing]** Delaware trimmed to ~two sentences (was the longest treatment of "the easy one"); the reclaimed words went to the Kentucky scene.
- **[GATE-FIX, STORY-2]** Kentucky scene deepened: both presidents Kentucky-born within ~100 miles (Lincoln, Hardin County, 1809; Davis, Fairview, 1808) — now leading opposite nations; ✅ in fact-check.
- **[GATE-FIX, FACT MUST-FIX 3 + SHOULD-FIX B; FRAMING MUST-FIX 2]** Baltimore riot: only the **6th Massachusetts Militia** was attacked (Apr 19); "and Pennsylvania" removed, with a clause noting PA troops passed the day before (Apr 18) unharmed. Death toll corrected to **five Union soldiers and at least twelve civilians** (four killed outright + Cpl. Sumner Henry Needham, who died of wounds days later; Sgt. John Ames also mortally wounded). Verified at revision time via Wikipedia "Baltimore riot of 1861" + NPS.
- **[GATE-FIX, CLARITY-M5]** Habeas corpus reordered and re-glossed: a plain one-line version ("the centuries-old rule that the government cannot lock a person up without bringing them before a court and proving a lawful reason") is given **before** "suspended," and "writ" is defined in plain words (a court order forcing the government to justify holding a prisoner or release them) before the consequences.
- **[GATE-FIX, CLARITY-S16]** "Ex parte Merryman" replaced with "in an emergency decision"; Taney (Dred Scott author) ✅; Apr 29 53–13 vote ✅; Sept ~1/3 of "the Maryland General Assembly (the state legislature)" arrested (follow-on) ✅.
- Kentucky neutrality May 20; Lincoln armed Unionist home guards; Sept Confederate incursion → KY sides with Union → all ✅.
- **[GATE-FIX, FACT MUST-FIX 1; CLARITY-M6]** Camp Jackson (May 10): Lyon corrected from "Brigadier General" to **captain** ("then only a captain"; promoted BG May 30). The 63-word sentence split into trackable steps. German-immigrant regiments; cannon seized from federal arsenal; crowd attacks after a man fires; ~28 civilians killed; secured St. Louis but pushed MO toward guerrilla war → all ✅.

**Closing**
- Two-foundings contrast → Framing (A)(B), composed, no new facts.
- **[GATE-FIX, FRAMING SHOULD-FIX 7]** Added the enslaved-as-stakeholders sentence (end of "In Their Own Words" and echoed in the close): the four million enslaved people understood the stakes and were not bystanders — closes the human-reality gap without poaching the "Freedom Struggle" sibling's lane.
- Handoff to First Bull Run; only framing asserted (first major battle, a Virginia creek). [VERIFY-residual] The handoff names First Bull Run as the next section — an internal pipeline assumption; confirm the section order before integration (fact-checker [VERIFY] #3 noted this is outside the fact gate's scope).

---

### LOCKED FRAMING QUOTES — VERBATIM CONFIRMATION (each re-checked against the fact pack and, where corrected, the cited primary source)

**(A) Cornerstone Speech (Stephens) — all three quoted passages verbatim:**
- "The new Constitution has put at rest forever all the agitating questions relating to our peculiar institution—African slavery as it exists among us—the proper status of the negro in our form of civilization. This was the immediate cause of the late rupture and present revolution." ✓ verbatim.
- "Those ideas, however, were fundamentally wrong. They rested upon the assumption of the equality of races. This was an error." ✓ verbatim.
- "Our new government is founded upon exactly the opposite idea; its foundations are laid, its corner-stone rests, upon the great truth that the negro is not equal to the white man; that slavery, subordination to the superior race, is his natural and normal condition. This, our new government, is the first, in the history of the world, based upon this great physical, philosophical, and moral truth." ✓ verbatim (singular "opposite idea"; comma version of "slavery, subordination to the superior race," per fact-check).
- Provenance now corrected to the *Savannah Republican* (canonical Savannah text), distinguished from the *Southern Confederacy* Atlanta March 12 speech. ✓

**(B) Confederate Constitution — all quoted clauses verbatim (Avalon Project):**
- "three-fifths of all slaves" (Art. I §2(3)). ✓
- "law denying or impairing the right of property in negro slaves" (Art. I §9(4)). ✓
- "slaves and other property" (Art. IV §2(1)). ✓
- "the institution of negro slavery, as it now exists in the Confederate States, shall be recognized and protected" (Art. IV §3(3)). ✓

**(C) Secession Declarations — all quoted passages verbatim (Avalon Project):**
- Mississippi: "Our position is thoroughly identified with the institution of slavery—the greatest material interest of the world." ✓
- Mississippi: "Its labor supplies the product which constitutes by far the largest and most important portions of commerce of the earth. These products are peculiar to the climate verging on the tropical regions, and by an imperious law of nature, none but the black race can bear exposure to the tropical sun." ✓
- Mississippi: "There was no choice left us but submission to the mandates of abolition, or a dissolution of the Union." ✓
- Mississippi: "loss of property worth four billions of money." ✓ (fragment)
- South Carolina: "deliberately refused, for years past, to fulfill their constitutional obligations" / "encouraged and assisted thousands of our slaves to leave their homes" / "servile insurrection." ✓ (fragments)
...
- Georgia: "anti-slavery party" / "the prohibition of slavery in the Territories is the cardinal principle of this organization." ✓ (fragments)
- Georgia: "subvert our society, and subject us, not only to the loss of our property but the destruction of ourselves, our wives and our children, and the desolation of our homes, our altars, and our firesides." ✓ (now FULL sentence; previously truncated).
- **Texas (newly added):** "was received as a commonwealth holding, maintaining and protecting the institution known as negro slavery—the servitude of the African to the white race within her limits." ✓ / "rightfully held and regarded as an inferior and dependent race, and in that condition only could their existence in this form be tolerable or advantageous." ✓ / "the abolition of negro slavery throughout the confederacy, the recognition of political equality between the white and negro races." ✓ (all verbatim from fact pack / Avalon Project).

**Lincoln First Inaugural (Beat 3) — verbatim:**
- "I have no purpose, directly or indirectly, to interfere with the institution of slavery in the States where it exists." ✓
- "I hold that in contemplation of universal law and of the Constitution the Union of these States is perpetual." ✓
- "The power confided to me will be used to hold, occupy, and possess the property and places belonging to the Government, and to collect the duties and imposts; but beyond what may be necessary for these objects, there will be no invasion, no using of force against or among the people anywhere." ✓ (now COMPLETE sentence; previously truncated).
- "In your hands, my dissatisfied fellow-countrymen, and not in mine, is the momentous issue of civil war." ✓
- "I am loath to close. We are not enemies, but friends. We must not be enemies. Though passion may have strained it must not break our bonds of affection. The mystic chords of memory, stretching from every battlefield and patriot grave to every living heart and hearthstone all over this broad land, will yet swell the chorus of the Union, when again touched, as surely they will be, by the better angels of our nature." ✓

**Davis First Inaugural (Beat 2) — verbatim fragments:**
- "the right solemnly proclaimed at the birth of the States" / "in the people the power to resume the authority delegated." ✓
- "it is by abuse of language that their act has been denominated a revolution." ✓

**Lincoln to Browning (Beat 7) — verbatim:**
- "I think to lose Kentucky is nearly the same as to lose the whole game. Kentucky gone, we can not hold Missouri, nor, as I think, Maryland. These all against us, and the job on our hands is too large for us." ✓

**Lincoln 1848 Congressional speech (Beat 2) — newly quoted, verbatim fragment:**
- "I had a good many bloody struggles with the musquetoes, and although I never fainted from the loss of blood, I can truly say I was often very hungry." ✓ (Lincoln's July 27, 1848 speech in the U.S. House on the Mexican War; *Collected Works*, Vol. 1. Original spelling "musquetoes" retained.)

**Lee (Beat 6) — paraphrased, not quoted:** "could take no part in an invasion of the Southern states" rendered as paraphrase (not in quotation marks), per fact-check ✅.

**[VERIFY] residuals after revision:**
1. **Handoff naming First Bull Run** — internal section-order assumption, outside the fact gate's scope; confirm the next section is in fact First Bull Run before integration. (All on-page Bull Run content is generic — "a Virginia creek," "the first real battle" — both accurate, so no factual exposure if the order changes.)

All three FACT must-fixes, both FACT should-fixes, both FRAMING factual/provenance must-fixes, all four FRAMING should-fixes, both COMPREHENSIVENESS must-adds, all six CLARITY must-fixes, and the three high-leverage STORY rewrites are applied. No unresolved [VERIFY] flags remain in the body text.
