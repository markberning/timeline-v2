...
> quote: With a heart full of love and gratitude I now take leave of you. — George Washington at Fraunces Tavern, from Tallmadge's 1830 memoir
...
> quote: Having now finished the work assigned me, I retire from the great theatre of Action — and bidding an Affectionate farewell to this August body. — George Washington, resignation address, 23 December 1783
...
*Every non-trivial factual claim keyed to its fact-pack section. No fact appears here that is not in the pack. HANDLE-WITH-CARE directives obeyed are flagged HWC#. Revision fix tags: [FIX-FACT], [FIX-FRAME], [FIX-STORY], [FIX-CLARITY], [FIX-NIT].*
...
- Britain *chose* to stop — anti-inevitability beat stated plainly; "Britain stopped because Britain decided to stop" KEPT (NIT was optional; the line still earns its place as the open's thesis). (S1 KEY FRAMING)
- Gnadenhutten, March 1782: PA militia under Col. David Williamson murdered 96 unarmed Christian Delaware (men/women/children), no one punished — ONE sentence, cross-ref native-nations; 96 total only. (S1; HWC: native chapter owns it)
- Blue Licks, Aug 1782: British/Loyalist/Native ambush, ~70 Kentuckians killed, incl. Israel Boone, Daniel Boone present and had warned against it; "nearly a year after Yorktown"; no last-battle claim. (S1)
- The Saintes, April 1782: Rodney shattered de Grasse's fleet; flagship surrendered, de Grasse captured aboard; Jamaica invasion finished. (S1)
...
- National debt "roughly doubled" (no hard numbers, per MED). 1763 Treaty of Paris symmetry. (S1)
- [FIX-STORY] "The point here is the timing:" → "The timing is the point: the surrender that supposedly ended the war did nothing to stop the killing on the western edge of it."
...
- Commons: Feb 1782 motion failed by one vote, then passed 234–215; North resigned 20 March 1782, PM 12 years, first government brought down by effective no-confidence. (S2; used 20 March, no scene on the 27 March gap per HWC#11)
- [FIX-CLARITY] Commons glossed ("the lower house of Parliament, where a government survives only as long as it holds a majority of votes there"); no-confidence glossed ("a formal motion declaring that Parliament has lost faith in the government; once it passes, the ministry has to resign"); "ministry" defined at first standalone use, moved to the Rockingham→Shelburne sentence ("the cabinet, the prime minister and his senior ministers, who govern as a bloc and fall together"); the earlier no-confidence sentence reworded "ministry"→"government" so the gloss precedes first jargon use.
- George III's undelivered abdication draft (c. late March 1782): "...quitting it for ever." Framed "not a cartoon tyrant" per HWC#10. (S2)
...
- Shelburne's bet: independence as opportunity, keep profits/trade not costs/garrisons; generous boundary; "Adam Smith's *Wealth of Nations*" kept light. (S2)

### Section: "The negotiators and the Vergennes problem" (S3)
- [FIX-CLARITY] "commissioners" defined at first use ("official envoys empowered to negotiate and sign").
- Five named, four signed: Franklin (throughout), Jay (Madrid June 1782), Adams (Netherlands late Oct 1782), Laurens (2 days before preliminaries). Jefferson appointed, never arrived. (S3)
- Laurens: Tower of London >1 yr, only American held there, exchanged for Cornwallis. (S3)
- British side: Oswald negotiated preliminaries; David Hartley MP signed definitive 1783. (S3)
- Oswald slave-trade wealth; Laurens his Charleston associate — ONE dry clause. (S3)
- Instructions, 15 June 1781 (verbatim): "to undertake nothing... without their knowledge and concurrence; and ultimately to govern yourselves by their advice and opinion"; non-negotiables = independence + alliance. (S3 quote #4)
- [FIX-CLARITY] Vergennes re-anchored at the instructions beat ("the Comte de Vergennes, France's foreign minister, ran the war and the diplomacy from the king's court outside Paris").
- They negotiated separately = real violation, stated plainly. (S3; HWC#4, #5)
- Jay's Rayneval suspicion (Sept 1782, false name, Jay's own messenger without Franklin); "probably overdrawn," Rayneval chiefly Franco-Spanish/Gibraltar, Jay "partly right in spirit." (S3; HWC#4 DISPUTED)
- Preliminaries explicitly conditional: preamble "not to be concluded untill terms of a peace shall be agreed upon between Great Britain and France"; not a separate peace in law; "bent in spirit, not broken in letter." (S3; HWC#4)
- Vergennes "The English buy peace rather than make it" — "marveled," no footnote. (S3) PULL QUOTE.
- Vergennes's Dec 1782 protest = the discourtesy of shipping articles off without informing the court. (S3)
- [FIX-STORY] "one of the great pieces of diplomatic nerve in the founding" → "What Franklin sent back took nerve."
- Franklin's 17 Dec 1782 letter (verbatim, shown to Adams/Jay/Laurens): "Nothing has been agreed... till you have concluded yours" + "The English... flatter themselves they have already divided us... totally mistaken." (S3 quote #5)
- France's 6-million-livre loan (1783); first money crossed on the ship that carried the preliminaries home (loose per MED). (S3)
- [FIX-NIT] livres glossed ("the French currency of the day").
...
- Art. 1 verbatim incl. the 13 states named ("Brittanic" spelling); plural = 80-yr argument. (S4 quote #1)
- Art. 2: NE highlands, 45th parallel, Great Lakes, west to Mississippi, down to ~Florida; "roughly doubled" (qualitative); almost all Native homeland → §6. (S4)
- [FIX-FRAME, BLOCKER] Art. 2 gets the plain Native clause: "That land was full of nations who had not surrendered it and were not consulted."
- Art. 3: "right to take fish" open ocean vs "liberty to take fish" inshore; right=yours, liberty=revocable; Adams's crusade; decades of disputes (one clause). (S4)
- [FIX-CLARITY] "unmolested" glossed ("without interference from British patrols").
- Art. 4 verbatim ("no lawful impediment... full value in sterling money... bona fide debts"); British merchants could sue; one of two broken promises. (S4)
- Art. 5 verbatim "earnestly recommend"; toothless by design; British fig leaf; British critics savaged it, helped bring Shelburne down a few months later (no invented quote per HWC#7). (S4)
- Art. 6 verbatim; flouted in early postwar years. (S4)
- Art. 7 verbatim eleven words; Laurens procured/interlined it 30 Nov 1782, witnesses recorded the insertion; "property" classes people with furniture/livestock; Carleton declined retroactive application. (S4; HWC#8)
- [FIX-FRAME] Carleton's consequence added: "...not 'property of the American inhabitants' to be handed back, and in declining, freed them." (rendered without em dash in our prose)
- Arts. 8/9/10: Mississippi "forever remain free and open"; pre-news conquests restored without compensation; ratification defined + six-month clock. (S4)
- [FIX-CLARITY] Art. 10's deadline pinned to the definitive treaty ("within six months of the definitive treaty's signing").
- Secret separate article (preliminaries only): West Florida boundary farther north; never operated; caused real discomfort. (S4)
- [FIX-NIT] "the Floridas" glossed ("the two Florida colonies, East and West, that Spain and Britain were dividing between them").
- Rest of the Peace of Paris (same day): Spain — East Florida + West Florida + Minorca, nothing on Gibraltar; France — Tobago + Senegal + "a mountain of debt... pointing toward 1789." (S4)

### Section: "Signed, sealed, ratified" (S5)
- Preliminaries 30 Nov 1782, Oswald + Adams/Franklin/Jay/Laurens, conditional. (S5)
- Britain/France/Spain preliminaries Jan 1783; guns fell silent (cessation soft, no 11 April date per MED). (S5)
- Definitive 3 Sept 1783 (NOT the Avalon "September 30" misprint per HWC#11), Hôtel d'York / Hartley's Left Bank lodgings, by Hartley/Adams/Franklin/Jay, Laurens absent; "deliberately ordinary room." (S5)
- [FIX-STORY] West painting prose gets its explanatory clause: "...it tells the truth precisely because it was never finished: the British side is blank because Oswald and his secretary refused to pose for a picture of their own defeat."
- [FIX-NIT] Caleb Whitefoord named (prose + caption).
- West unfinished painting: Americans finished (Jay, Adams, Franklin, Laurens, W.T. Franklin), British half blank, Oswald + Whitefoord refused, never finished. THE chapter image. (S5; FIGURE 1)
- Ratification: 9 states required; Jefferson insisted nine required vs a seven-state shortcut; one SC delegate completed the ninth; unanimous 14 Jan 1784; near the deadline; exchange in Paris May 1784; "deadline technically blown," wry, no consequence. (S5)

### Section: "Who paid" (S6)
- [FIX-CLARITY] Vergennes re-anchored ("the French foreign minister who had been cut out of the deal").
- [FIX-CLARITY] Loyalist beat self-anchored ("the colonists who had stayed loyal to the Crown").
- Loyalists: ~60,000 left (Jasanoff count), ~15,000 enslaved carried; Art. 5 produced almost nothing; Parliament's claims commission examined >3,000 claims, paid "on the order of" £3M. Cross-ref civil-war. ONE beat. (S6)
- Native nations: NO signatories, NO provisions, NO mention (verified vs full text) — stated as fact (HWC#9); Britain signed away trans-Appalachian West incl. its own allies without telling/consulting/naming; US treated land as conquered; Fort Stanwix 1784 punitive cession. ONE forward line; native chapter owns it. (S6)
- [FIX-FRAME] S6 Native beat strengthened with the added sentence: "The nations the treaty erased were not defeated at any Paris table; the land transfer was a fiction performed entirely by the people who wanted the land."
- [FIX-CLARITY] Haudenosaunee glossed ("the Six Nations of the Iroquois Confederacy"); Fort Stanwix rendered as a forced land-cession treaty at "a post called Fort Stanwix."
- Enslaved: NY ~3,000 Black refugees carried to freedom over protest (Carleton's stand); Savannah/Charleston 1782 far larger numbers carried off STILL enslaved; Art. 7's afterlife → compensation fight decades, War of 1812, Tsar arbitration, settled 1826 Britain paid US >$1M. ONE beat. (S6) PILL: slavery-and-the-revolution.
- [FIX-CLARITY] Carleton callback made self-contained ("the people Carleton, the British commander in New York, had refused to apply Article 7 backward to, since they had already been freed").
- Soldiers: furloughed from summer 1783 with 3 months' pay + final-settlement certificates (defined), most sold to speculators for a fraction; army chapter owns Newburgh/furloughs/Cincinnati. ONE beat, NOT trimmed. (S6) PILL: army-from-nothing.
- [FIX-STORY] soldiers beat strengthened with one human line (pack-supported only): "To a man walking home broke, with no farm waiting and no cash in his pocket, a certificate that might be honored someday was worth less than a meal today, so most of them sold the paper to speculators for a fraction of its face value and took whatever they could carry."
- The dead: Peckham ~25,000 (battle, camp disease, prison ships), "probably more," upper estimates higher; uncounted civilian/Loyalist/British/German/Native dead; ~1% of ~2.5M; per-capita claim in EXACT defensible form ("deadliest in US history except the Civil War"), no hard single total. (S6; HWC#6)
- PILLS: civil-war-among-themselves, slavery-and-the-revolution, army-from-nothing.

### Section: "The endings" (S7)
- Evacuations in order: Savannah summer 1782; Charleston Dec 1782 (>4,200 Loyalist civilians + >5,000 of African descent); New York end 1783, last and largest. (S7)
- Evacuation Day 25 Nov 1783: 7-year occupation; handover at noon; Washington + Gov. George Clinton rode in; civic holiday ~100 years. (S7)
- Greased flagpole: told AS the story New York told, explicitly badged; fullest telling 1883 by Van Arsdale's grandson; "some flag incident plausible," polished heroics = family legend. (S7; HWC#2)
- [FIX-CLARITY] Tallmadge pre-introduced ("a cavalry officer and Washington's chief of military intelligence through the war").
- Fraunces Tavern 4 Dec 1783, Long Room, Pearl St; ONLY firsthand = Tallmadge's 1830 memoir (badged "recollection not a transcript"); "With a heart full of love and gratitude..."; Knox embraced first, then every officer. (S7 quote #7)
- [FIX-FACT, BLOCKER] Tallmadge silence quote completed in full: "Not a word was uttered to break the solemn silence that prevailed, or to interrupt the tenderness of the interesting scene."
- [FIX-STORY] Fraunces pull quote MOVED to after the scene completes (after the Tallmadge silence line), tagged "from Tallmadge's 1830 memoir."
- [FIX-STORY] cut "And then Annapolis, which is where the arc lands." (meta) — section flows straight into the Annapolis scene.
- Annapolis 23 Dec 1783, ~noon, Old Senate Chamber; Mifflin presiding (the failed Valley Forge quartermaster now receiving the commission); delegates seated with hats on, Washington bareheaded; hand shook; McHenry eyewitness same-day letter; resignation close verbatim. (S7 quote #6)
- [FIX-FACT] Washington's resignation restored verbatim with HIS em dash, in BOTH prose and pull-quote: "I retire from the great theatre of Action — and bidding an Affectionate farewell to this August body..." (em dash inside a verbatim source quote, allowed; our prose ban unaffected).
- "Greatest man in the world": badged HARD as "a story the King's own painter told," two non-matching West versions, NOT the king's words. (S7; HWC#3)
- Republican precedent: victorious general hands power back to a Congress that couldn't pay the men; Society of the Cincinnati / Cincinnatus; concrete, no meta. (S7)
...
- Debts + Loyalist articles stayed broken >a decade; government that couldn't enforce its treaty → road to the Constitution (single forward clause). (S8)
...
- Close = the Annapolis room; country twice its settled size, indebted, victorious, contradictory.
- [FIX-STORY] frame-breaking "The rest of the app is that argument." → "The rest of it is that argument."

### Images placed (3 figures)
- /war-img/rev-treaty-west.jpg — Benjamin West, "American Commissioners of the Preliminary Peace Agreement" (1783–84, unfinished, Winterthur). PD. Caption carries the refused-to-sit story + names the five Americans + Whitefoord. NON-NEGOTIABLE figure. (pack candidate 1)
- /war-img/rev-treaty-evacuation.jpg — "'Evacuation day'... Nov. 25th, 1783," chromolithograph 1879, LOC 2003652651. PD. Captioned AS a later commemorative print. (pack candidate 4)
- /war-img/rev-treaty-resignation.jpg — John Trumbull, "General George Washington Resigning His Commission" (1824, Capitol Rotunda). PD. Caption carries the later-imagining caveat (4 decades later; Martha + others not present). (pack candidate 3)
- NOT used: signature-page NARA scan (candidate 2); Chappel "Washington's Farewell" 1866 (candidate 5); Lord North portrait (candidate 6, file unconfirmed).

### GAPs
- [GAP: Lord North portrait] No image slot taken in "London turns"; the candidate-6 North portrait was not byte-confirmed; North carried in prose only.
- [GAP: treaty signature page] The NARA signature-page scan (candidate 2) is verified-PD but not placed (figure budget = 3). Flag for image-review if a 4th figure is wanted; the signature page is the obvious add.
- No invented dates, numbers, names, or quotes. All six HANDLE-WITH-CARE directives obeyed. Native silence stated as fact; Rayneval presented as Jay's suspicion; both sides shown honest.
