# Author draft — Andy Warhol, *Marilyn Diptych* (1962) · id=`marilyn`

Authored from `audits/art-pipeline/work-marilyn-factpack.md` (source of truth). Shape ported from `STARRY_NIGHT` / `CITY_RISES`; in-copyright credit/rights handling from `AUTUMN_RHYTHM`; voice from the absinthe chapters. Five `Mar*` section components + trailing NARRATIVES registry comment.
...
//    Niagara, photographed by Gene Kornman. Don't name another film.
  ...
  return (
    <article style={{ padding: '18px 18px 40px' }}>
      ...
      <p style={proseStyle}>
        ...
        n <strong>5 August 1962</strong>, <strong>Marilyn Monroe</strong> (1926&ndash;1962) was found dead in her Los Angeles home. She was thirty-six, the most photographed woman in the world, and at that moment the most famous face on the planet. Within weeks, a thirty-three-year-old New York artist named <strong>Andy Warhol</strong> (1928&ndash;1987) was making picture after picture of that face. The work we&rsquo;re going to look at, the <em>Marilyn Diptych</em>, comes straight out of those weeks. It is not a memorial in the ordinary sense. It is something stranger, and to see what, you first have to know what Warhol had already been doing that year.
      </p>
      <p style={proseStyle}>
  ...
  return (
    <article style={{ padding: '18px 18px 40px' }}>
      ...
      <p style={proseStyle}>
        ...
        very one of the fifty faces in this work comes from a <strong>single photograph</strong>. Not fifty photos, not a sitting, not a range of moods, one image, used over and over. It is a <strong>publicity still</strong> (a posed promotional photo a film studio puts out to advertise a movie) made in <strong>1953</strong> for the film noir <em>Niagara</em>, in which Monroe had her first starring role. The photographer was <strong>Gene Kornman</strong>, a Hollywood studio cameraman. Warhol cropped the still tight, throwing away the rest of it and keeping only the head: the hair, the heavy-lidded eyes with their shadow, the parted lips. What he kept was not really a face so much as a <strong>mask</strong>, the glamour image at its most reducible, the few features that say &ldquo;Marilyn&rdquo; and nothing else.
      </p>

      <SectionHeader accent={accent} label="The technique" title="What a silkscreen is, and how he pulled fifty" />
      <p style={proseStyle}>
        Now the method, because it is the whole point. The image is not painted. It is <strong>silkscreened</strong>, and that word needs unpacking. A <strong>silkscreen</strong> (or screenprint) is a stencil printing process: you take a fine mesh screen, block out the parts that should stay blank, and push ink through the open mesh onto whatever lies beneath, so the ink prints in the shape of the open areas. Warhol used a <strong>photographic</strong> version of this. As he described it himself: <em>&ldquo;you pick a photograph, blow it up, transfer it in glue onto silk, and then roll ink across it so the ink goes through the silk but not through the glue.&rdquo;</em> The photograph becomes the stencil. Then you press the screen onto the canvas, squeegee ink through it, lift it, move it over, and pull again. Same image, again and again, by hand but by machine logic, as fast as you can reposition the screen.
      </p>
      <p style={proseStyle}>
      ...
      <p style={proseStyle}>
        And because it is printing, it goes wrong, on purpose. Roll a screen by hand fifty times and the ink loads up and runs out; the screen lands a hair off-center; an impression clogs solid or starves to a ghost. Warhol did not fix any of this. He let the registration drift and the ink thin and the faces clog or fade, so that the &ldquo;same&rdquo; image is in fact slightly different every single time, never once a clean copy. Two paintings worth of the same dead movie star, reproduced by a process that quietly fails. That failure is not a flaw in the work. As the next chapter shows, it is most of what the work is about.
      </p>
    </article>
  )
}
  ...
  return (
    <article style={{ padding: '18px 18px 40px' }}>
      ...
      <p style={proseStyle}>
        ...
        tand in front of it. The first surprise is the <strong>size</strong>. People who know the image from postcards expect something small; in the room it is large, about <strong>six and three-quarter feet tall and nine and a half feet wide</strong> (the two panels joined run over nine feet across), a wall of a picture. The second thing you register is that it is <strong>two canvases</strong>, set edge to edge, with a clear seam down the middle, and that the two halves are doing opposite things. The whole work hinges on that split. Take the two sides one at a time.
      </p>
      ...
      <p style={proseStyle}>
        Now cross the seam to the <strong>right</strong> panel, and the color is simply gone. It is <strong>black-and-white</strong>, the same face printed in black ink on bare canvas, and as your eye travels across it the printing <strong>degrades</strong>. Some faces are over-inked, clogged into dark blots where the features disappear. Others are starved, the ink thinning out, the face breaking up, growing fainter and fainter until, toward the <strong>far right edge</strong>, the last impressions all but <strong>dissolve into blank canvas</strong>. You can watch a recognizable face thin into a grey smudge and then into almost nothing. The machine is running out.
      </p>
      <p style={proseStyle}>
      ...
      <p style={proseStyle}>
        Pull back and take in the layout across both panels: <strong>fifty faces</strong> in even rows and columns, twenty-five a side, every one the same cropped Kornman still. The arrangement is not a gallery of portraits but a <strong>grid</strong>, the regular cells of a contact sheet, a strip of film frames, rows of product on a shelf. And once you see it as a grid, you see the argument it&rsquo;s making without a word: a star is a <strong>quantity</strong>, an image stamped out by the million, identical units. The thing that makes Marilyn Marilyn, the unrepeatable person, is exactly what the repetition strips away. Look at one face and it&rsquo;s a glamour shot; look at fifty and it&rsquo;s a product run, and the longer you look the emptier each one gets. That emptiness, it turns out, is the point, and it is what Warhol said out loud, which is where we go next.
      </p>
    </article>
  )
}
