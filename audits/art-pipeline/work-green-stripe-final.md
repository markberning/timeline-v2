# FINAL — THE GREEN STRIPE (kind: WORK, Modern era, Fauvism, 1905)

Matisse, *The Green Stripe (Portrait of Madame Matisse / La Raie verte)*, 1905,
Statens Museum for Kunst, Copenhagen. RESOLVED draft: the three gate files
(fact / read / frame) folded into `work-green-stripe-draft.md`. No BLOCKERs were
raised; every [FIX] and the strongest [NICE]s are applied. Component prefix `Grn`.

**Thirds-vs-two-zone settle (READ LOOK-2):** the painting's background is a
TWO-ZONE split (a warm pink-and-orange side, a cool teal-green side), echoing the
two-zone split of the face. The "thirds" wording lived only in the gate brief, not
in the painting; the prose, the Part A annotation, and the section blurb all now
agree on a two-zone background and the word "thirds" appears nowhere.
