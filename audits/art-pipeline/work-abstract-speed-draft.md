# DRAFT — Giacomo Balla, *Abstract Speed + Sound* (1913–14) — WORK read

Authored from `work-abstract-speed-factpack.md` (source of truth) in the absinthe voice.
Gated-from-the-start: this draft goes to the five critic gates before integration.

**Fact-handling notes for the gates:**
- Peggy Guggenheim Collection, Venice; accession **76.2553 PG 31** (per fact pack).
- **CENTRAL panel** of a three-part work; the Tate holds the **right** panel (*The Car has Passed*).
  Triptych framed as the **leading scholarly reconstruction, NOT settled fact** ("has been proposed",
  "may have been" — Guggenheim's own hedge). Panel titles + the left panel's whereabouts are DISPUTED.
- **Painted frame is integral** — part of the work, named as such.
- **PURE ABSTRACTION**: the speeding car is implied only by landscape/sky/force-lines/noise — **NO car shown.**
- "+rumore" = sound made visible (crisscross noise lattice).
- The 1912 *Dog* → 1913–14 abstraction turn.
- NO "first abstract painting" overclaim — "among the first," Western-scoped; abstraction had simultaneous
  origins (Kandinsky, Kupka, Delaunay, Malevich). MoMA's *Inventing Abstraction* (2012) placed this work.
- One proportionate, non-anachronistic line on Futurist ideology (manifesto glorified war/violence; Marinetti
  later co-founded Fascism). No invented Balla/Marinetti quotes.
- Dims imperial only: **1 ft 9½ in × 2 ft 6 in** (chip `1′9½″ × 2′6″`). Philadelphia *Velocità astratta + rumore*
  is a SEPARATE related work — never conflated.
...
// holds the right panel (Abstract Speed — The Car has Passed). Panel titles + the
// left panel's whereabouts are DISPUTED. The PAINTED FRAME is part of the work.
// PURE ABSTRACTION: no car is depicted; speed is implied by landscape, force-lines
// and noise. NO "first abstract painting" overclaim (abstraction had simultaneous
// origins — Kandinsky, Kupka, Delaunay). The Philadelphia "Velocità astratta +
// rumore" is a SEPARATE related work, never conflated with this Guggenheim panel.
// ─────────────────────────────────────────────────────────────
...
| Russolo → noise music (one-line context) | Movement const (Russolo) | [VERIFY] tone only — proportionate aside |
| Dims ≈ 1 ft 9½ in × 2 ft 6 in; oil on millboard; landscape | §1 | — |
| Green = earth, blue = sky, both across all 3 panels | §4.1, §4.3 | — |
| White road = lines of force / trajectory | §4.2 | — |
| Swept blue arcs = bent atmosphere | §4.3 | hedged ("read as") |
| Multiplication of lines/planes = museum phrase for centre panel | §4.5 | quoted museum phrase |
...
| Panel titles wobble (*Line of Force + Noise*); left panel whereabouts undocumented | Headline, §8 | DISPUTED, stated as such |
| Philadelphia *Velocità astratta + rumore* = separate work | §Headline disambiguation | not conflated |
| "Among the first," Western-scoped; Kandinsky/Kupka/Delaunay simultaneous; MoMA *Inventing Abstraction* 2012 | Beat 5, §8 | NO "first" overclaim |
| Marinetti 1909 manifesto glorified war as "world's only hygiene"; Futurists → WWI; Marinetti co-founded Fascism | §6, movement hookLong | proportionate; "help write the founding manifesto of Italian Fascism" |
