# DRAFT — Work read: *Funeral of the Anarchist Galli* (Carlo Carrà, 1910–11, MoMA)

Authored from `work-galli-factpack.md` (source of truth). Voice modeled on the
L'Absinthe narratives. Imperial dims only. NEW prose contains no `—` (em dash);
verbatim quote punctuation preserved. Born-verified facts only.

Fact handling honored: Angelo Galli died **10 May 1906** (killed during a Milan
general strike); Carrà misdated it to 1904 in his 1945 memoir and *Corriere della
Sera* corrected it (told as a small story, 1906 stated as fact). The first-person
account is framed as 1945 recollection, not live reportage. Marinetti is movement
context only, no role in the canvas. The "one killed, eight injured Royal Guard"
detail is single-sourced and hedged. Rights: pd-us (Carrà d.1966 → PD-US / self-host
tier). No invented price. heroFit: 'contain', landscape ~1.3.
...
// (hedged). Marinetti is movement context only, no role in this canvas.
...
export const GALLI: ArtWorkContent = {
  ...
  sections: [
    { id: 'street', eyebrow: 'Milan · May 1906', dateLabel: '10–13 May 1906', title: 'The funeral the police would not let through', blurb: 'A general strike convulses Milan; the anarchist organizer Angelo Galli is stabbed to death on 10 May 1906, and at his funeral days later the police on horseback refuse to let the procession reach the cemetery. Carrà, living in the city’s anarchist circles, is caught in the crush.', progress: 0.08 },
    ...
    { id: 'afterlife', eyebrow: 'After', dateLabel: '1912–today', title: 'Paris, Berlin, and a wall at MoMA', blurb: 'First shown in Paris in 1912 at the Futurists’ landmark group exhibition, the canvas passes through Berlin and Dutch collections before MoMA acquires it in 1948, where Alfred Barr reads its chaos as secretly classical, ordered like a fifteenth-century battle piece.', progress: 0.96 },
  ],
  provenance: [
  ...
  figures: [
    { name: 'Carlo Carrà', role: 'The painter', palette: ['#bf2f25', '#1c1c1c', '#6a1414'] },
    { name: 'Angelo Galli', role: 'The anarchist in the coffin', palette: ['#8a1c1c', '#3a1010', '#120606'] },
...
function GalStreet({ accent }: { accent: string; onZoom: (src: string, cap: string) => void }) {
  return (
    <article style={{ padding: '18px 18px 40px' }}>
      ...
      <p style={proseStyle}>
        One of those anarchists was a strike organizer named <strong>Angelo Galli</strong>. On <strong>10 May 1906</strong>, Galli was <strong>stabbed to death</strong> by security guards of the Macchi and Pessoni factory as he and a small group of fellow anarchists approached a picket line. The killing landed in a city already on a knife&rsquo;s edge. (You will sometimes read that the strike itself had begun after the authorities fired on a crowd, killing one and wounding several more; that specific casualty count traces to a single source, so hold it loosely. What is not in doubt is the temperature of the streets that week, or that a man on the strikers&rsquo; side was now dead.)
      </p>
      <p style={proseStyle}>
      ...
      <p style={proseStyle}>
        And in that crowd, getting shoved and trampled along with everyone else, was a young painter named <strong>Carlo Carrà</strong>. He was living in Milan, he moved in the city&rsquo;s anarchist circles, and on the day Galli was buried he was not an artist observing a subject from a safe distance. He was a man in a brawl. That is the difference that makes this painting what it is, and it is worth holding onto as we go: the picture we are about to look at is not a scene Carrà witnessed. It is a scene he was inside.
      </p>
    </article>
  )
}
  ...
  return (
    <article style={{ padding: '18px 18px 40px' }}>
      ...
      <p style={proseStyle}>
        ...
        here are, in a sense, two versions of this painting, and the gap between them is the whole story of how it got made. The first is a <strong>charcoal-and-pastel study</strong> Carrà drew in <strong>1910</strong>, and the surprising thing about it is how <em>orderly</em> it is. It uses traditional, near one-point perspective &mdash; the old Renaissance trick of letting all the receding lines aim at a single vanishing point, so the scene sits in a deep, believable box of space, the way a stage set does. Carrà had come up through <strong>Divisionism</strong>, the Italian cousin of Pointillism, in which you build an image out of separate small strokes of pure, unmixed color and let the eye blend them. He knew how to make a calm, deep, well-mannered picture of a chaotic event. The 1910 study is exactly that.
      </p>
      <p style={proseStyle}>
        It is also, by then, the wrong kind of picture for the man making it. By 1910 Carrà was a <strong>Futurist</strong>. He had put his name to the two founding documents of Futurist painting that year, the <strong>Manifesto of the Futurist Painters</strong> and the <strong>Technical Manifesto of Futurist Painting</strong>, alongside <strong>Umberto Boccioni, Luigi Russolo, Giacomo Balla</strong> and <strong>Gino Severini</strong>. Futurism, the loud Milanese movement founded a year earlier by the poet <strong>Filippo Tommaso Marinetti</strong>, worshipped speed, machines, crowds, energy, the modern city at full throttle. (Marinetti launched the whole thing with a manifesto on the front page of a Paris newspaper; he is the impresario behind the movement, not a hand on this particular canvas, so file him as background.) A movement built on motion and force could not very well be content with a tidy one-point-perspective drawing of a riot.
      </p>
      <p style={proseStyle}>
      ...
      <p style={proseStyle}>
        Those lines of force were not decoration. They were doctrine. The Futurists&rsquo; own <strong>Technical Manifesto</strong> had declared that such force-lines must <strong>&ldquo;encircle and involve the spectator so that he will&hellip; be forced to struggle himself with the persons in the picture.&rdquo;</strong> Read that again, because it is the design brief for this canvas. The point of the lines is not to depict the riot. It is to put <em>you</em> in it, to deny you the safe spot outside the frame from which you would normally watch a painting. A funeral that Carrà had been physically unable to stand outside of became a painting you are not allowed to stand outside of either. The chaos is the subject, and the structure is built to make the chaos reach out and grab you.
      </p>
    </article>
  )
}
...
function GalLooking({ accent }: { accent: string; onZoom: (src: string, cap: string) => void }) {
  return (
    <article style={{ padding: '18px 18px 40px' }}>
      ...
      <p style={proseStyle}>
        Now find the one red thing. Up in the <strong>upper center</strong>, riding above everything on the mourners&rsquo; shoulders, is the single brightest, reddest passage in the picture: <strong>Galli&rsquo;s coffin</strong>, draped and, in Carrà&rsquo;s memory, piled with <strong>red carnations</strong>. Here is the move that organizes the whole canvas: Carrà does not light the coffin, he makes the coffin the <em>source</em> of light. Red flares out of it and washes across the bodies below, the way the sun would in an ordinary picture. So the dead man is not the still, sad center of a funeral. He is the hot core of an explosion. Your eye goes there first and keeps being pulled back.
      </p>
      <p style={proseStyle}>
...
function GalAfterlife({ accent }: { accent: string; onZoom: (src: string, cap: string) => void }) {
  return (
    <article style={{ padding: '18px 18px 40px' }}>
      <SectionHeader accent={accent} label="Paris · February 1912" title="The riot goes on the wall" first />
      <p style={proseStyle}>
        <DropCap accent={accent}>T</DropCap>
        he finished painting made its public debut not in Milan but in <strong>Paris</strong>, in <strong>February 1912</strong>, at the <strong>Galerie Bernheim-Jeune</strong>. This was the Futurists&rsquo; landmark group exhibition, the show that introduced the Italians to the French avant-garde, organized with help from the critic <strong>Félix Fénéon</strong> &mdash; the same sharp-eyed dealer-critic who turns up all over this period of modern art. Carrà&rsquo;s riot, hung in Paris a year after Paris had handed him the Cubism that rebuilt it, went out into the world.
      </p>
      <p style={proseStyle}>
      ...
      <p style={proseStyle}>
        In <strong>1948</strong> it crossed to New York, to the <strong>Museum of Modern Art</strong>, acquired through the <strong>Lillie P. Bliss Bequest, by exchange</strong> &mdash; meaning MoMA traded other works for it rather than paying cash, the same quiet mechanism that brought the museum its <em>Starry Night</em>. It hangs there still, and it is at MoMA that the painting picked up its most durable reading.
      </p>
      <p style={proseStyle}>
        That reading came from <strong>Alfred H. Barr Jr.</strong>, MoMA&rsquo;s founding director and one of the people who effectively wrote the standard story of modern art in the twentieth century. Barr looked at all that red-and-black chaos and saw, underneath it, something almost paradoxically calm. He called the painting <strong>&ldquo;as classically organized as a fifteenth-century battle piece by Paolo Uccello,&rdquo;</strong> likening it to Uccello&rsquo;s famous <em>Battle of San Romano</em>, the Renaissance war picture in which a tangle of lances and rearing horses is in fact pinned to a strict, almost geometric order. It is a wonderful observation, and worth keeping labeled as <em>Barr&rsquo;s</em> observation rather than the artist&rsquo;s stated plan; the scholar Rosalind McKever has since argued Carrà likely did know the Uccello. The point that lands is the one Barr was making: the riot only <em>looks</em> like pure pandemonium. Hold the canvas at arm&rsquo;s length and you can feel the diagonals bracing each other, the explosion held in a frame as taut as an old master&rsquo;s. Carrà took the most disordered thing he had ever lived through and gave it a structure. That is the trick of the picture, and it is why a street fight from 1906 still works as a painting more than a century on.
      </p>
    </article>
  )
}
...
### Author notes for the coordinator / gates

- **Section ids match the const** (`street`, `making`, `looking`, `memory`,
  `afterlife`) and the 5 `Gal`-prefixed components map 1:1.
- **Gate-1 (fact) watchlist already honored in prose:** 1906 stated as fact, 1904
  flagged as Carrà's own memoir slip (never repeated as fact); the *La mia vita*
  quote framed as 1945 recollection; the "killed one, injured eight" casualty count
  hedged ("traces to a single source, so hold it loosely"); Marinetti introduced as
  movement impresario with an explicit "not a hand on this particular canvas"; the
  Uccello/San Romano line attributed to Barr (and McKever), not the artist.
- **Quote punctuation preserved verbatim** from the fact pack (the *La mia vita*
  passage and the Technical Manifesto "encircle and involve the spectator…" line).
- **No em dash typed in NEW prose** — all dashes are `&mdash;` HTML entities, matching
  the absinthe-file convention (those render as the dash glyph but are not the `—`
  character in source).
- **Imperial dims only** throughout (6 ft 6 1/4 in × 8 ft 6 in; stats chip 6′6¼″ × 8′6″).
- **rights: 'pd-us'** — coordinator should resolve the image at gate-6: `ART_IMG.carraGalli`
  already points at an en.wikipedia PD-US file (`/wikipedia/en/7/7f/Funeraloftheanarchistgalli.jpg`),
  consistent with the Demoiselles self-host/en-tier precedent (Carrà d.1966, not on Commons).
- **The looking section** carries the explicit red-and-black-clash + lines-of-force
  walk the brief requires, with a close-up/step-back pass.
```
