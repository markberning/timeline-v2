# L'Absinthe (Dans un café) — work-level deep read (FINAL)

Author pass, art content pipeline. kind = WORK, Modern era, Impressionism movement.
Edgar Degas, *L'Absinthe* (originally *Dans un café*), 1875–76, oil on canvas, roughly
3 ft × 2 ft 3 in, portrait orientation, Musée d'Orsay (RF 1984). House voice (dry wit,
comparisons as the #1 teaching tool, make the reader SEE the canvas). American spelling.
Imperial dimensions only. Reader has ZERO prior knowledge — every term inline-defined on
first use. Five chapters per the locked map (section ids: `cafe` · `making` · `looking`
· `show` · `afterlife`).

**HOOK (work header):** Two friends posed in an empty café for a quiet picture of urban
loneliness — and seventeen years later, in London, it accidentally became the most
notorious painting in the temperance debate.

---

## cafe — The Nouvelle-Athènes
...
## making — Two real sitters who weren't drinking

Degas did not paint *L'Absinthe* in the café. This is the first thing to get straight, because the whole power of the picture is its illusion of a snatched accidental glance — as if you, the viewer, had wandered into the Nouvelle-Athènes, sat down at an empty table, and caught these two strangers in the corner without their noticing. That feeling is built. Degas built it in his studio, with two friends, over months. The "candid" is a construction.
...
## looking — What's actually on the canvas
...
Now let your eye land on it. The first thing that should hit you is what is **not** in the picture. Almost the entire **lower-left half** of the canvas is given over to a pale, drained, gray-brown expanse of **empty café tables**. They are seen slightly from above, the way you see your own table when you're sitting at it, and they are arranged in a steep, irregular **zig-zag** that runs from the lower-left corner of the picture inward and upward — three or four marble tabletops at jagged angles, like a small staircase made of stone slabs. They are absolutely bare. On one of them — closer to the figures, partway up the zig-zag — a folded newspaper has been left behind. That's the only object on those tables. No drinks, no plates, no people. It is a still life of absence.

The diagonal does work that is hard to overstate. It pulls your eye in from the corner nearest you and shoves it, against its will, into the upper right of the picture, where it finally hits the two figures. By the time your attention arrives at them, you have already crossed a desert of empty tables to get there. You have *traveled* through emptiness to reach two people. That is the picture telling you, before you've even read its title, that this is going to be a painting about isolation.
...
## show — 1876 in Paris, 1893 in London
...
## afterlife — Brighton to the Louvre
...
no-blind-coordinates rule. Six pointers covering: figures shoved upper right; the
milky-green glass; the zig-zag empty tables; Andrée's expression; Desboutin's dark
jacket + pipe; the drained palette.

### 1. The two figures shoved to the corner
- **label:** Two people, pushed off into one corner
- **where:** Upper-right portion of the canvas — well above center, well right of center
- **detail:** Find the two figures and notice how little of the picture they take up. Together they fill maybe a third of the canvas, jammed into the upper-right corner. Most paintings of two people put them in the middle. Degas refused. By shoving them off into one corner and giving the rest of the canvas to empty tables, he made the composition itself the argument — these two are not the center of anything. They're an afterthought in their own room. Once you see it, the picture stops being about two people and starts being about the space around two people.

### 2. The milky-green glass in front of Andrée
- **label:** The one charged note of color
- **where:** On the table directly in front of the seated woman, upper right
- **detail:** Look at the tall stemmed glass in front of Andrée. Its liquid is pale, slightly cloudy, faintly green — milky rather than vivid. This is absinthe after the louche, the moment when ice water has been dripped through sugar into the spirit and turned it cloudy. Now notice that this small glass is the only piece of charged color in the whole picture — everything else is drained gray and dusty brown. The eye finds it without being told to. That's the point. The painting builds a desaturated room so the green pulls; without the desaturation the glass would just be a glass.

### 3. The zig-zag of empty tables
- **label:** A staircase of nothing
- **where:** Across the lower-left half of the canvas, marching in from the corner
- **detail:** Look at the foreground tables. Notice how they zig-zag: three or four marble tabletops at jagged angles, like a small staircase of stone slabs that climbs from the lower-left corner of the picture up and into the figures' table. They are nearly bare — one of them has a folded newspaper, and that's it. No drinks, no plates, no people. This whole big empty foreground is the picture's largest visual fact. Most painters would have filled it; Degas left it empty. The emptiness isn't background — it *is* the painting.

### 4. Andrée's lowered, off-into-nothing eyes
- **label:** A stare into the middle distance
- **where:** Andrée's face — the seated woman in the pale dress, upper right — under the broad light hat
- **detail:** Look at her eyes. They're lowered, turned slightly to one side, fixed on nothing in particular. Notice that the broad brim of her pale lavender-gray hat throws a soft shadow across the upper part of her face, dimming the eyes further. She isn't looking at her drink. She isn't looking at the man beside her. She isn't looking at us. That blank, internal middle-distance stare is the painting's emotional center, and it's the thing Victorian critics later read as evidence of wreckage. Look at it without that frame and it could just as easily be exhaustion, boredom, or the small private quiet of someone who's been posing for a painter for the eighteenth pose.

### 5. Desboutin's dark jacket and clay pipe
- **label:** The man looking off in the other direction
- **where:** Right edge of the canvas, beside and slightly behind Andrée
- **detail:** Find the bearded man. He's a denser, more solid figure than she is — a thick, dark, almost black jacket painted in heavy strokes, a battered tall hat pushed back on his head, a beard that takes over the lower half of his face. In his hand is a long-stemmed clay pipe (the cheap white pipes that were everywhere in 1870s Paris cafés). His eyes are turned off to the right, out of the picture entirely, looking at something we'll never see. Notice that he and Andrée are looking in opposite directions — neither at each other, neither at us. That's two people at the same table, twice as alone.

### 6. The drained gray-brown palette
- **label:** A room with the color wiped off
- **where:** Across the whole picture — wall, tables, floor, figures
- **detail:** Stand back and look at the whole canvas as a field of color. Notice how restricted it is: cool grays in the wall and the tabletops, warm browns in the floor, a near-black in Desboutin's jacket, a dusty pink in Andrée's jacket, a soft lavender-gray in her hat, and that one faint milky off-green in her glass. No reds. No bright blues. No sunlight — this is gas-lit interior, painted in the yellowish low light of nineteenth-century cafés. The palette is the picture's mood: dust, smoke, gaslight, no daylight. The figures are nearly the same color as the wall behind them. They're not just in the empty room. They're of it.

---

# FACT LEDGER — claims and sources

All facts cited below come from `audits/art-pipeline/imp-batch-b-factpack.md` section 2.
Items marked DOCUMENTED are the fact-pack's hard claims; items marked LIKELY are flagged
as such in prose; items not in the fact pack are flagged as **AUTHOR-INFERENCE** with
the inference's basis.

| Claim in draft | Status |
|---|---|
| Title *Dans un café* in 1876; *L'Absinthe* fixed at Grafton Gallery London 1893 | DOCUMENTED |
| Edgar Degas, 1875–76, oil on canvas, ~3 ft × 2 ft 3 in, Musée d'Orsay RF 1984 | DOCUMENTED |
| Setting = Café de la Nouvelle-Athènes, Place Pigalle (NOT Café Guerbois) | DOCUMENTED |
| Impressionist circle migrated Guerbois → Nouvelle-Athènes around 1875 | DOCUMENTED |
| Duranty published *La Nouvelle Peinture* in 1876 | DOCUMENTED |
| Zola in Nouvelle-Athènes circle | DOCUMENTED |
| Absinthe ~70% ABV, anise/fennel/wormwood spirit | DOCUMENTED |
| Louche ritual (slotted spoon, sugar, ice water) | AUTHOR-INFERENCE from period café practice; consistent with fact-pack's "absinthe louche" |
| "Fée verte" / "green fairy" nickname | AUTHOR-INFERENCE from standard period usage; not in fact pack but uncontroversial |
| Absinthe in 1875 was popular & cheap, not yet "the green poison"; anti-absinthe panic 1880s–1915 | DOCUMENTED |
| French ban 1915 | AUTHOR-INFERENCE (date standard); fact pack says "1880s–1915 demonised" |
| Sitter = Ellen Andrée (1857–1925), actress, age ~19 in 1876 | DOCUMENTED (born 1857; painting 1875–76) |
| Andrée sat for Manet (*La Prune* c.1877, *Chez le père Lathuille* 1879), Renoir (*Luncheon* 1880–81) | DOCUMENTED |
| Sitter = Marcellin Desboutin (1823–1902), printmaker | DOCUMENTED |
| Manet painted Desboutin (*The Artist*, 1875) | AUTHOR-INFERENCE (standard art-historical fact); not in fact pack but uncontroversial |
| Andrée's hat is large and light-colored (lavender/gray, broad brim) | DOCUMENTED (gate-1 visual correction) |
| Desboutin's jacket is dark / near-black (NOT brown) | DOCUMENTED (gate-1 visual correction) |
| Andrée's glass holds absinthe (for the painting); Desboutin's holds mazagran (cold coffee), NOT absinthe | DOCUMENTED |
| Mazagran origin story (Algerian town, French soldiers 1840) | AUTHOR-INFERENCE flagged in prose as soldier-story / uncertain origin |
| In real life Andrée was not an absinthe drinker; Desboutin's later being "the one who actually drank" | DOCUMENTED via Andrée's 1921 Fénéon telling — kept attributed to her recollection, not promoted to independent fact |
| Picture built in studio, not painted on-site in the café | AUTHOR-INFERENCE consistent with fact-pack's "construction of the empty foreground" + standard Degas studio practice |
| Mirrored back wall of Nouvelle-Athènes | DOCUMENTED |
| Folded newspaper in foreground | DOCUMENTED |
| Figures shoved upper right; zig-zag of empty tables from lower-left | DOCUMENTED |
| One milky-greenish glass = the painting's one charged color note | DOCUMENTED (composition described in fact pack) |
| Drained gray-brown palette | AUTHOR-INFERENCE from fact pack's description (pale dress / pinkish-cream / milky-greenish / dark jacket / warm interior) — consistent reading of palette |
| Portrait orientation (taller than wide) | DOCUMENTED (92 × 68.5 cm, portrait) |
| Shown at 2nd Impressionist Exhibition, Paris, April 1876, as *Dans un café* | DOCUMENTED |
| Some Paris critics called the figures "ugly and disgusting" in 1876 | DOCUMENTED |
| 2nd Impressionist Exhibition held at rue Le Peletier | AUTHOR-INFERENCE (standard art-historical fact); not in fact pack |
| Brighton Royal Pavilion Gallery showing 1876 (Hill loan, no. 166) — first English showing, no scandal | DOCUMENTED |
| Grafton Gallery, London, 1893 (no. 258, Arthur Kay loan) — the scandal | DOCUMENTED |
| Title *L'Absinthe* fixed in English at Grafton 1893 | DOCUMENTED |
| **Walter Crane** wrote the "study in degradation" line in 1893 (named author, not anonymous *Westminster Gazette*) | DOCUMENTED (gate-1 attribution correction) |
| Other 1893 reviews: "loathsome" / "uncouth" / "warning" language | DOCUMENTED |
| George Moore initially echoed moral critique, later recanted ("the picture is merely a work of art") | DOCUMENTED |
| Andrée's 1921 Fénéon interview — venue hedged ("Andrée's later interview"), no specific theatre named | DOCUMENTED for the interview itself; venue claim DROPPED per gate-1 (popular-source, not primary) |
| Desboutin defended in 1893 as serious printmaker not a drunk | DOCUMENTED in fact-pack context section |
| Provenance: Atelier Degas → Deschamps (London, 1876) → Captain Henry Hill (Brighton, 1876–1892) → Christie's 19 Feb 1892 lot 209 (as *Figures at a Café*) → Alexander Reid (Glasgow, 1892) → Arthur Kay (Glasgow, 1893) → Martin et Camentron / Reid → Camondo (1893–1911) → Louvre 1911 bequest → Jeu de Paume 1947–1986 → Orsay 1986–present | DOCUMENTED |
| Captain Henry Hill = private collector (military tailor, retired to Brighton, ~7 Degas works); NOT a club, NOT a Sussex temperance society — named in the `show` bridge so the reader is not stranded | DOCUMENTED |
| Christie's 1892 lot price £180 | AUTHOR-INFERENCE (standard provenance figure); not explicit in fact-pack table |
| Charles W. Deschamps = young French dealer with New Bond Street gallery | AUTHOR-INFERENCE (standard biographical fact); not in fact pack |
| Alexander Reid had shared Paris lodgings with Van Gogh | AUTHOR-INFERENCE (well-documented in Reid biography); not in fact pack |
| Camondo (1851–1911) = Paris banker of Sephardic Jewish heritage, Ottoman/Istanbul family origin; 1911 bequest to Louvre with display-as-unit condition | AUTHOR-INFERENCE on biography (standard); 1911 bequest DOCUMENTED |
| Nissim Camondo killed flying 1917; Béatrice Camondo and family killed Auschwitz 1944; Musée Nissim de Camondo | AUTHOR-INFERENCE (well-documented Camondo family history); not in fact pack |
| Jeu de Paume housed national Impressionist collection 1947–1986 | AUTHOR-INFERENCE (standard French museum history); fact pack documents the dates for *L'Absinthe* specifically |
| Musée d'Orsay opened December 1986 in converted railway station | AUTHOR-INFERENCE (standard fact); fact pack documents 1986 transfer |
| On permanent view at Musée d'Orsay | DOCUMENTED |

---

**FALSEHOODS EXPLICITLY REFUSED IN PROSE (per fact-pack requirements):**

1. That Andrée was an absinthe drinker — refused in `making`, `looking`, and `show` (she clarified in 1921 she was sober and posing).
2. That Desboutin's glass holds absinthe — refused throughout; explicitly identified as mazagran (cold coffee) in `making` and `looking`.
3. That the café was the Guerbois — refused in `cafe` chapter, with the Guerbois → Nouvelle-Athènes migration explained.
4. That a "Sussex club" or "Sussex temperance society" bought the painting — refused in `afterlife`, with Captain Henry Hill identified as a private collector (and named in the `show` bridge so the reader is never stranded).
5. That the 1893 London showing was a new painting — refused in `show`, with the seventeen-year gap and the 1876 Paris debut both stated.
6. That the title *L'Absinthe* was Degas's own — refused in `cafe` and `show`; title fixed in English at the Grafton in 1893.
7. That the picture was shown at the First Impressionist Exhibition 1874 — refused in `show`; explicitly Second Exhibition, April 1876.
8. That the "study in degradation" line was an anonymous *Westminster Gazette* notice — refused in `show`; attributed by name to **Walter Crane**.
9. That Andrée's 1921 Fénéon interview took place at the Théâtre Édouard VII — venue claim DROPPED (popular-source, not primary); the interview is now referred to as "Andrée's later interview" with Fénéon, year specified, venue unnamed.
10. That Desboutin's being "the one who actually drank" is independent corroboration — refused in `show`; explicitly attributed to Andrée's 1921 telling, kept as her recollection rather than promoted to documentary fact.
