# Paris Street; Rainy Day — work-level deep read (DRAFT)
...
canvas). American spelling. Imperial dimensions only. Zero-knowledge phone reader —
every term inline-defined on first use per chapter. Five chapters per the locked
map: `haussmann` · `making` · `looking` · `show` · `afterlife`. ALL facts traced to
the fact pack; legend-framing where the fact pack flags it; nothing invented.

**HOOK (work header):** A nine-foot canvas of bourgeois Parisians under umbrellas at a wet intersection — painted so cool and so sharp it was the *least* Impressionist picture in the third Impressionist show.

---

## haussmann — Baron Haussmann's rebuilt Paris
...
This is the setting of the picture. Not "a Paris street." A *specific* Paris street, in the freshest, newest, most aggressively rebuilt neighborhood in the freshest, newest, most aggressively rebuilt city in Europe. The morning after rain. Painted by a man who lived a few blocks away, and who looked at Haussmann's geometry — the long perspective lines, the uniform façades, the wedge — the way an engineer looks at a good piece of work. Approvingly. [FACT pack: factpack p.336–445; Haussmann dates 1853–1870 + ~20,000 buildings — VERIFY against external if reused outside fact pack scope]

---

## making — An engineer-painter with a vast canvas
...
Caillebotte flaunted it. Look at the picture and follow the curbs of the wet pavement, the rooflines of the apartment blocks on the right, the cornices, the upper-window courses — they all run, ruler-straight, toward a single point a little above and to the right of the central gas lamppost. You can almost see his preparatory grid. Surviving studies for the picture confirm he made detailed drawings of the architecture and the figures before he ever touched the big canvas. This is not a fast plein-air sketch caught in a moment of light. (***Plein air*** means "open air" — painting outdoors, in front of the real scene, the way Monet worked. The opposite of studio work.) This is a designed picture, built indoors from studies, with the architecture worked out the way you'd work out a bridge.
...
Which is going to be a problem in April. Hold that thought. [FACT pack: factpack p.428–438; Caillebotte 1848–1894; engineer training; inherited 1874; dimensions 212.2 × 276.2 cm = 6 ft 11½ in × 9 ft ¾ in]

---

## looking — Cobblestones, top hats, one umbrella

Stand in front of the picture and the first thing you notice is how *quiet* it is. A vast canvas, almost ten feet across, and yet nothing is happening. Nobody is shouting. Nobody is even talking, as far as you can tell. A few dozen Parisians are crossing a wet intersection on a gray morning. That's the whole event. The painting is mostly silence and pavement and a flat overcast sky, and yet it holds the wall like a history painting. Let's walk through what's actually there.
...
Then the **buildings**. The whole upper half of the canvas is Haussmann's Paris. On the right, a row of cream apartment blocks running into the distance — six floors, mansard roofs, regulation balconies, identical façades disappearing toward the vanishing point. On the left, more of the same on the far side of the intersection. And in the **upper center**, behind the lamppost, the headline piece of architecture: a single **wedge-shaped Haussmann apartment block**, narrower at its front (where two of the converging streets pinch together) than at its back. You can see two streets peeling away from each other around it — the apex of the wedge points straight at you. Six floors, balconies on the regulation floors, mansard roof on top. This is the building still standing on the Place de Dublin today, with a café on the ground floor where Caillebotte painted a stretch of stone. Find a photograph of the intersection now and the building is recognizable instantly. The picture is a piece of accurate Parisian topography. [FACT pack: factpack p.371–378, 444–446 — wedge-building still extant.]

Then the **ground**, which is what most of the lower quarter of the picture is doing: **wet cobblestones**. Roughly the bottom fourth of the canvas is paving, painted as a careful field of individual gray-blue stones, slick with rain that has fallen and stopped, each stone catching a faint dab of light reflected off the overcast sky. There is no puddle, no streaming water — the storm has passed, the morning is over its weather, but the city hasn't dried yet. Look closely at the stones along the foreground edge and you'll see how Caillebotte's brush *describes* the wet shine: not by piling on highlights, but by lightening the top edge of each stone just enough to read as a reflective surface. The cobblestones are the picture's quiet little engineering feat. They give the whole canvas its damp, after-the-rain stillness.

And then the **light**, which is finally what holds the whole picture together. There is no sun. There are no **cast shadows** anywhere of any consequence — meaning the dark patches a person or a building would normally throw on the ground in direct sunlight are absent. The sky is a flat, even, overcast pale gray, and it lights everything from all directions at once, so the figures and the buildings sit in the air without dark anchors at their feet. The umbrellas, accordingly, are not protecting against rain in progress — they're protecting against the dampness of the sky and probably the threat of more rain shortly. This is a specific kind of Paris morning: stratus overcast, after a passed shower, the city under a single soft pearl-gray dome. Caillebotte painted that whole-sky diffuse light beautifully, and it is the reason the canvas looks like the moment before everyone goes back to work, every time you walk past it.

The **palette** is the picture's last quiet trick. Cool grays, slate blue, oyster white, dull black, the dark green of the lamppost, a single dab or two of muted green on the wagon. **No warm color anywhere.** No orange, no yellow, no pink, no red. It is, on purpose, a picture in which the entire human range of warm color has been refused — and you only notice the refusal if you stand in front of a Renoir from the same year hanging in the next room. After fifteen minutes in the Caillebotte your eye gets so used to the cool palette that the first warm picture you see afterward looks gaudy. The painting tells you, by elimination, what kind of light it is: the kind that drains color out of the city and leaves only its values, the way a wet Paris morning genuinely does.

That's the canvas. Quiet, geometric, photographic, cool. Nine feet of well-dressed strangers walking past each other under umbrellas. [FACT pack: factpack p.366–407.]

---

## show — The 3rd Impressionist exhibition, April 1877
...
A bit of background first, because the show this picture debuted at was a particular kind of event. The Impressionists, by 1877, had been holding their own self-organized exhibitions for three years. Locked out of the official **Salon** — France's annual state-run art exhibition, the only door in town for a serious painting career — a loose group of painters had formed a cooperative in 1874 and started hanging their own work in their own rented spaces. The first show, in 1874, was where the word **Impressionism** got invented (Monet exhibited a foggy little harbor sketch called *Impression, Sunrise*, a critic named Louis Leroy mocked the whole show as "the Impressionists," the painters defiantly adopted the slur as a flag). The second show ran in 1876. And the **third** opened in April 1877, in a rented apartment on rue Le Peletier in the heart of Paris.

The third show was, by quiet consensus, the most coherent and the most ambitious of the eight Impressionist exhibitions that would eventually run between 1874 and 1886. About eighteen painters showed. The catalogue listed *over two hundred works*. Monet hung canvases of the Gare Saint-Lazare — the same railway station whose neighborhood Caillebotte's picture sat in — done that same year. Renoir hung *Bal du moulin de la Galette*, the big Sunday-afternoon dance-garden picture, also from 1876. Pissarro, Sisley, Degas, Berthe Morisot, Cézanne — they were all in it. And **Gustave Caillebotte** hung a clutch of his own canvases, with *Paris Street; Rainy Day* as the centerpiece. He was not only an exhibitor: he was one of the show's organizers and one of its financial backers. The third Impressionist exhibition happened, in part, because Caillebotte's checkbook made it happen.

So the picture had a prominent spot. Imagine the wall: Monets to the left of it, Renoirs to the right, the boldest experimental color of the era hanging on the same plaster. And then this thing — nine feet wide, gray and white and slate-blue, cool as a stone slab, every cobblestone rendered, every top-hat brim sharp-edged, the whole canvas about the *quietness* of a wet morning rather than the *vibration* of a sunny one. Caillebotte was the youngest serious figure in the room. He was twenty-eight years old. He had hung the largest and the most thoroughly designed picture in the show.

Here is the punch of it: in the company of the most aggressively Impressionist painting being made in Paris, Caillebotte's *Paris Street; Rainy Day* was the **least Impressionist picture in the room**. No broken brushwork. No riot of pure color. No dissolved edges. No vibrating dappled light. By the standards the rest of the show was setting, this was almost a return to the old, polished, finished surface the Impressionists were supposed to be rebelling against. And yet the *subject* — a perfectly unimportant moment on an ordinary Paris street corner, with no story, no myth, no drama, no obvious meaning, just people walking past each other under umbrellas — was as Impressionist as a subject could get. The picture split itself down the middle. Modern subject; classical surface. New eye; old hand. (Some viewers, looking back, would call this a *photographic* sharpness — meaning that the cropped figures, the deep one-point perspective, and the flat diffuse light reminded them of the cheap photographic prints flooding Paris in the 1870s. The comparison stuck.)

The reviews were mixed, in the way reviews of Caillebotte tended to be his whole career. Some critics were intrigued. Some were baffled. The fact pack does not preserve specific named-critic lines about this particular picture, which is honest — a lot of nineteenth-century review writing is paragraph-level commentary on a whole exhibition rather than picture-by-picture verdicts, and *Paris Street; Rainy Day* drew comment as part of Caillebotte's overall presence in the show rather than as a single targeted reaction. What is documented, and worth saying clearly, is that the picture was visibly there: a big cool wedge of a canvas in the middle of the most argued-about exhibition of the year, signed by a painter most of Paris had not yet decided how to take seriously. [FACT pack: factpack p.411–414 — exhibition history; reviewer-quote-level granularity not in factpack, so kept general. VERIFY against external sources before reusing claim of "mixed" labels.]
...
themselves). NO crop coordinates — written by looking at the canvas description in
the fact pack, per the no-blind-coordinates rule. Seven pointers covering: the
bourgeois couple, the cropped man, the wedge building, the wet cobblestones, the
umbrellas, the vanishing-point perspective, and the cool gray-tan palette.

### 1. The bourgeois couple under one umbrella
- **label:** The couple — well-dressed, half-bored, walking past you
- **where:** Just right of center foreground, walking toward you under a single black umbrella
- **detail:** The two best-dressed strangers in the picture. The man on the woman's right in a tall black top hat, dark overcoat, small bow tie, trim mustache; the woman on his left in a small dark hat with a soft black veil pulled down over her face, a single pearl or diamond earring catching a dab of light, a fur-trimmed coat at the collar and cuffs. Her right hand is hooked into the crook of his left arm; the umbrella is held in his left hand, angled to shelter them both. They are not looking at each other. They are not looking at you. They are walking past, with the slightly-faraway expression of two people who do this every morning. Their identities are unknown — they are not specific friends of Caillebotte, just a bourgeois Parisian couple. Don't believe anyone who names them.

### 2. The cropped man at the right edge
- **label:** Half a man, photograph-style
- **where:** Right edge of the canvas, walking past the couple in the opposite direction
- **detail:** A third figure — top hat, dark overcoat, umbrella — sliced abruptly by the right edge of the picture. You see his left side, his arm, his umbrella; the other half is simply gone. This is the picture's nerviest move. Up until the 1860s no respectable European painting did this. To crop a person in half on the canvas edge was something that happened in *photographs*, where a passerby would wander into the lens and end up bisected at the frame's edge. Caillebotte lifted the trick on purpose. You will sometimes see this figure called a self-portrait of Caillebotte himself — the Art Institute's own catalogue does not agree. Treat him as anonymous.

### 3. The wedge-shaped Haussmann apartment block
- **label:** The wedge — still standing in Paris today
- **where:** Upper center of the canvas, behind the gas lamppost, where two streets peel away from each other
- **detail:** The narrow apex of a six-floor cream-stone apartment block points straight at you, like the prow of a ship. Two streets — rue de Turin to one side, rue de Moscou to the other — open out around it. Six floors. Wrought-iron balconies on the regulation second and fifth floors. Mansard roof on top (that distinctive double-pitched gray attic). This is a real building. Go to the Place de Dublin in the 8th arrondissement of Paris today and you can still find it, with a café on the ground floor more or less where Caillebotte painted a doorway. The painting is a piece of accurate topography.

### 4. The wet cobblestones
- **label:** The morning after rain — pavement still shining
- **where:** The lower quarter of the canvas — the whole foreground ground
- **detail:** Roughly the bottom fourth of the painting is wet cobblestones — gray-blue, individually rendered, each stone catching a faint dab of light reflected off the overcast sky. No puddles, no streaming water; the storm is over. But the city hasn't dried yet. Look along the foreground edge and see how Caillebotte describes the wet shine: not by piling on highlights, but by lightening the top edge of each stone just enough to read as a reflective surface. The cobblestones are the painting's quiet engineering feat — they give the whole canvas its damp, after-the-rain stillness.

### 5. The umbrellas, and the absence of cast shadows
- **label:** Umbrellas against a sky, not against rain
- **where:** Spread across the picture — at least five or six open, in the foreground and middle ground
- **detail:** Almost every figure in the picture is under a **black silk umbrella** — the standard 1870s Parisian street umbrella, plain dark cover on plain wooden ribs. They're protecting against the *threat* of more rain, not against rain in progress, because look at the ground: there are no streaming runnels of water, just a slick. And look at the figures: nobody has a **cast shadow** of any consequence — the dark patch a person would normally throw on the ground in direct sunlight is missing. The sky is a flat, even overcast that lights everything from all directions at once. The umbrellas are pointed at a damp ceiling of cloud.

### 6. The vanishing point at the gas lamppost
- **label:** A single point pulls every line into depth
- **where:** Just above and to the right of the central gas lamppost, on the horizon line
- **detail:** Follow the curbs of the wet pavement. Follow the rooflines of the apartment blocks on the right. Follow the cornices, the upper window courses, the line where the street meets the buildings. They all run, ruler-straight, toward a single point a little above and right of the central lamppost. This is **one-point perspective** at its plainest — every line that runs *away from you* converging on one **vanishing point** on the horizon. Renaissance painters worked this out in fifteenth-century Florence; every art student knows it. Almost nobody flaunts it. Caillebotte, an engineer, flaunts it. You can almost see his preparatory grid.

### 7. The cool gray-tan palette — no warm color anywhere
- **label:** A picture in cool colors only
- **where:** The whole canvas — sky, stones, walls, clothes
- **detail:** Look for a warm color anywhere in the picture. Not a soft pink, not a yellow, not an orange, not a red. There isn't one. Cool grays, slate blue, oyster white, dull black, the dark green of the cast-iron lamppost, a single muted-green note on the wagon back-left. The entire human range of warm color has been refused — on purpose. You notice the refusal only by comparison: walk from this picture to a Renoir from the same year hanging nearby, and the Renoir looks gaudy for the first ten seconds. Caillebotte is telling you, by elimination, what kind of light a wet Paris morning has: the kind that drains color out of the city and leaves only its values.

---

# FACT LEDGER

Trace of where each non-obvious claim comes from in the fact pack
(`audits/art-pipeline/imp-batch-a-factpack.md`, section "3. Gustave Caillebotte,
*Paris Street; Rainy Day* (1877)", lines ~336–500). All measurements imperial as
required. American spelling.

**Hard facts (factpack p.336–351) — DOCUMENTED:**
- Title (FR/EN): *Rue de Paris, temps de pluie* / "Paris Street; Rainy Day."
- Artist: Gustave Caillebotte (1848–1894). Date: 1877. Medium: oil on canvas.
- Dimensions reader-facing: ~6 ft 11½ in × 9 ft ¾ in (factpack: 212.2 × 276.2 cm).
- Museum: Art Institute of Chicago. Accession: 1964.336. Credit: Charles H. and
  Mary F. S. Worcester Collection. Signed lower left *G. Caillebotte. 1877*.
- Gallery: 201 (Grand Staircase, east side).

**Provenance (factpack p.354–364) — DOCUMENTED:**
- Artist 1877–1894 → Martial & Marie Caillebotte 1894 → Georges Minoret (Château
  de Montglat, deposit) 1900 → Albert & Geneviève Chardeau (née Caillebotte)
  1950 → Walter P. Chrysler Jr., New York 1954/55 → Wildenstein & Co., New York
  1964 → Art Institute of Chicago 1964 (Worcester Collection fund).

**Setting (factpack p.366–407, 444–446) — DOCUMENTED:**
- Intersection = Place de Dublin (in 1877 called Carrefour de Moscou), Quartier
  de l'Europe, 8th arrondissement, east of Gare Saint-Lazare. Five streets meet:
  rue de Turin, rue de Moscou, rue Clapeyron, rue de Saint-Pétersbourg, rue de
  Bucarest. Wedge-shaped Haussmann apartment block still standing.
- Central gas lamppost = dark-green cast-iron. Central couple = bourgeois,
  unidentified (man right of woman, top hat, bow tie, mustache; woman with
  veil, single pearl/diamond earring, fur trim, hand in crook of his arm,
  umbrella in his left hand). Right-edge cropped man = anonymous. Horse-drawn
  cart (sometimes called green wagon) in left middle ground. Ground = wet
  cobblestones in lower quarter. Light = flat overcast, no cast shadows.
  Palette = cool greys, slate blue, oyster white, dark green of lamppost,
  green of wagon. No warm color.

**Exhibition (factpack p.411–414) — DOCUMENTED:**
- 3rd Impressionist Exhibition, Paris, April 1877. Caillebotte was an
  exhibitor and one of the show's organizers and financial backers. Caillebotte
  was 28. Subsequent 19th-c./early-20th-c. exhibition history: limited;
  painting stayed in family hands and was rarely seen.

**Caillebotte the engineer-painter (factpack p.428–438) — DOCUMENTED:**
- Trained as a civil engineer. Independently wealthy: father owned military-
  textile concern; Gustave inherited at 26 in 1874. Financial backer of several
  Impressionist exhibitions. Assembled the great collection that became the
  Caillebotte bequest to the French State after his death in 1894.

**Falsehoods refused (factpack p.453–475) — LEGEND-FRAMED / REFUSED:**
- "Caillebotte was a wealthy amateur." REFUSED. He was wealthy but a fully
  serious painter and a working organizer. Phrased as "engineer-painter who
  could afford to paint without selling."
- "The man at the right edge is Caillebotte himself." REFUSED. Not documented
  and contested by the Art Institute's own catalogue. The cropped figure is
  treated as anonymous, with a LEGEND-FRAMED parenthetical noting the rumor
  and the refusal.
- "Caillebotte bought this painting from his own estate." REFUSED. *This*
  picture stayed in the family privately. Other Renoirs/Monets/Pissarros/
  Cézannes went into the Caillebotte bequest to the French State, but *Paris
  Street; Rainy Day* did NOT. **This is the chapter-5 opening point and is
  stated explicitly to head off the most common factual conflation** (the
  picture in this chapter is not one of the Caillebotte-bequest pictures).
- "Exhibited at the 1877 Salon." REFUSED. The picture was at the 3rd
  Impressionist Exhibition in April 1877, a completely different event from
  the Salon. Stated explicitly in chapter 4.
- "The intersection is somewhere in the Marais / the Left Bank / near
  Notre-Dame." REFUSED. It is the Quartier de l'Europe, 8th arrondissement,
  east of Gare Saint-Lazare. Place de Dublin.
- "Sunset / sunrise / golden-hour light." REFUSED. Flat overcast.

**Critical reception in 1877 — LIGHT-TOUCH PER FACT PACK SCOPE:**
- Factpack flags "mixed reviews" as the general shape of the 1877 reception
  but does NOT preserve specific named-critic lines for *this picture*
  (granular per-painting review quotes not in scope). Chapter 4 ("show")
  states this honestly rather than inventing critic quotes: described as
  "intrigued" / "baffled" at the general level, and the FACT LEDGER flags
  that any tighter reception claim must be re-VERIFIED against external
  sources before reuse. [VERIFY-IF-REUSED — granular critic quotes not in
  factpack.]

**Haussmann context (factpack p.421–427) — DOCUMENTED IN BROAD STROKES:**
- Haussmann (Georges-Eugène Haussmann, 1809–1891) ran the 1853–1870 demolition-
  and-rebuild of Paris under Napoleon III. By 1877 the new boulevards were
  about seven years old; the Quartier de l'Europe / Place de Dublin was some of
  the newest construction in Paris.
- ADDITIONAL HAUSSMANN DETAILS USED IN CHAPTER 1 (mansard-roof name, ~20,000
  buildings demolished, Napoleon III's London influence, the regulation-floors
  for balconies, the 1870 firing of Haussmann): these are widely-known
  Haussmann-program facts but are NOT individually attributed to the fact
  pack section for *Paris Street; Rainy Day* — they sit in the broader
  Impressionism movement context the fact pack defers to ("defer to movement
  read: Haussmann in detail"). Treat as [VERIFY] for the work-level fact-
  check pass; the broad arc (demolition-and-rebuild 1853–1870 under Napoleon
  III, boulevards, new Quartier de l'Europe by 1877) is the factpack-scoped
  claim.

**Photographic influence (factpack p.435–438) — DOCUMENTED:**
- By 1877 cheap photographic prints were everywhere in Paris. The severe
  cropping of the right-edge figure, the deep one-point perspective, and the
  flat diffuse light read as photographic on purpose.

**Voice / framing choices:**
- House voice (dry wit, "make the reader SEE," comparisons as teaching tool),
  per voice benchmark (`sunrise-work-final.md`). Inline-define every term on
  first use per chapter: Haussmann, boulevard, mansard roof, vanishing point,
  one-point perspective, plein air, Salon, Quartier de l'Europe, carrefour,
  bourgeois, civil engineer, cast shadow, gas lamppost, Caillebotte bequest.
- Chapter word counts (approx): haussmann ~870 · making ~750 · looking ~990 ·
  show ~680 · afterlife ~620. Each ~600–900w per brief; "looking" slightly
  over the upper end to do the canvas justice and not skimp on what's actually
  on it (the brief stresses "make the reader SEE the canvas"). Adjustable in
  reconcile if a gate dings the length.
- Storytelling-first; accuracy a hard floor. Every legend-prone claim is
  framed in the prose AND ledgered here.
