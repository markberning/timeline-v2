...
export const CAPITAL: PhiNarr = {
  ...
  "chapters": [
    ...
    },
    {
      ...
      "blocks": [
        {
          "p": "Once commodities exchange in fixed proportions of value, one of them naturally drifts into the role of measuring all the others. That is money: a commodity, historically gold, that becomes the universal yardstick of value and the thing everything else trades against. Ordinary commerce then runs in a simple circuit Marx labels C-M-C, commodity to money to commodity. A weaver sells his cloth for money and uses the money to buy bread. He begins with a use-value he does not want to keep, the cloth, and ends with one he does, the bread, and the money is just a go-between. He sells in order to buy. The whole point of the loop is the bread at the end; the money is a means."
        },
        {
