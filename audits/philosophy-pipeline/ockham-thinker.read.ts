...
export const OCKHAM: PhiNarr = {
  ...
  "hook": [
    ...
    "He was a friar who never finished his degree, ended his life excommunicated and on the run, and spent his last twenty years writing pamphlets against a pope he had declared a heretic. The schools nicknamed him the Venerable Beginner, for the doctorate he started and never completed. The name turned out to fit in a larger sense than they meant. He began something. The medieval synthesis ends with him, and the modern habit of mind, trust what you can observe, distrust what you cannot, multiply nothing without need, starts to come into focus on the far side."
  ],
  "brk": {
