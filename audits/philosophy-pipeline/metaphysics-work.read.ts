...
export const METAPHYSICS: PhiNarr = {
  ...
  "hook": [
    "Start with the single most famous opening line in the history of philosophy. \"All men by nature desire to know.\" That is how the treatise we call the *Metaphysics* begins, and the proof Aristotle offers for it is not some grand argument but something you can check against your own life: the simple delight we take in just *looking* at things. We love our senses \"even apart from their usefulness,\" he says, and above all the sense of sight: we like to see, to notice, to take the world in, long before any of it pays off. That ordinary itch to understand, he thinks, is the seed of everything. Follow it far enough and it climbs all the way up to the deepest question there is: what does it mean for anything to exist at all?",
    "Before going a step further, one fact has to be put on the table, because it changes how you read every page that follows. Aristotle did not sit down and write a book called the *Metaphysics*. There is no such book in the way the *Republic* is a book: one author, one continuous argument, start to finish. What we have is a stack of fourteen separate treatises, written at different times for the inner circle of Aristotle's school, that a later editor (almost certainly a scholar named Andronicus of Rhodes (an-droh-NY-kus), around 70 BCE) gathered up, put in an order, and shelved on the library roll *after* Aristotle's treatises on nature, the *Physics*. The Greek label *ta meta ta physika* (tah meh-TAH tah foo-sih-KAH) just means \"the [books] after the *Physics*.\" It was a librarian's filing note. The most influential book in the history of Western thought got its name from where it sat on a shelf.",
  ...
  "chapters": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "Because it's the most fundamental science, it also turns out to be the keeper of the most fundamental *rule*, the principle that every other piece of reasoning everywhere silently relies on. Aristotle calls it the firmest of all principles, and it is the law we now call **non-contradiction**. In his words: \"the same attribute cannot at the same time belong and not belong to the same subject and in the same respect.\" A thing can't both be red and not-red, in the same way, at the same moment. It sounds almost too obvious to state. That's the point. \"This is the most certain principle of all,\" Aristotle writes, and it has two distinct features that make it bedrock. First, it is \"best known\": there is nothing you could possibly understand better than this, because you already rely on it to understand anything else at all. Second, it is, in his term, \"non-hypothetical.\" Most starting points are hypotheses, premises you *choose* to assume, the way a geometer chooses to start from a definition of a point and could in principle have started somewhere else. Non-contradiction is not like that. You don't get to opt into it or out of it; you are already using it the instant you think a single thought. It is the one principle you cannot even argue against, because the moment you try to deny it you have to use it to make the denial mean anything. You cannot reason at all without it."
        },
        {
          "p": "Which raises a problem: how do you *prove* the most certain principle of all? You can't, and Aristotle knows it, and this is one of his sharpest moves. Any proof would have to start from something even more certain than the thing being proved, but nothing is more certain than non-contradiction, so demanding a proof of it is already a confusion. What Aristotle does instead is turn the burden around. He challenges anyone who denies it to so much as *say something*, to make one meaningful statement. And the moment they do, he argues, they've used the principle: to assert that something is the case is to rule out its being not-the-case, in the same breath. The denier who tries to speak refutes himself; the denier who refuses to speak has said nothing at all, and you can't argue with a vegetable. The most basic rule of reality can't be demonstrated, but it can't be coherently denied either, and that, for Aristotle, is exactly what you'd expect of the firmest principle there is."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "The question Aristotle opened with, what does it mean for anything to *be*, gets answered all the way up, from the delight of looking at the world to the divine thought thinking itself at the summit of it. The name on the work is a librarian's accident, the books inside were never meant to be one book, and the divine mind at the top is colder than the God it was later mistaken for. But underneath the accidents of how it reached us, the *Metaphysics* is the most sustained attempt anyone in the West had yet made to get to the very bottom of reality, and to do it by studying *this* world rather than escaping it. That conviction, that you understand a thing by examining the thing, its matter, its form, its source, and its end, patiently, all the way down, is what the treatise leaves behind, more lasting than any single one of its answers."
        }
      ]
    }
  ]
