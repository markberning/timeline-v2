  ...
  "chapters": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "p": "But Hobbes draws a sharp line first, around a word the whole book turns on: *right* versus *law*. In the state of nature each person has a \"right of nature,\" the liberty to use his own power however he wishes for his own preservation, including a right to all things, even to another's body. A right is a liberty, a permission. A law is an obligation, something that *binds*. The laws of nature tell a man what he ought to do to survive, but they bind only in conscience, not in act, when others cannot be trusted to keep them. A man who lays down his weapons among men who keep theirs has not made peace; he has made himself prey. So the laws of nature, by themselves, do not get anyone out of the war. They are valid, and they are useless without something more."
        },
        {
