...
[FIGURE: A J.L. Magee 1856 lithograph showing a giant free-soil settler bound to a Democratic platform while party leaders force a Black man into his mouth. | "Forcing Slavery Down the Throat of a Freesoiler," J.L. Magee, 1856. The cartoon's free-soil rage at the Democratic slavery-expansion platform is exactly the anger that built the new Republican Party. | Library of Congress, item 2008661578; public domain. | /thread-img/parties-magee-1856.jpg]
...
[FIGURE: An 1860 United States map shaded by which presidential candidate won each state. | The 1860 electoral map. Lincoln's Republican red covers the North and Pacific coast; Breckinridge's Southern Democrats hold the slave states. The country is already split along the line it will fight over. | Wikimedia Commons, public domain. | /thread-img/parties-1860-map.png]
...
[The war these parties fought](/war-civil-war)
...
[FIGURE: An 1867 illustration of African American men lined up to cast ballots, the first man a well-dressed laborer dropping his vote into a box. | "The First Vote," drawn by Alfred R. Waud for Harper's Weekly, November 1867. Black men in the South cast their first ballots under the Reconstruction Acts, and they voted overwhelmingly Republican. | Library of Congress, LCCN 2011648984; no known restrictions on publication. | /thread-img/parties-first-vote-1867.jpg]
...
[FIGURE: A Thomas Nast cartoon of a hooded Klansman and a White League member clasping hands above a terrorized Black family, with the words "Worse than Slavery." | "The Union as It Was," Thomas Nast, Harper's Weekly, October 1874. The Klan and the White League shake hands over a Black family they have ruined. This is the violence that put the white-supremacist Democratic Redeemers back in power. | Library of Congress, item 2001696840; no known restrictions. | /thread-img/parties-nast-1874.jpg]
...
Every non-trivial factual claim below, with its pack source. Sections refer to the fact pack at `audits/threads-pipeline/parties-factpack.md`. Newcomer glosses added in this revision are marked [GLOSS-CK] for bedrock common-knowledge definitions and [GLOSS-PACK] for glosses drawn from facts the pack itself names.

**Opening / orientation**
- Republicans = anti-slavery party, Lincoln a Republican; Democrats = party of slaveholding South; coalitions look roughly inverted today; the South once Democratic now mostly Republican; Black voters once "party of Lincoln" now overwhelmingly Democratic. — ORIENTATION; §4; §5 Engine B.
- "seceded" = formally broke away from the United States. — [GLOSS-CK]; secession of the slave states is pack-grounded in ORIENTATION/§3 (every seceding state Democratic-run).
- The inversion was gradual (decades), not overnight, and multi-causal; no single day/law. — ORIENTATION; DISPUTED §3.
- Instruction to track coalitions/poles not party names. — §1 KEY FRAMING.

**§ The two poles (First Party System)**
- Hamilton = first Treasury Secretary, organized Federalists c. 1789–1791 around his fiscal program. — §1.
- Federalist positions: strong central gov't, broad powers, national bank, federal assumption of state debts, protective tariffs, commerce/manufacturing. — §1.
- Tariff defined as tax on imports sheltering domestic industry. — [GLOSS-PACK] (tariff role stated in §1/§2 "protective tariff to foster domestic manufacturing").
- Jefferson & Madison built Democratic-Republican (Jeffersonian Republican) Party 1792–1793. — §1.
- Jeffersonian positions: limited federal power, strict construction, states' rights, low tariffs, agrarian republic of farmers, bank seen as unconstitutional. — §1.
- "states' rights" = the idea that the states, not the federal government, should hold most governing power (defined on first use in the Jefferson/Madison paragraph). — [GLOSS-CK]; the states'-rights position itself is pack-sourced §1.
- Federalists dominant until 1800; Jefferson elected 1800, Jeffersonians take over. — §1.
- Hartford Convention Dec 1814–Jan 1815, New England Federalists protesting Madison/War of 1812; overshadowed by Treaty of Ghent and Jackson's victory at New Orleans; secession rumors branded party disloyal/regional. — §1.
- Era of Good Feelings ~1815–1825, one-party Jeffersonian dominance; Monroe re-elected 1820 essentially unopposed. — §1.
- Hamiltonian vs Jeffersonian as the durable spine. — §1 KEY FRAMING.

**§ New names, same poles (Second Party System)**
- Second Party System organized ~1828. — §2.
- Democratic Party built around Jackson, grew from Democratic-Republicans, is the modern Democrats' lineage. — §2.
- Jacksonian positions: common man vs elites, vote for non-landowning white men, hostility to concentrated economic power, low tariffs, westward expansion; vetoed/killed the Second Bank of the United States (recharter veto 1832). — §2.
- Whig Party 1833–1854, assembled by Henry Clay; opposed Jackson's "executive tyranny." — §2.
- American System = national bank for uniform currency + protective tariff + federal subsidy of internal improvements (roads/canals); this is the Whig program (named once, collapsing the prior double-pass). — §2.
- Whig = Hamiltonian pole; Jacksonian Dems = Jeffersonian pole. — §2.
- Whigs cross-sectional, held by economics not a slavery position; couldn't hold N (anti-slavery) and S (pro-slavery) wings as slavery centered in early 1850s. — §2.
- Clay and Webster both died 1852. — §2.

**§ The crucible**
- Kansas-Nebraska Act May 1854 (signed May 30, 1854), sponsored by Democratic Sen. Stephen A. Douglas of Illinois. — §3.
- "the territories" = western lands the U.S. held that had not yet become states, where the slave-or-free question was the central fight. — [GLOSS-PACK] (§3 territories/popular-sovereignty context).
- Organized Kansas & Nebraska under popular sovereignty (settlers vote slavery up or down); effectively repealed the Missouri Compromise of 1820 (36°30′ line barring slavery in northern Louisiana Purchase territory). — §3.
- "the Louisiana Purchase" = the vast western territory the U.S. bought from France in 1803, which roughly doubled the size of the country. — [GLOSS-CK]; the Louisiana Purchase line is named in §3.
- Triggered "Bleeding Kansas" (guerrilla violence over slave/free); destroyed Whigs, split Democrats, catalyzed Republican founding. — §3.
- Republican Party born at anti-slavery meetings across the North in 1854 (Ripon/Jackson "which town" debate cut per storytelling gate; precision-of-founding kept). — §3.
- "Free Soil Party" / free-soilers = a movement to keep the western territories free of slavery so ordinary farmers could settle without competing against slave labor. — [GLOSS-CK/PACK]; Free Soil Party named in §3 as a founding component; gloss is bedrock common-knowledge.
- "abolition" = the total, immediate end of slavery everywhere, distinct from merely stopping its spread. — [GLOSS-CK]; the expansion-vs-abolition distinction is the core §3 precision point.
- Founding coalition = Northern anti-slavery Whigs + Free Soil Party + anti-slavery/anti-Nebraska Democrats. — §3.
- United on stopping the EXPANSION of slavery, NOT abolition where it existed; free-soilers not founding abolitionists; Lincoln's 1860 platform pledged not to interfere with slavery in existing slave states, only opposed its spread. — §3.
- 1860 Democratic convention in Charleston, SC deadlocked; Douglas led but couldn't reach two-thirds; after pro-slavery plank rejected, ~50 Southern delegates walked out. — §3.
- "two-thirds" rule = required a two-thirds majority to nominate, which let the Southern delegates block Douglas as long as they held together. — [GLOSS-PACK] (§3: two-thirds required, ~50 Southern delegates walked out; the veto-mechanism is the pack's own causal point).
- Reconvened in Baltimore, split: Northern Democrats nominated Douglas (popular sovereignty); Southern Democrats nominated VP John C. Breckinridge of Kentucky (pro-slavery, states' rights). — §3.
- Constitutional Union Party nominated John Bell of Tennessee (preserve Union, dodge slavery). — §3.
- 1860 results: Lincoln 180 EV, Breckinridge 72, Bell 39, Douglas 12 (broken into a more readable pass). — §3.
- "electoral votes" = the state-by-state votes that actually decide the presidency, which is how a candidate can win the office without winning the most ballots nationwide. — [GLOSS-CK].
- Lincoln ~40% popular vote = ONE OF the lowest winning shares in American history (NOT "the lowest"; J.Q. Adams 1824 ~30.9% was lower — superlative removed per fact blocker F1). — §3 (corrected pack popular-vote note).
- Lincoln swept North + Pacific, won zero slave states, not on many Southern ballots; Breckinridge most of South; Bell took KY/TN/VA; Douglas (national popular-vote runner-up) carried only Missouri outright, plus a split share of New Jersey. — §3.
- Republicans 1860 = North, anti-slavery-expansion, Lincoln, Hamiltonian heir (strong federal gov't, economic modernization); wartime GOP Congress passed Homestead Act, Pacific Railway Act, National Banking Acts, protective tariffs. — §3.
- Democrats 1860s = South (every seceding state Democratic-run) + Northern Democrats split into War Democrats and Copperheads (Peace Democrats). — §3.
- Copperheads strongest in Midwest (Ohio, Indiana, Illinois); invoked Jefferson and Jackson; opposed Lincoln's centralization/emancipation as "strangling the Constitution." — §3.
- "emancipation" = freeing the enslaved, formalized in Lincoln's 1863 Emancipation Proclamation. — [GLOSS-CK]; the Emancipation Proclamation (1863) is bedrock common knowledge; emancipation is named in §3 (Copperheads opposed Lincoln's "move toward emancipation").
- 1864: Democrats nominated Gen. George B. McClellan on a Copperhead-written platform calling the war a failure / demanding peace; McClellan repudiated the peace plank; Sherman's capture of Atlanta (Sept 1864) undercut it; Lincoln won re-election decisively. — §3.
- Sherman/Atlanta identified: Union General William T. Sherman captured the Confederate city of Atlanta in Sept 1864, signaling the Union was winning. — §3 (Sherman's capture of Atlanta, Sept 1864); "William T." and "Union General" are bedrock common knowledge [GLOSS-CK].

**§ The mirror (Reconstruction)**
- "Reconstruction" = after the Confederacy's defeat the federal government placed the former rebel states under military control and required them to form new governments, with Black men allowed to vote, before they could rejoin the Union (defined at the start of the section, before "Reconstruction Acts"). — [GLOSS-PACK]; built from §4 (Reconstruction Acts, military Reconstruction, Black male suffrage, readmission).
- 13th/14th/15th Amendments written and pushed by Republicans over Democratic opposition. — §4.
- 13th: abolished slavery, passed Congress Jan 1865, ratified Dec 1865, after Lincoln's death. — §4.
- 14th: birthright citizenship, due process, equal protection, ratified 1868. — §4.
- 15th: vote regardless of "race, color, or previous condition of servitude," ratified 1870. — §4.
- Black men voted in large numbers for first time in 1867 under the Reconstruction Acts; voted overwhelmingly Republican. — §4.
- Republicans = "party of Lincoln," party of Black voters/civil rights; first Black members of Congress Hiram Revels and Joseph Rainey, both 1870, Republicans. — §4.
- Democrats became party of the white South; "Redeemers" retook state governments via violence/voter suppression. — §4.
- KKK = secret white-supremacist terror group founded by former Confederates to murder and intimidate Black voters and their allies (one-clause description on first mention). — [GLOSS-CK/PACK]; KKK founded 1865/66 and the murder/intimidation of Black voters and white Republican allies are stated in §4.
- KKK founded 1865/66; White League and Red Shirts from ~1874, called by historians the military arm of the Democratic Party. — §4.
- Reconstruction ended with the Compromise of 1877, settling the disputed 1876 election, federal troops withdrawn. — §4.
- Compromise of 1877 mechanism + Republican agency: Republican leaders in Washington struck the deal, accepting troop withdrawal / return of the South to Democratic control in exchange for the presidency for Hayes; a bargain trading federal enforcement of Black civil rights for the White House, judged harshly by historians (added per framing blocker R1 + newcomer N6). — §4 (Compromise of 1877 = settling the disputed 1876 Hayes–Tilden election + troop withdrawal); "Hayes" and the Republican-side bargain are bedrock common knowledge [GLOSS-CK]. No contested date/number invented.
- Redeemer Democratic gov'ts built Jim Crow: segregation + disenfranchisement (poll taxes, literacy tests, grandfather clauses), entrenched 1890s–1900s. — §4.
- "grandfather clauses" = rules that let a white man skip the poll tax or literacy test if an ancestor had voted before the war, which nearly all Black men (whose grandfathers had been enslaved) could not. — [GLOSS-CK]; grandfather clauses are named in §4.
- "Solid South" = with Black voters stripped from the rolls, the only voters left were white, voting as one bloc, so reliably Democratic at every level it earned the name (causal bridge tightened per N14). — §4.
- Explicit inversion: 1865–77 Republicans = party of Black Americans / civil-rights amendments / federal enforcement; Democrats = white South / "states' rights" invoked in this era as a shield for white supremacy / Jim Crow; mirror image of today's racial coalitions. (Era-anchored per R2.) — §4.
- Honesty guardrail (state the true fact AND situate it in the realignment; mirror is setup, swap is payoff; don't leave reader implying today's parties hold those positions). PRESERVED VERBATIM in position per R5. — §4 HONESTY GUARDRAIL; DISPUTED §5.

**§ The teaser**
- FDR + New Deal built a new Democratic majority (New Deal coalition) holding the segregationist white Solid South + Northern urban ethnics/Catholics/Jews/labor + Northern Black voters. — §5 Engine A.
- New Deal = FDR's sweeping government response to the Great Depression. — [GLOSS-PACK] ("New Deal" named §5 Engine A).
- "the Great Depression" = the economic collapse of the 1930s that wiped out jobs and savings nationwide (parenthetical expanded per N8). — [GLOSS-CK].
- 1936: roughly three-quarters of Black voters backed FDR, a break from Republican ("party of Lincoln") allegiance. — §5 Engine A (pack 71–75%, kept as "roughly three-quarters" per could-not-verify list).
- The coalition held both the white South and a growing Northern Black bloc = internal contradiction. — §5 Engine A.
- White South moved away as national Democrats embraced civil rights, from the late 1940s onward. — §5 Engine B.
- Gradual + multi-level: presidential voting flipped first (1960s), state/local and party ID took decades, ~30+ years, not complete until the 1990s; Black voters became overwhelmingly Democratic (today). — §5 Engine B; CRITICAL note.
- Scholarly debate over WHY the white South moved: race-backlash camp (weight of recent quantitative work) vs. economics/Sunbelt-growth camp, the latter anchored by a Harvard University Press study that won the V.O. Key Award (political science's top prize for Southern-politics research); both factors present, the dispute is proportion, not settled either way. (Camp credentials balanced per R3; the press, prize, and prize description are pack-sourced — DISPUTED §2, Shafer & Johnston, Harvard 2006, V.O. Key Award.) — DISPUTED §2.
- LBJ "lost the South for a generation" quote = flagged apocryphal: no solid contemporary record, wording surfaces decades later, historians treat as effectively apocryphal. NOT used as a real quote. — DISPUTED §1.
- Closing: Republicans began the anti-slavery-EXPANSION party of Lincoln/North (precision restored per R4); Democrats began party of agrarian South; both true, neither describes today's parties because the ground under the names moved. — ORIENTATION; §1; §3; §4; DISPUTED §5.

**Images used (4, all PD candidates from pack image section)**
- Magee 1856 "Forcing Slavery Down the Throat of a Freesoiler," LOC 2008661578 — image #5, crucible slot.
- 1860 electoral map, File:ElectoralCollege1860.svg — image #1, 1860 results.
- Waud "The First Vote" 1867, LOC LCCN 2011648984 — image #2, Reconstruction mirror.
- Nast 1874 "The Union as It Was / Worse than Slavery," LOC 2001696840 — image #4, Redemption violence.
- NOT used: Thurmond 1948 photo (rights-unconfirmed, pack flag) and Nast 1868 "White Man's Government" (#3, optional, dropped to keep image count at 4 and avoid two Nast cartoons back to back).

**Cross-link pill**
- `[The war these parties fought](/war-civil-war)` — only the verified-existing route used, placed at the end of the crucible.

**GAPs flagged**
- None. Every new gloss draws either on a fact the pack already names ([GLOSS-PACK]) or on a bedrock, uncontested common-knowledge definition ([GLOSS-CK]); none required a contested date, number, or quote outside the pack. The Compromise-of-1877 mechanism (Republican leaders trading troop withdrawal for the Hayes presidency) is drawn from §4 plus common knowledge of the Hayes–Tilden outcome named in the pack; no new contested figure was introduced.
